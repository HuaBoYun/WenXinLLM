...
import com.regulatory.penetration.oracle.service.TblCeaConferenceMgtOracleService;
import com.regulatory.penetration.oracle.service.TblStaffOracleService;
import com.regulatory.penetration.service.CeaConferenceMgtService;
import com.regulatory.penetration.service.FileUploadService;
import com.regulatory.penetration.util.MyJsonBean;
import com.regulatory.penetration.util.MyResponseFormat;
import com.regulatory.penetration.util.PageResult;
...
public class CeaConferenceMgtServiceImpl implements CeaConferenceMgtService {
	...
	public MyJsonBean<TblCeaConferenceMgtOracle> getTblCeaConferenceMgtList(TblCeaConferenceMgtQueryParam param) {
		...
		if (CollectionUtil.isNotEmpty(pageInfo.getList())) {
			...
			PageResult<TblCeaConferenceMgtOracle> build = new PageResult<TblCeaConferenceMgtOracle>().build(pageInfo);
