...
@Configuration
@MapperScan(basePackages = {"com.regulatory.penetration.mysql.mapper"}, sqlSessionTemplateRef = "mysqlSqlSessionTemplate")
public class DataSourceMySqlConfig {
	...
	public SqlSessionFactory mysqlSqlSessionFactory(@Qualifier(value = "mysqlDataSource") DataSource dataSource, MybatisProperties mybatisProperties)
		...
		bean.setTypeAliasesPackage("com.regulatory.penetration.mysql.entity");
