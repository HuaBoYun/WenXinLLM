...
import com.hbfk.gateway.utils.WebfluxResponseUtils;
import com.hbfk.gateway.utils.XssInjectionRuleUtils;
...
public class XssInjectionFilter implements GlobalFilter, Ordered {
    ...
    /**
     * XSS注入拦截过滤逻辑
     * <p>对HTTP/HTTPS请求的查询参数、JSON请求体、表单数据进行XSS关键字检测</p>
     * <p>检测到XSS注入时直接返回错误响应，阻断请求转发</p>
     *
