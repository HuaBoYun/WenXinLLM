 ...
 * 常年法律服务-评分表
 */
@Schema(name="TblFwglPerennialLawServiceGradeMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_perennial_law_service_grade")
public class TblFwglPerennialLawServiceGradeMySql implements Serializable {
	...
	public static TblFwglPerennialLawServiceGradeMySql ofId(Integer id) {
		TblFwglPerennialLawServiceGradeMySql tblFwglPerennialLawServiceGradeMySql = new TblFwglPerennialLawServiceGradeMySql();
