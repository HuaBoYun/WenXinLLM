 ...
 * 课题管理表
 */
@Schema(name="TblFwglSubjectManagementMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_subject_management")
public class TblFwglSubjectManagementMySql implements Serializable {

	@Id
	@Column(name = "SUBJECTMANAGEMENTID")
	@GeneratedValue(generator = "JDBC")
	@Schema(name = "课题管理ID")
	private Integer subjectManagementId;
	...
	public static TblFwglSubjectManagementMySql ofId(Integer id) {
		TblFwglSubjectManagementMySql tblFwglSubjectManagementMySql = new TblFwglSubjectManagementMySql();
