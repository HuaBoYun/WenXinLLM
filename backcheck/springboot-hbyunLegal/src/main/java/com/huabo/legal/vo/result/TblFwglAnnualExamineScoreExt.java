 ...
 * 年度考核评分表
 */
@Schema(name="TblFwglAnnualExamineScoreExt")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_annual_examine_score_ext")
public class TblFwglAnnualExamineScoreExt implements Serializable {
	...
	public static TblFwglAnnualExamineScoreExt ofId(Long id) {
		TblFwglAnnualExamineScoreExt tblFwglAnnualExamineScoreExtMySql = new TblFwglAnnualExamineScoreExt();
		tblFwglAnnualExamineScoreExtMySql.setAnnualExamineScoreExtId(id);
		return tblFwglAnnualExamineScoreExtMySql;
	}

	public static TblFwglAnnualExamineScoreExt ofDelete(Long annualExamineId) {
		TblFwglAnnualExamineScoreExt tblFwglAnnualExamineScoreExtMySql = new TblFwglAnnualExamineScoreExt();
