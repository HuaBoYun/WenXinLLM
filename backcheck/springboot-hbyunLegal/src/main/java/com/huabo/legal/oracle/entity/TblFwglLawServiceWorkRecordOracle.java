...
/**
 * 法律服务-工作记录表(此表名实体类名称与oracle数据库不一致 注意)
 */
@Schema(name="TblFwglLawServiceWorkRecordOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_service_work_record")
public class TblFwglLawServiceWorkRecordOracle implements Serializable {
	...
	public static TblFwglLawServiceWorkRecordOracle ofId(Long id) {
		TblFwglLawServiceWorkRecordOracle tblFwglLawServiceWorkRecordMySql = new TblFwglLawServiceWorkRecordOracle();
