 ...
 * 学法考试表
 */
@Schema(name="-TblFwglXfExamOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_xf_exam")
public class TblFwglXfExamOracle implements Serializable {
	...
	public static TblFwglXfExamOracle ofId(Long id) {
		TblFwglXfExamOracle tblFwglXfExamMySql = new TblFwglXfExamOracle();
