 ...
 * 公司律师扩展表
 */
@Schema(name="TblFwglFirmLawyerExtOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_firm_lawyer_ext")
public class TblFwglFirmLawyerExtOracle implements Serializable {
	...
	public static TblFwglFirmLawyerExtOracle ofId(Long id) {
		TblFwglFirmLawyerExtOracle tblFwglFirmLawyerExtMySql = new TblFwglFirmLawyerExtOracle();
