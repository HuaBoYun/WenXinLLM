package com.huabo.legal.exam.aspect;
...
import com.huabo.legal.exam.modules.sys.system.service.SysDictService;
...
public class DictAspect {
     ...
     * @throws Throwable
     */
    @Around("execution(public *  com.huabo.legal.exam..*.*Controller.*(..))")
