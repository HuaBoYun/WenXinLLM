 ...
 * 年度考核题目表
 */
@Schema(name="TblFwglAnnualExamineTopicExtMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_annual_examine_topic_ext")
public class TblFwglAnnualExamineTopicExtMySql implements Serializable {
	...
	public static TblFwglAnnualExamineTopicExtMySql ofId(Integer id) {
		TblFwglAnnualExamineTopicExtMySql tblFwglAnnualExamineTopicExtMySql = new TblFwglAnnualExamineTopicExtMySql();
