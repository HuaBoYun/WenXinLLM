...
@Schema(name="TblFwglFirmLawyerMySql")
@AllArgsConstructor
@NoArgsConstructor
public class TblFwglFirmLawyerMySql implements Serializable {
	...
	public static TblFwglFirmLawyerMySql ofId(Integer id) {
		TblFwglFirmLawyerMySql tblFwglFirmLawyerMySql = new TblFwglFirmLawyerMySql();
