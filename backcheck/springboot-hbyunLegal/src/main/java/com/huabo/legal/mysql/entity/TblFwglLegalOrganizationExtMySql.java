 ...
 * 法务机构及负责人扩展表
 */
@Schema(name="TblFwglLegalOrganizationExtMySql")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_legal_organization_ext")
public class TblFwglLegalOrganizationExtMySql implements Serializable {
	...
	public static TblFwglLegalOrganizationExtMySql ofId(Integer id) {
		TblFwglLegalOrganizationExtMySql legalOrganizationExtMySql = new TblFwglLegalOrganizationExtMySql();
