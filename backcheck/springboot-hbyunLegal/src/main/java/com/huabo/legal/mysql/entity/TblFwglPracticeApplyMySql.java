 ...
 * 执业申请表
 */
@Schema(name="TblFwglPracticeApplyMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_practice_apply")
public class TblFwglPracticeApplyMySql implements Serializable {

	@Id
	@Column(name = "PRACTICEAPPLYID")
	@GeneratedValue(generator = "JDBC")
	@Schema(name = "执业申请ID")
	private Integer practiceApplyId;
	...
	public static TblFwglPracticeApplyMySql ofId(Integer id) {
		TblFwglPracticeApplyMySql tblFwglPracticeApplyMySql = new TblFwglPracticeApplyMySql();
