...
public class TblFwglPracticeApplyExt implements Serializable {
	...
	public static TblFwglPracticeApplyExt ofId(Long id) {
		TblFwglPracticeApplyExt tblFwglPracticeApplyExtMySql = new TblFwglPracticeApplyExt();
