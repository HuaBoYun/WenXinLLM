...
public class TblFwglXfExamMySql implements Serializable {
	...
	public static TblFwglXfExamMySql ofId(Integer id) {
		TblFwglXfExamMySql tblFwglXfExamMySql = new TblFwglXfExamMySql();
