 ...
 * 公司律师扩展表
 */
@Schema(name="TblFwglFirmLawyerExtMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_firm_lawyer_ext")
public class TblFwglFirmLawyerExtMySql implements Serializable {

	@Id
	@Column(name = "LAWYEREXTID")
	@GeneratedValue(generator = "JDBC")
	@Schema(name = "公司律师扩展ID")
	private Integer lawyerExtId;
	...
	public static TblFwglFirmLawyerExtMySql ofId(Integer id) {
		TblFwglFirmLawyerExtMySql tblFwglFirmLawyerExtMySql = new TblFwglFirmLawyerExtMySql();
