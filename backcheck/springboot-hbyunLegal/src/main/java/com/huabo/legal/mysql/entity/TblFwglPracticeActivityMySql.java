 ...
 * 执业活动表
 */
@Schema(name="TblFwglPracticeActivityMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_practice_activity")
public class TblFwglPracticeActivityMySql implements Serializable {

	@Id
	@Column(name = "PRACTICEACTIVITYID")
	@GeneratedValue(generator = "JDBC")
	@Schema(name = "执业活动ID")
	private Integer practiceActivityId;

	@NotNull(message = "activityCategory活动类别 1-文章发表 2-法律审核 3-法律尽调，不能为空")
	@Column(name = "ACTIVITYCATEGORY")
	@Schema(name = "活动类别 1-文章发表 2-法律审核 3-法律尽调")
	...
	@Column(name = "ARTICLEPUBLISHPUBLISHINGCARRIER")
	...
	public static TblFwglPracticeActivityMySql ofId(Integer id) {
		TblFwglPracticeActivityMySql tblFwglPracticeActivityMySql = new TblFwglPracticeActivityMySql();
