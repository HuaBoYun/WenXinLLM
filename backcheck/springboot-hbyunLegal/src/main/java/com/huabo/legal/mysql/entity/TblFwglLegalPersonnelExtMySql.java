 ...
 * 法务人员扩展表
 */
@Schema(name="TblFwglLegalPersonnelExtMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_legal_personnel_ext")
public class TblFwglLegalPersonnelExtMySql implements Serializable {

	@Id
	@Column(name = "PERSONNELEXTID")
	@GeneratedValue(generator = "JDBC")
	@Schema(name = "法务人员扩展ID")
	private Integer personnelExtId;
	...
	public static TblFwglLegalPersonnelExtMySql ofId(Integer id) {
		TblFwglLegalPersonnelExtMySql tblFwglLegalPersonnelExtMySql = new TblFwglLegalPersonnelExtMySql();
