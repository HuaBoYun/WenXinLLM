 ...
 * 总法律顾问表
 */
@Schema(name="TblFwglLegalAdviserMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_legal_adviser")
public class TblFwglLegalAdviserMySql implements Serializable {
...
//	private String fillInPerson;
	...
	public static TblFwglLegalAdviserMySql ofId(Integer id) {
		TblFwglLegalAdviserMySql tblFwglLegalAdviserMySql = new TblFwglLegalAdviserMySql();
