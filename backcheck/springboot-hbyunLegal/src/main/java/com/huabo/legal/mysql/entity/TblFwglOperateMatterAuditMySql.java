 ...
 * 经营事项审核表
 */
@Schema(name="TblFwglOperateMatterAuditMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_operate_matter_audit")
public class TblFwglOperateMatterAuditMySql implements Serializable {
	...
	public static TblFwglOperateMatterAuditMySql ofId(Integer id) {
		TblFwglOperateMatterAuditMySql tblFwglOperateMatterAuditMySql = new TblFwglOperateMatterAuditMySql();
