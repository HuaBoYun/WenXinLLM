 ...
 * 法律服务-律师信息表
 */
@Schema(name="TblFwglLawServiceLawyerOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_law_service_lawyer")
public class TblFwglLawServiceLawyerOracle implements Serializable {
	...
	public static TblFwglLawServiceLawyerOracle ofId(Long id) {
		TblFwglLawServiceLawyerOracle tblFwglLawServiceLawyerMySql = new TblFwglLawServiceLawyerOracle();
