 ...
 * 执业申请-简历表
 */
@Schema(name="TblFwglPracticeApplyExtMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_practice_apply_ext")
public class TblFwglPracticeApplyExtMySql implements Serializable {

	@Id
	@Column(name = "PRACTICEAPPLYEXTID")
	@GeneratedValue(generator = "JDBC")
	@Schema(name = "执业申请-简历ID")
	private Integer practiceApplyExtId;
	...
	public static TblFwglPracticeApplyExtMySql ofId(Integer id) {
		TblFwglPracticeApplyExtMySql tblFwglPracticeApplyExtMySql = new TblFwglPracticeApplyExtMySql();
