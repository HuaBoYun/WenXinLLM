package com.huabo.legal.exam.modules.sys.user.service.impl;
...
import com.huabo.legal.exam.core.enums.CommonState;
import com.huabo.legal.exam.core.exception.ServiceException;
import com.huabo.legal.exam.core.utils.BeanMapper;
import com.huabo.legal.exam.core.utils.passwd.PassHandler;
import com.huabo.legal.exam.core.utils.passwd.PassInfo;
//import com.huabo.legal.exam.ability.shiro.jwt.JwtUtils;
import com.huabo.legal.exam.modules.sys.user.dto.SysUserDTO;
import com.huabo.legal.exam.modules.sys.user.dto.request.SysUserSaveReqDTO;
import com.huabo.legal.exam.modules.sys.user.dto.response.SysUserLoginDTO;
import com.huabo.legal.exam.modules.sys.user.entity.SysUser;
import com.huabo.legal.exam.modules.sys.user.mapper.SysUserMapper;
import com.huabo.legal.exam.modules.sys.user.service.SysUserRoleService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
    ...
    public SysUserLoginDTO token(String token) {
        ...
        // 校验结果
        boolean check = true;//JwtUtils.verify(token, username);
