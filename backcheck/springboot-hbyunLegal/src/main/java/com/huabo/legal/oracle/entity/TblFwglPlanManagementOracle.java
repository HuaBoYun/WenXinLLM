 ...
 * 规范管理表
 */
@Schema(name="TblFwglPlanManagementOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_plan_management")
public class TblFwglPlanManagementOracle implements Serializable {
	...
	public static TblFwglPlanManagementOracle ofId(Long id) {
		TblFwglPlanManagementOracle tblFwglPlanManagementMySql = new TblFwglPlanManagementOracle();
