 ...
 * 法务机构及负责人扩展表
 */
@Schema(name="TblFwglLegalOrganizationExt")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_legal_organization_ext")
public class TblFwglLegalOrganizationExt implements Serializable {
	...
	public static TblFwglLegalOrganizationExt ofId(Long id) {
		TblFwglLegalOrganizationExt legalOrganizationExtMySql = new TblFwglLegalOrganizationExt();
