 ...
 * 法务人员信息表
 */
@Schema(name="TblFwglLegalPersonnelOracle")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_legal_personnel")
public class TblFwglLegalPersonnelOracle implements Serializable {
	...
	@Column(name = "STATE")
	@Schema(name="状态0-未审批、1-审批中、2-需调整、3-已通过、",hidden=true)
	...
	public static TblFwglLegalPersonnelOracle ofId(Long id) {
		TblFwglLegalPersonnelOracle legalPersonnelMySql = new TblFwglLegalPersonnelOracle();
