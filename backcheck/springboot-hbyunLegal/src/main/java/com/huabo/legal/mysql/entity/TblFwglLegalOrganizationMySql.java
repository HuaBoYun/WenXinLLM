 ...
 * 法务机构及负责人表
 */
@Schema(name="TblFwglLegalOrganizationMySql")
@Data
@Builder
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_legal_organization")
public class TblFwglLegalOrganizationMySql implements Serializable {
	...
	public static TblFwglLegalOrganizationMySql ofId(Integer id) {
		TblFwglLegalOrganizationMySql tblFwglLegalOrganizationMySql = new TblFwglLegalOrganizationMySql();
