 ...
 * 法律服务-工作报告表/服务登记
 */
@Schema(name="TblFwglLawServiceWorkReportMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_law_service_work_report")
public class TblFwglLawServiceWorkReportMySql implements Serializable {
	...
	public static TblFwglLawServiceWorkReportMySql ofId(Integer id) {
		TblFwglLawServiceWorkReportMySql tblFwglLawServiceWorkReportMySql = new TblFwglLawServiceWorkReportMySql();
