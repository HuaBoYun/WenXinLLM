 ...
 * 年度计划表
 */
@Schema(name="TblFwglAnnualPlanOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_annual_plan")
public class TblFwglAnnualPlanOracle implements Serializable {
	...
	public static TblFwglAnnualPlanOracle ofId(Long id) {
		TblFwglAnnualPlanOracle tblFwglAnnualPlanMySql = new TblFwglAnnualPlanOracle();
