package com.huabo.legal.exam.modules.qu.service.impl;
...
import com.huabo.legal.exam.modules.qu.dto.export.QuExportDTO;
import com.huabo.legal.exam.modules.qu.dto.ext.QuDetailDTO;
import com.huabo.legal.exam.modules.qu.dto.request.QuQueryReqDTO;
import com.huabo.legal.exam.modules.qu.entity.Qu;
import com.huabo.legal.exam.modules.qu.enums.QuType;
import com.huabo.legal.exam.modules.qu.mapper.QuMapper;
...
public class QuServiceImpl extends ServiceImpl<QuMapper, Qu> implements QuService {
    ...
    @Override
    public PageResult<QuDTO> paging(PagingReqDTO<QuQueryReqDTO> reqDTO) {
    	PageInfo<QuDTO> objectPageInfo = PageMethod.startPage(reqDTO.getCurrent(), reqDTO.getSize())
				.doSelectPageInfo(() -> baseMapper.paging(reqDTO.getParams()));
		return new PageResult<QuDTO>().build(objectPageInfo);
    }
