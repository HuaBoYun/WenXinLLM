 ...
 * 登记管理表
 */
@Schema(name="TblFwglRegisterManagementOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_register_management")
public class TblFwglRegisterManagementOracle implements Serializable {
	...
	public static TblFwglRegisterManagementOracle ofId(Long id) {
		TblFwglRegisterManagementOracle tblFwglRegisterManagementMySql = new TblFwglRegisterManagementOracle();
