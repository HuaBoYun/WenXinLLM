 ...
 * 法律服务-工作记录表
 */
@Schema(name="TblFwglLawServiceWorkRecord")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_law_service_work_record")
public class TblFwglLawServiceWorkRecord implements Serializable {
	...
	public static TblFwglLawServiceWorkRecord ofId(Long id) {
		TblFwglLawServiceWorkRecord tblFwglLawServiceWorkRecordMySql = new TblFwglLawServiceWorkRecord();
