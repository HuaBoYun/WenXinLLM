 ...
 * 制度审核/经营事项审核表
 */
@Schema(name="TblFwglInstitutionAuditOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_institution_audit")
public class TblFwglInstitutionAuditOracle implements Serializable {
	...
	@Column(name = "COMPANYGROUPOPINION")
	@Schema(name = "所属公司意见意见")
	private String companyGroupOpinion;
	...
	@Schema(name = "事项知会人员ID,多个逗号隔开(经营事项审核)")
	...
	@Column(name = "STATE")
	@Schema(name="制度审核状态0-未审批、1-审批中、2-需调整",hidden=true)
	private Integer state;

	@Column(name = "STATUS")
	@Schema(name="经营事项审核状态0-未审批、1-审批中、2-需调整",hidden=true)
	...
	public static TblFwglInstitutionAuditOracle ofId(Long id) {
		TblFwglInstitutionAuditOracle tblFwglInstitutionAuditMySql = new TblFwglInstitutionAuditOracle();
