 ...
 * 会议管理
 */
@Schema(name="TblFwglConferenceManagementOracle")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_conference_management")
public class TblFwglConferenceManagementOracle implements Serializable {
	...
	@Transient
	@Schema(name = "会议参与者名称 多个参与者用逗号隔开")
	...
	public static TblFwglConferenceManagementOracle ofId(Long id) {
		TblFwglConferenceManagementOracle tblFwglConferenceManagementMySql = new TblFwglConferenceManagementOracle();
