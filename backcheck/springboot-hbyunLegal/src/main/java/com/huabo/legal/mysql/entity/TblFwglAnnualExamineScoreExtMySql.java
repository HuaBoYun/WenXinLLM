 ...
 * 年度考核评分表
 */
@Schema(name="TblFwglAnnualExamineScoreExtMySql")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_annual_examine_score_ext")
public class TblFwglAnnualExamineScoreExtMySql implements Serializable {

	@Id
	@Column(name = "ANNUALEXAMINESCOREEXTID")
	@GeneratedValue(generator = "JDBC")
	@Schema(name = "年度考核评分ID")
	private Integer annualExamineScoreExtId;
	...
	private Integer annualExamineTopicExtId;
	...
	public static TblFwglAnnualExamineScoreExtMySql ofId(Integer id) {
		TblFwglAnnualExamineScoreExtMySql tblFwglAnnualExamineScoreExtMySql = new TblFwglAnnualExamineScoreExtMySql();
		tblFwglAnnualExamineScoreExtMySql.setAnnualExamineScoreExtId(id);
		return tblFwglAnnualExamineScoreExtMySql;
	}

	public static TblFwglAnnualExamineScoreExtMySql ofDelete(Integer annualExamineId) {
		TblFwglAnnualExamineScoreExtMySql tblFwglAnnualExamineScoreExtMySql = new TblFwglAnnualExamineScoreExtMySql();
