 ...
 * 法务人员扩展表
 */
@Schema(name="TblFwglLegalPersonnelExt")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tbl_fwgl_legal_personnel_ext")
public class TblFwglLegalPersonnelExt implements Serializable {
	...
	public static TblFwglLegalPersonnelExt ofId(Long id) {
		TblFwglLegalPersonnelExt tblFwglLegalPersonnelExtMySql = new TblFwglLegalPersonnelExt();
