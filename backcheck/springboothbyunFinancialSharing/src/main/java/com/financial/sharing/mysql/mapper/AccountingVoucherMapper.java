...
import com.financial.sharing.mysql.entity.AccountingVoucherEntity;
...
/**
 * 会计凭证 Mapper接口 - MySQL版本
 * 
 * @author system
 * @since 2024-12-19
 */
@Mapper
@Component("mysqlAccountingVoucherMapper")
public interface AccountingVoucherMapper extends BaseMapper<AccountingVoucherEntity> {
     ...
     * @return 分页结果
     */
    IPage<AccountingVoucherVO> selectAccountingVoucherPage(Page<AccountingVoucherVO> page, @Param("param") AccountingVoucherQueryParam param);
