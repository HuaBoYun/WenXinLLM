...
import com.financial.sharing.oracle.entity.TblOrganization;
import com.financial.sharing.oracle.entity.TblStaffOracle;
import com.financial.sharing.oracle.mapper.TblStaffOracleMapper;
import com.financial.sharing.oracle.service.TblStaffOracleService;
import com.financial.sharing.vo.param.UpdateUserOnDutyStatusParam;
import com.financial.sharing.vo.param.UserAllQueryParam;
import com.financial.sharing.vo.result.StaffResult;
import com.financial.sharing.vo.result.UserAllResult;
import com.financial.sharing.vo.result.UserInfo;
...
public class TblStaffOracleServiceImpl implements TblStaffOracleService {
	...
	public PageInfo<UserAllResult> getUserAllList(UserAllQueryParam param) {
		return PageMethod.startPage(param.getPageNum(), param.getPageSize()).doSelectPageInfo(() -> tblStaffOracleMapper.findUserAllList(param));
	}
