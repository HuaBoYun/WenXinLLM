...
import com.financial.sharing.oracle.entity.InfluenceFactorEntity;
...
/**
 * 影响因素定义 Mapper 接口 (Oracle/达梦数据库)
 * @author system
 * @since 2024-12-19
 */
@Component("oracleInfluenceFactorMapper")
public interface InfluenceFactorMapper extends BaseMapper<InfluenceFactorEntity> {

    /**
     * 分页查询影响因素 (使用PageHelper)
     * @param param 查询参数
     * @return 影响因素列表
     */
    List<InfluenceFactorEntity> selectInfluenceFactorPage(@Param("param") InfluenceFactorQueryParam param);
