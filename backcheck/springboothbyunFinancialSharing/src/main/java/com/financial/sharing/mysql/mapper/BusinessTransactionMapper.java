...
import com.financial.sharing.mysql.entity.BusinessTransactionEntity;
...
/**
 * 业务事项 Mapper接口 - MySQL版本
 * 
 * @author system
 * @since 2024-12-19
 */
@Mapper
@Component("mysqlBusinessTransactionMapper")
public interface BusinessTransactionMapper extends BaseMapper<BusinessTransactionEntity> {
     ...
     * @return 分页结果
     */
    IPage<BusinessTransactionVO> selectBusinessTransactionPage(Page<BusinessTransactionVO> page, @Param("param") BusinessTransactionQueryParam param);
