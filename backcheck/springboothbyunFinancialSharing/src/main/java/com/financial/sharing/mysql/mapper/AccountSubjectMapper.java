...
import com.financial.sharing.mysql.entity.AccountSubjectEntity;
...
/**
 * 会计科目 Mapper接口 - MySQL版本
 *
 * @author system
 * @since 2024-12-19
 */
@Mapper
@Component("mysqlAccountSubjectMapper")
public interface AccountSubjectMapper extends BaseMapper<AccountSubjectEntity> {
     ...
     * @return 分页结果
     */
    IPage<AccountSubjectVO> selectAccountSubjectPage(Page<AccountSubjectVO> page, @Param("param") AccountSubjectQueryParam param);
