...
public class BudgetPreparationEntity implements Serializable {
    ...
    /**
     * 预算明细 JSON 串
     * 存储 budgetDetails 数组（[{itemName, itemAmount, itemDescription}, ...]）的 fastjson 序列化结果
     * 数据库列：BUDGET_DETAILS_JSON VARCHAR(4000)
     */
    @TableField("BUDGET_DETAILS_JSON")
    private String budgetDetailsJson;
}
