...
import com.financial.sharing.mysql.entity.CurrencyRateEntity;
...
/**
 * 币种汇率 Mapper接口 - MySQL版本
 * 
 * @author system
 * @since 2024-12-19
 */
@Mapper
@Component("mysqlCurrencyRateMapper")
public interface CurrencyRateMapper extends BaseMapper<CurrencyRateEntity> {
     ...
     * @return 分页结果
     */
    IPage<CurrencyRateVO> selectCurrencyRatePage(Page<CurrencyRateVO> page, @Param("param") CurrencyRateQueryParam param);
