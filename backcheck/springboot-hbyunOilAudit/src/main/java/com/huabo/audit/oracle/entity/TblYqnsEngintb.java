 ...
 * 工程安排批次表
 *
 * @TableName TBL_YQNS_ENGINTB
 */
@TableName("TBL_YQNS_ENGINTB")
@Data
@Schema(name="实体类")
@Accessors(chain = true)
public class TblYqnsEngintb extends BaseReservedProperty implements Serializable {
...
//    @GeneratedValue(strategy = GenerationType.IDENTITY,generator = "select HIBERNATE_SEQUENCE.nextval from dual")
    ...
    @Schema(name = "项目集合")
    private List<TblYqnsEnginAuditProjectEntity> list;
