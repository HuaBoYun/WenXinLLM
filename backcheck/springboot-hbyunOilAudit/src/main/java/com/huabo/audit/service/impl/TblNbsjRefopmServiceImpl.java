...
//						 no = no.replace(solutioncode, "");
    ...
    public JsonBean getAllReformNbsjByProject(TblNbsjRefopm re, Integer pageNumber, Integer pageSize, BigDecimal projectid, String selectidIdsstr) throws Exception {
        ...
        if (projectid != null) {
            ...
            //链表分页  xml 写法
            com.github.pagehelper.PageInfo<TblNbsjRefopm> pageInfo = PageMethod.startPage(pageNumber, pageSize)
                    .doSelectPageInfo(() -> {
                        try {
                            String ids = selectidIdsstr.replaceAll("__p", "").replaceAll("__b", "");
                            this.reMapper.findNbsjReformList(projectid, re, ids);
                        } catch (Exception e) {
            ...
            PageResult<TblNbsjRefopm> build = new PageResult<TblNbsjRefopm>().build(pageInfo);
    ...
    public JsonBean findTblReformBySheetIdAndSoultionid(String code, BigDecimal soultionid, Integer pageNumber, Integer pageSize, TblNbsjRefopm re, String type, String token) throws Exception {
		...
		/*	Map<String,Object> resultMap = new HashMap<String,Object>(0);
            ...
            com.github.pagehelper.PageInfo<TblNbsjRefopm> pageInfo = PageMethod.startPage(pageNumber, pageSize)
                    .doSelectPageInfo(() -> {
                        try {
                            this.reMapper.findNbsjReformBySolution(soultionid, re, type);
                        } catch (Exception e) {
                            throw new RuntimeException(e);
                        }
                    });
    ...
    public JsonBean getAllReformNbsjBywxh(TblNbsjRefopm re, Integer pageNumber, Integer pageSize) throws Exception {
        ...
        com.github.pagehelper.PageInfo<TblNbsjRefopm> pageInfo = PageMethod.startPage(pageNumber, pageSize)
                .doSelectPageInfo(() -> {
                    try {
                        this.reMapper.findNbsjReformBySolutionPageInfowxh(re);
                    } catch (Exception e) {
                        throw new RuntimeException(e);
                    }
                });
    ...
    public JsonBean getResultall(BigDecimal soultionid, String token, String reformid) throws Exception {
        ...
        if (reformid != null) {
           /* Map<String, Object> resultMap = new HashMap<String, Object>(0);
            ...
            QueryWrapper<TblNbsjRefopm> wrapper = new QueryWrapper<>();
            wrapper.lambda().eq(TblNbsjRefopm::getSolutionid, soultionid);
            if (reformid.indexOf("__b") >= 0) {
                wrapper.lambda().eq(TblNbsjRefopm::getBugid, reformid.replace("__b", ""));
            } else {
                wrapper.lambda().eq(TblNbsjRefopm::getQuestionid, reformid.replace("__p", ""));
            }
            wrapper.lambda().isNotNull(TblNbsjRefopm::getReformresult);
            wrapper.orderByDesc(true, "reformid");
            List<TblNbsjRefopm> list = this.reMapper.selectList(wrapper);
            Map<Object, Object> resultMap = MapUtil.createMap(Map.class);
    ...
    public JsonBean selectNbsjReformByAll(BigDecimal auditorg, String code, String projectname, Integer pageNumber, Integer pageSize, String token) throws Exception {
        ...
        com.github.pagehelper.PageInfo<TblNbsjRefopm> pageInfo = PageMethod.startPage(pageNumber, pageSize)
                .doSelectPageInfo(() -> {
                    try {
                        this.reMapper.findNbsjReformByAllPageInfo(auditorg, code, projectname);
                    } catch (Exception e) {
                        throw new RuntimeException(e);
                    }
                });
    ...
    @Override
    public JsonBean getAttListByReformId(String token, Integer reformid) throws Exception {
