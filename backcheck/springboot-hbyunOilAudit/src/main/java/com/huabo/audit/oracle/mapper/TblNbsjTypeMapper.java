...
public interface TblNbsjTypeMapper extends BaseMapper<TblNbsjType> {
	...
	List<TblNbsjType> findByOrgidAndId(@Param("orgid")BigDecimal orgid,@Param("auditType")String auditType,@Param("typeid")Integer typeid);
	...
	void updateTblNbsjType(@Param("id")int id,@Param("type")String type,@Param("version")String version,@Param("orgid")String orgid,@Param("status")Integer status,@Param("auditCode")Integer auditCode) throws Exception;
	...
	List<TblNbsjType> selectNbsjTempleteListByPageInfo(PageInfo<TblNbsjType> pageInfo, BigDecimal orgid);

    @SelectProvider(method="selectNbsjTempleteListCountByPageInfo",type=TblNbsjTypeMapperSqlConfig.class)
	Integer selectNbsjTempleteListCountByPageInfo(PageInfo<TblNbsjType> pageInfo, BigDecimal orgid);
}
