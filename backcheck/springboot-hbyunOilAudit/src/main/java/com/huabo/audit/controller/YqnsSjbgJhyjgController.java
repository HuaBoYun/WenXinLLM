...
/**
 * @author wangxilu
 * @description 审计报告_交换意见稿
 */
@Tag(name="审计报告_交换意见稿",description="审计报告_交换意见稿")
@RestController
@RequestMapping(value = "/jhyjg")
public class YqnsSjbgJhyjgController {

    @Resource
    TblYqnsSjbgJhyjgService service;
