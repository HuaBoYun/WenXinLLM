...
public class TblNbsjStaffscoreController {
    ...
    public JsonBean getprojectLisbystaffid(HttpServletRequest request,
                                           ...
                                           @Parameter(name = "staffid", description = "选择的人员id", required = false) @RequestParam(value = "staffid", required = false) Integer staffid,
    ...
    public JsonBean getpjuserList(HttpServletRequest request,
                                  ...
                                  @Parameter(name = "jobExperiences", description = "经验", required = false) @RequestParam(value = "jobExperiences", required = false) String jobExperiences, @Parameter(name = "jobName", description = "岗位", required = false) @RequestParam("jobName") String jobName) {
        JsonBean jsonBean = null;
        try {
