 ...
 * 计划管理计划初稿审计类型明细
 *
 * @TableName TBL_YQNS_JHGL_JHCHUG_MX
 */
@TableName(value = "TBL_YQNS_JHGL_JHCHUG_MX")
@Data
@KeySequence(value = "HIBERNATE_SEQUENCE")
public class TblYqnsJhglJhchugMx implements Serializable {
     ...
     * 计划初稿审计类型明细主键
     */
    @Schema(name = "计划初稿审计类型明细主键")
    @TableId(value = "JHCHUGMXID", type = IdType.INPUT)
    private BigDecimal jhchugmxid;
