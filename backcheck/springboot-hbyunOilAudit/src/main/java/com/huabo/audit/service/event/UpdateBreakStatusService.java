...
@Service
public class UpdateBreakStatusService implements JavaDelegate{
	...
	public void execute(DelegateExecution exection) {
		...
		modle.setCystate(TblCirculation.STATE_ZD);
		this.cirmapper.updateCirculationInfoById(modle);
		this.callbackUpdateService.updateStatus(modle.getCyid(),TblCirculation.STATE_ZD);
	}
