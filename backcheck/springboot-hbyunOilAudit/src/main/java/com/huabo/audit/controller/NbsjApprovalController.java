...
public class NbsjApprovalController {
     ...
     * 查看当前流程图
     ...
     public void lookCurrentProcessImage(HttpServletRequest request, HttpServletResponse response,
    		 @Parameter(name = "taskId", description = "工作流任务主键", required = true) @RequestParam(value ="taskId", required = true) String taskId)throws IOException {
    ...
    @RequestMapping(value ="/submitAuditPlanApproval", produces ="application/json; charset=utf-8", method = {RequestMethod.POST})
 	...
 	public JsonBean dealAuditPlanApporvalInfo(HttpServletRequest request,HttpServletResponse response,
 			...
 			@Parameter(name = "planId", description = "审计计划主键", required = true) @RequestParam(value ="planId", required = true) String planId,
     ...
     @RequestMapping(value = "Project_Process", method = {RequestMethod.POST},produces = "application/json; charset=utf-8")
  	...
  	public String Project_Process(HttpServletRequest request,
  			@Parameter(name = "projectId", description = "审计项目主键", required = true) @RequestParam(value ="projectId", required = false) Integer projectId,
  									  @Parameter(name = "businessKey", description = "businessKey", required = false)@RequestParam(value="businessKey",required=true)String businessKey
  									  ) throws Exception {
  		String result = null;
  		try {
     ...
     public JsonBean getProjectApprovalInfo(HttpServletRequest request,
    		 @Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		 @Parameter(name = "projectId", description = "审计项目主键", required = true) @RequestParam(value ="projectId", required = true) Integer projectId,
    		 @Parameter(name = "taskId", description = "工作流任务主键", required = false) @RequestParam(value ="taskId", required = false) String taskId,
    		 @Parameter(name = "cyId", description = "审批记录主键", required = true) @RequestParam(value ="cyId", required = true) Integer cyId,
     ...
     @RequestMapping(value ="/submitTblAdvicenoteArrpoval", produces ="application/json; charset=utf-8", method = {RequestMethod.POST})
      ...
      public JsonBean submitTblAdvicenoteArrpoval(HttpServletRequest request,
      		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
      		@Parameter(name = "adviceid", description = "审计通知书id", required = true) @RequestParam(value ="adviceid", required = false) Integer adviceid) {
      	JsonBean jsonBean = null;
  		try {
     ...
     public JsonBean getTblAdvicenoteApprovalInfo(HttpServletRequest request,
     		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
     		@Parameter(name = "adviceid", description = "审计通知书id", required = true) @RequestParam(value ="adviceid", required = true) Integer adviceid,
     		@Parameter(name = "taskId", description = "工作流任务主键", required = true) @RequestParam(value ="taskId", required = true) String taskId,
     		@Parameter(name = "cyId", description = "审批记录主键", required = true) @RequestParam(value ="cyId", required = true) Integer cyId) {
     	JsonBean jsonBean = null;
 		try {
    ...
    public JsonBean submitTblNbsjSheetArrpoval(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "sheetid", description = "审计底稿id", required = true) @RequestParam(value ="sheetid", required = false) Integer sheetid,
    ...
    public JsonBean getTblNbsjSheetApprovalInfo(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "sheetid", description = "审计底稿id", required = true) @RequestParam(value ="sheetid", required = true) Integer sheetid,
    		@Parameter(name = "cyId", description = "审批记录主键", required = true) @RequestParam(value ="cyId", required = true) Integer cyId) {
    	JsonBean jsonBean = null;
    	try {
    ...
    public JsonBean submitTblNbsjFactbookArrpoval(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "factid", description = "事实确认书id", required = true) @RequestParam(value ="factid", required = false) Integer factid) {
    	JsonBean jsonBean = null;
    	try {
    ...
    public JsonBean getTblNbsjFactbookApprovalInfo(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "factid", description = "事实确认书id", required = true) @RequestParam(value ="factid", required = true) Integer factid,
    		@Parameter(name = "taskId", description = "工作流任务主键", required = true) @RequestParam(value ="taskId", required = true) String taskId,
    		@Parameter(name = "cyId", description = "审批记录主键", required = true) @RequestParam(value ="cyId", required = true) Integer cyId) {
    	JsonBean jsonBean = null;
    	try {
    ...
    @RequestMapping(value ="/submitReportZqyjApproval", produces ="application/json; charset=utf-8", method = {RequestMethod.POST})
     ...
     public JsonBean submitReportZqyjApproval(HttpServletRequest request,
     		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
     		@Parameter(name = "reportid", description = "审计报告主键", required = true) @RequestParam(value ="reportid", required = false) Integer reportid) {
     	JsonBean jsonBean = null;
 		try {
    ...
    public JsonBean submitReportSpApproval(HttpServletRequest request,
     ...
     public JsonBean getReportFhApprovalInfo(HttpServletRequest request,
     		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
     		@Parameter(name = "reportid", description = "审计报告主键", required = true) @RequestParam(value ="reportid", required = true) Integer reportid,
     		@Parameter(name = "taskId", description = "工作流任务主键", required = true) @RequestParam(value ="taskId", required = true) String taskId,
     		@Parameter(name = "cyId", description = "审批记录主键", required = true) @RequestParam(value ="cyId", required = true) Integer cyId) {
     	JsonBean jsonBean = null;
 		try {
     ...
     public JsonBean submitRecordApproval(HttpServletRequest request,
    		 @Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		 @Parameter(name = "borrowid", description = "主键", required = true) @RequestParam(value ="borrowid", required = false) Integer borrowid) {
    	 JsonBean jsonBean = null;
    	 try {
     ...
     public JsonBean getRecordApprovalInfo(HttpServletRequest request,
    		 @Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		 @Parameter(name = "borrowid", description = "主键", required = true) @RequestParam(value ="borrowid", required = true) Integer borrowid,
    		 @Parameter(name = "taskId", description = "工作流任务主键", required = true) @RequestParam(value ="taskId", required = true) String taskId,
    		 @Parameter(name = "cyId", description = "审批记录主键", required = true) @RequestParam(value ="cyId", required = true) Integer cyId) {
    	 JsonBean jsonBean = null;
    	 try {
     ...
     public JsonBean submitAuditUserApproval(HttpServletRequest request,
     		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
     		@Parameter(name = "staffid", description = "人员主键", required = true) @RequestParam(value ="staffid", required = false) Integer staffid) {
     	JsonBean jsonBean = null;
     	try {
     ...
     public JsonBean getAuditUserApprovalInfo(HttpServletRequest request,
     		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
     		@Parameter(name = "staffid", description = "人员主键", required = true) @RequestParam(value ="staffid", required = true) Integer staffid,
     		@Parameter(name = "cyId", description = "审批记录主键", required = true) @RequestParam(value ="cyId", required = true) Integer cyId) throws Exception {
     	JsonBean jsonBean = null;
 		try {
   ...
   public JsonBean getAuditUserApprovalView(HttpServletRequest request,
     ...
     public JsonBean getStaffScoreApprovalInfo(HttpServletRequest request,
     		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
     		@Parameter(name = "staffScoreid", description = "评价主键", required = true) @RequestParam(value ="staffScoreid", required = true) Integer staffScoreid,
     		@Parameter(name = "cyId", description = "审批记录主键", required = true) @RequestParam(value ="cyId", required = true) Integer cyId) {
     	JsonBean jsonBean = null;
 		try {
	...
	public @ResponseBody String submitStaffScoreApproval(HttpServletRequest request,
												@Parameter(name = "staffScoreid", description = "评价主键", required = false)Integer staffScoreid,
	...
	public JsonBean certificate_submit(HttpServletRequest request,
											   @Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
											   @Parameter(name = "certificateId", description = "审计取证单id", required = true) @RequestParam(value ="certificateId", required = false) Integer certificateId,
											   @Parameter(name = "examination", description = "审批意见", required = true)@RequestParam(value = "examination",required = false)String examination) {
		JsonBean jsonBean = null;
		try {
