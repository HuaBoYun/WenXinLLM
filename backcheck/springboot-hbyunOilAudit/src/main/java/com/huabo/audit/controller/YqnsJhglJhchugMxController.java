...
/**
 * @author wangys
 * @description 计划管理_计划草初稿明细
 */
@Tag(name="计划管理_计划草初稿明细",description="计划管理_计划草初稿明细")
@RestController
@RequestMapping(value = "/jhgljhchugmx")
public class YqnsJhglJhchugMxController {

    @Resource
    TblYqnsJhglJhchugMxService service;
    ...
    @Operation(summary = "单个详情接口", description = "jhchugmxid=?")
    @GetMapping("/detail")
