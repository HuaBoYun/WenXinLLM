 ...
 * 计划管理计划明细
 *
 * @TableName TBL_YQNS_JHGL_JH_MX
 */
@TableName(value = "TBL_YQNS_JHGL_JH_MX")
@Data
@KeySequence(value = "HIBERNATE_SEQUENCE")
public class TblYqnsJhglJhMx implements Serializable {
     ...
     */
    @Schema(name = "计划明细主键")
    @TableId(value = "JHMXID", type = IdType.INPUT)
    private BigDecimal jhmxid;
