...
public interface AuditModelService {
	 ...
	 * @return
	 */
	JsonBean getTblAuditModelExcel(BigDecimal id) throws Exception;
	 ...
	 * @return
	 */
	JsonBean deleteTblAuditModelExcelExt(BigDecimal id);
	 ...
	 * @return
	 */
	JsonBean getTblAuditModelExcelExt(BigDecimal id);
	 ...
	 * @return
	 */
	JsonBean deleteTblAuditModelExcelTable(BigDecimal id);
	 ...
	 * @return
	 */
	JsonBean getTblAuditModelExcelTable(BigDecimal id);
