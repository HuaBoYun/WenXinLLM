...
/**
 * @author wangys
 * @description 计划管理_计划明细
 */
@Tag(name="计划管理_计划明细",description="计划管理_计划明细")
@RestController
@RequestMapping(value = "/jhgljhmx")
public class YqnsJhglJhMxController {

    @Resource
    TblYqnsJhglJhMxService service;
