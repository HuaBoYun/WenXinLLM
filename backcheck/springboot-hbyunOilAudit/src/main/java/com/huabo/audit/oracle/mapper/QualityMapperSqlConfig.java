 ...
 * @DATE 2023/10/9
 */
public class QualityMapperSqlConfig {

    public String selectByEntity( QualityEntity qualityEntity){
        StringBuffer sb = new StringBuffer();
        //	sb.append("SELECT * FROM (SELECT T1.* , ROWNUM RN FROM (");
        sb.append("SELECT * FROM TBL_YQNS_QUALITY RS WHERE TYPE= "+ qualityEntity.getType());

        if(qualityEntity.getProject() != null &&  StringUtil.isNotEmpty(qualityEntity.getProject().getProjectName())){
            sb.append("AND RS.PROJECT_ID IN (SELECT ID FROM TBL_YQNS_IMPLEMENT_PLAN WHERE PROJECT_NAME LIKE '%"+qualityEntity.getProject().getProjectName()+"%')");
        }
...
//        sb.append(" ) T1 WHERE ROWNUM <= "+(pageInfo.getCurrentRecord() + pageInfo.getPageSize() )+" ) T2 WHERE T2.RN > "+ pageInfo.getCurrentRecord());
    ...
    public String selectCountByEntity(QualityEntity qualityEntity){
        StringBuffer sb = new StringBuffer();
    ...
    public String updateEntity(QualityEntity qualityEntity){
        StringBuffer sb = new StringBuffer();
        sb.append("UPDATE TBL_YQNS_QUALITY SET ");
        sb.append("PROJECT_ID = '"+qualityEntity.getProjectId()+"'");

        if(qualityEntity.getScore() != null){
            sb.append(", SCORE = '"+qualityEntity.getScore()+"'");
        }

//        if(qualityEntity.getType() != null){
//            sb.append(", TYPE = '"+qualityEntity.getType()+"'");
//        }

        if(StringUtil.isNotEmpty(  qualityEntity.getOrgId() )){
            sb.append(", ORG_ID = '" + qualityEntity.getOrgId()+"'");
        }

        if(qualityEntity.getStartTime() != null){
            sb.append(", START_TIME = '"+ DateUtil.format(qualityEntity.getStartTime(),"yyyy-MM-dd")+"'");
        }

        // 预留字符串（输入框）10个
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString1())){
            sb.append(", RESERVEDSTRING1 = '"+qualityEntity.getReservedString1()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString2())){
            sb.append(", RESERVEDSTRING2 = '"+qualityEntity.getReservedString2()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString3())){
            sb.append(", RESERVEDSTRING3 = '"+qualityEntity.getReservedString3()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString4())){
            sb.append(", RESERVEDSTRING4 = '"+qualityEntity.getReservedString4()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString5())){
            sb.append(", RESERVEDSTRING5 = '"+qualityEntity.getReservedString5()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString6())){
            sb.append(", RESERVEDSTRING6 = '"+qualityEntity.getReservedString6()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString7())){
            sb.append(", RESERVEDSTRING7 = '"+qualityEntity.getReservedString7()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString8())){
            sb.append(", RESERVEDSTRING8 = '"+qualityEntity.getReservedString8()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString9())){
            sb.append(", RESERVEDSTRING9 = '"+qualityEntity.getReservedString9()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedString10())){
            sb.append(", RESERVEDSTRING10 = '"+qualityEntity.getReservedString10()+"'");
        }
        // 预留大文本（文本域）10个
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent1())){
            sb.append(", RESERVEDCONTENT1 = '"+qualityEntity.getReservedContent1()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent2())){
            sb.append(", RESERVEDCONTENT2 = '"+qualityEntity.getReservedContent2()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent3())){
            sb.append(", RESERVEDCONTENT3 = '"+qualityEntity.getReservedContent3()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent4())){
            sb.append(", RESERVEDCONTENT4 = '"+qualityEntity.getReservedContent4()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent5())){
            sb.append(", RESERVEDCONTENT5 = '"+qualityEntity.getReservedContent5()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent6())){
            sb.append(", RESERVEDCONTENT6 = '"+qualityEntity.getReservedContent6()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent7())){
            sb.append(", RESERVEDCONTENT7 = '"+qualityEntity.getReservedContent7()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent8())){
            sb.append(", RESERVEDCONTENT8 = '"+qualityEntity.getReservedContent8()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent9())){
            sb.append(", RESERVEDCONTENT9 = '"+qualityEntity.getReservedContent9()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedContent10())){
            sb.append(", RESERVEDCONTENT10 = '"+qualityEntity.getReservedContent10()+"'");
        }
        // 预留下拉多选字符串（多选下拉）5个
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownMultiple1())){
            sb.append(", RESERVEDDROPDOWNMULTIPLE1 = '"+qualityEntity.getReservedDropdownMultiple1()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownMultiple2())){
            sb.append(", RESERVEDDROPDOWNMULTIPLE2 = '"+qualityEntity.getReservedDropdownMultiple2()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownMultiple3())){
            sb.append(", RESERVEDDROPDOWNMULTIPLE3 = '"+qualityEntity.getReservedDropdownMultiple3()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownMultiple4())){
            sb.append(", RESERVEDDROPDOWNMULTIPLE4 = '"+qualityEntity.getReservedDropdownMultiple4()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownMultiple5())){
            sb.append(", RESERVEDDROPDOWNMULTIPLE5 = '"+qualityEntity.getReservedDropdownMultiple5()+"'");
        }

        // 预留多选字符串（多选框）5个
        if(StringUtil.isNotEmpty(qualityEntity.getReservedMultipleChoice1())){
            sb.append(", RESERVEDMULTIPLECHOICE1 = '"+qualityEntity.getReservedMultipleChoice1()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedMultipleChoice2())){
            sb.append(", RESERVEDMULTIPLECHOICE2 = '"+qualityEntity.getReservedMultipleChoice2()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedMultipleChoice3())){
            sb.append(", RESERVEDMULTIPLECHOICE3 = '"+qualityEntity.getReservedMultipleChoice3()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedMultipleChoice4())){
            sb.append(", RESERVEDMULTIPLECHOICE4 = '"+qualityEntity.getReservedMultipleChoice4()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedMultipleChoice5())){
            sb.append(", RESERVEDMULTIPLECHOICE5 = '"+qualityEntity.getReservedMultipleChoice5()+"'");
        }
        // 预留年份（年份）5个

        if(qualityEntity.getReservedYearTime1() != null){
            sb.append(", RESERVEDYEARTIME1 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearTime1(),"yyyy")+"','YYYY')");
        }
        if(qualityEntity.getReservedYearTime2() != null){
            sb.append(", RESERVEDYEARTIME2 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearTime2(),"yyyy")+"','YYYY')");
        }
        if(qualityEntity.getReservedYearTime3() != null){
            sb.append(", RESERVEDYEARTIME3 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearTime3(),"yyyy")+"','YYYY')");
        }
        if(qualityEntity.getReservedYearTime4() != null){
            sb.append(", RESERVEDYEARTIME4 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearTime4(),"yyyy")+"','YYYY')");
        }
        if(qualityEntity.getReservedYearTime5() != null){
            sb.append(", RESERVEDYEARTIME5 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearTime5(),"yyyy")+"','YYYY')");
        }
        // 预留时间（日期（年月日时分秒））5个
        if(qualityEntity.getReservedYearAccurateTime1() != null){
            sb.append(", RESERVEDYEARACCURATETIME1 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearAccurateTime1(),"yyyy-MM-dd HH:mm:ss")+"','YYYY-MM-DD HH24:MI:SS')");
        }
        if(qualityEntity.getReservedYearAccurateTime2() != null){
            sb.append(", RESERVEDYEARACCURATETIME2 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearAccurateTime2(),"yyyy-MM-dd HH:mm:ss")+"','YYYY-MM-DD HH24:MI:SS')");
        }
        if(qualityEntity.getReservedYearAccurateTime3() != null){
            sb.append(", RESERVEDYEARACCURATETIME3 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearAccurateTime3(),"yyyy-MM-dd HH:mm:ss")+"','YYYY-MM-DD HH24:MI:SS')");
        }
        if(qualityEntity.getReservedYearAccurateTime4() != null){
            sb.append(", RESERVEDYEARACCURATETIME4 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearAccurateTime4(),"yyyy-MM-dd HH:mm:ss")+"','YYYY-MM-DD HH24:MI:SS')");
        }
        if(qualityEntity.getReservedYearAccurateTime5() != null){
            sb.append(", RESERVEDYEARACCURATETIME5 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedYearAccurateTime5(),"yyyy-MM-dd HH:mm:ss")+"','YYYY-MM-DD HH24:MI:SS')");
        }
        // 预留年月日（日期（年月日））5个
        if(qualityEntity.getReservedTime1() != null){
            sb.append(", RESERVEDTIME1 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedTime1(),"yyyy-MM-dd")+"','YYYY-MM-DD')");
        }
        if(qualityEntity.getReservedTime2() != null){
            sb.append(", RESERVEDTIME2 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedTime2(),"yyyy-MM-dd")+"','YYYY-MM-DD')");
        }
        if(qualityEntity.getReservedTime3() != null){
            sb.append(", RESERVEDTIME3 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedTime3(),"yyyy-MM-dd")+"','YYYY-MM-DD')");
        }
        if(qualityEntity.getReservedTime4() != null){
            sb.append(", RESERVEDTIME4 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedTime4(),"yyyy-MM-dd")+"','YYYY-MM-DD')");
        }
        if(qualityEntity.getReservedTime5() != null){
            sb.append(", RESERVEDTIME5 = TO_DATE('"+DateUtil.format(qualityEntity.getReservedTime5(),"yyyy-MM-dd")+"','YYYY-MM-DD')");
        }
        // 预留单选字符串（单选框）5个
        if(StringUtil.isNotEmpty(qualityEntity.getReservedSingleChoice1())){
            sb.append(", RESERVEDSINGLECHOICE1 = '"+qualityEntity.getReservedSingleChoice1()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedSingleChoice2())){
            sb.append(", RESERVEDSINGLECHOICE2 = '"+qualityEntity.getReservedSingleChoice2()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedSingleChoice3())){
            sb.append(", RESERVEDSINGLECHOICE3 = '"+qualityEntity.getReservedSingleChoice3()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedSingleChoice4())){
            sb.append(", RESERVEDSINGLECHOICE4 = '"+qualityEntity.getReservedSingleChoice4()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedSingleChoice5())){
            sb.append(", RESERVEDSINGLECHOICE5 = '"+qualityEntity.getReservedSingleChoice5()+"'");
        }
        // 预留下拉单选字符串（单选下拉框）5个
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownSingleChoice1())){
            sb.append(", RESERVEDDROPDOWNSINGLECHOICE1 = '"+qualityEntity.getReservedDropdownSingleChoice1()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownSingleChoice2())){
            sb.append(", RESERVEDDROPDOWNSINGLECHOICE2 = '"+qualityEntity.getReservedDropdownSingleChoice2()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownSingleChoice3())){
            sb.append(", RESERVEDDROPDOWNSINGLECHOICE3 = '"+qualityEntity.getReservedDropdownSingleChoice3()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownSingleChoice4())){
            sb.append(", RESERVEDDROPDOWNSINGLECHOICE4 = '"+qualityEntity.getReservedDropdownSingleChoice4()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getReservedDropdownSingleChoice5())){
            sb.append(", RESERVEDDROPDOWNSINGLECHOICE5 = '"+qualityEntity.getReservedDropdownSingleChoice5()+"'");
        }
        // 预留数字（数字输入框）5个
        if(qualityEntity.getReservedNum1() != null){
            sb.append(", RESERVEDNUM1 = "+qualityEntity.getReservedNum1());
        }
        if(qualityEntity.getReservedNum2() != null){
            sb.append(", RESERVEDNUM2 = "+qualityEntity.getReservedNum2());
        }
        if(qualityEntity.getReservedNum3() != null){
            sb.append(", RESERVEDNUM3 = "+qualityEntity.getReservedNum3());
        }
        if(qualityEntity.getReservedNum4() != null){
            sb.append(", RESERVEDNUM4 = "+qualityEntity.getReservedNum4());
        }
        if(qualityEntity.getReservedNum5() != null){
            sb.append(", RESERVEDNUM5 = "+qualityEntity.getReservedNum5());
        }
        // 预留人员单选 5个
        if(qualityEntity.getStaffid1() != null){
            sb.append(", STAFFID1 = "+qualityEntity.getStaffid1());
        }
        if(qualityEntity.getStaffid2() != null){
            sb.append(", STAFFID2 = "+qualityEntity.getStaffid2());
        }
        if(qualityEntity.getStaffid3() != null){
            sb.append(", STAFFID3 = "+qualityEntity.getStaffid3());
        }
        if(qualityEntity.getStaffid4() != null){
            sb.append(", STAFFID4 = "+qualityEntity.getStaffid4());
        }
        if(qualityEntity.getStaffid5() != null){
            sb.append(", STAFFID5 = "+qualityEntity.getStaffid5());
        }
        // 预留人员多选 5个
        if(StringUtil.isNotEmpty(qualityEntity.getStaffids1())){
            sb.append(", STAFFIDS1 = '"+qualityEntity.getStaffids1()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getStaffids2())){
            sb.append(", STAFFIDS2 = '"+qualityEntity.getStaffids2()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getStaffids3())){
            sb.append(", STAFFIDS3 = '"+qualityEntity.getStaffids3()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getStaffids4())){
            sb.append(", STAFFIDS4 = '"+qualityEntity.getStaffids4()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getStaffids5())){
            sb.append(", STAFFIDS5 = '"+qualityEntity.getStaffids5()+"'");
        }
        // 预留组织单选 5个
        if(qualityEntity.getOrgid1() != null){
            sb.append(", ORGID1 = "+qualityEntity.getOrgid1());
        }
        if(qualityEntity.getOrgid2() != null){
            sb.append(", ORGID2 = "+qualityEntity.getOrgid2());
        }
        if(qualityEntity.getOrgid3() != null){
            sb.append(", ORGID3 = "+qualityEntity.getOrgid3());
        }
        if(qualityEntity.getOrgid4() != null){
            sb.append(", ORGID4 = "+qualityEntity.getOrgid4());
        }
        if(qualityEntity.getOrgid5() != null){
            sb.append(", ORGID5 = "+qualityEntity.getOrgid5());
        }
        // 预留组织多选 5个
        if(StringUtil.isNotEmpty(qualityEntity.getOrgids1())){
            sb.append(", ORGIDS1 = '"+qualityEntity.getOrgids1()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getOrgids2())){
            sb.append(", ORGIDS2 = '"+qualityEntity.getOrgids2()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getOrgids3())){
            sb.append(", ORGIDS3 = '"+qualityEntity.getOrgids3()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getOrgids4())){
            sb.append(", ORGIDS4 = '"+qualityEntity.getOrgids4()+"'");
        }
        if(StringUtil.isNotEmpty(qualityEntity.getOrgids5())){
            sb.append(", ORGIDS5 = '"+qualityEntity.getOrgids5()+"'");
        }


        sb.append(" WHERE ID = '"+qualityEntity.getId()+"'");

        return sb.toString();
    }


    public String insertEntity(QualityEntity qualityEntity){
        StringBuffer colSb = new StringBuffer();
        colSb.append("INSERT INTO TBL_YQNS_QUALITY (ID");
        ...
        if(qualityEntity.getScore() != null){
            colSb.append(", SCORE");
            valSb.append(", '" + qualityEntity.getScore() + "'");
        }

        if(qualityEntity.getType() != null){
            colSb.append(", TYPE");
            valSb.append(", '" + qualityEntity.getType() + "'");
        }
    ...
    public String deleteByIds(String ids){
        StringBuffer sb = new StringBuffer();
        sb.append("DELETE FROM TBL_YQNS_QUALITY WHERE ID IN (" + ids+")");
        return sb.toString();
    }

    public String insertQualityItem(BigDecimal qualityId, QualityItemEntity qualityItemEntity){
        StringBuffer colSb = new StringBuffer();
        colSb.append("INSERT INTO TBL_YQNS_QUALITY_ITEM (ID");

        StringBuffer valSb = new StringBuffer();
        valSb.append(" VALUES (HIBERNATE_SEQUENCE.nextval");

        if(StringUtil.isNotEmpty(qualityItemEntity.getDeductReason())){
            colSb.append(", DEDUCT_REASON");
            valSb.append(", '" + qualityItemEntity.getDeductReason() + "'");
        }

        if(qualityItemEntity.getScore() != null){
            colSb.append(", SCORE");
            valSb.append(", '" + qualityItemEntity.getScore() + "'");
        }else {
        	 colSb.append(", SCORE");
             valSb.append(", 0 ");
        }
        ...
        if(qualityId != null){
            colSb.append(", QUALITY_ID");
            valSb.append(", '" + qualityId + "'");
        }


        if(qualityItemEntity.getSmItem() != null && qualityItemEntity.getSmItem().getId() != null){
            colSb.append(", SMITEM_ID");
            valSb.append(", '" + qualityItemEntity.getSmItem().getId() + "'");
        }
    ...
    public String deleteQualityItemsById(String ids){
        StringBuffer sb = new StringBuffer("DELETE FROM TBL_YQNS_QUALITY_ITEM WHERE QUALITY_ID IN ("+ids+")");
        return sb.toString();
    }
}
