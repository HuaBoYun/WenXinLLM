...
public class TblYqnsJhglJhcg extends BaseReservedProperty implements Serializable {
    ...
    @TableField(exist = false)
    private List<TblYqnsJhglJhcgGL> leaveAudit3LEntityList;
    ...
    @TableField(exist = false)
    private List<TblYqnsJhglJhcgGL> tblYqnsJsxmJbqkList;
    ...
    @TableField(exist = false)
    private List<TblYqnsJhglJhcgGL> tblYqnsGcxmjgYsjhList;
    
    @Schema(name = "其他审计项目集合")
    @TableField(exist = false)
    private List<TblYqnsOtherAudit> oauList;

    @Schema(name = "审计类型明细主键集合")
    @TableField(exist = false)
