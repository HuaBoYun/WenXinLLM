...
/**
 * @author wangys
 * @description 项目管理_审前调查报告
 */
@Tag(name="项目管理_审前调查报告",description="项目管理_审前调查报告")
@RestController
@RequestMapping(value = "/xmglsqdcbg")
public class YqnsSqdcbgController {

    @Resource
    TblYqnsSqdcbgService service;
    ...
    @Operation(summary = "单个详情接口", description = "sqdcbgid=?")
    @GetMapping("/detail")
