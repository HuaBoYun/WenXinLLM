 ...
 * 财务安排批次表
 *
 * @TableName TBL_YQNS_FUNDTB
 */
@TableName("TBL_YQNS_FUNDTB")
@Data
@Schema(name="实体类")
@Accessors(chain = true)
public class TblYqnsFundtb extends BaseReservedProperty implements Serializable {
...
//    @GeneratedValue(strategy = GenerationType.IDENTITY,generator = "select HIBERNATE_SEQUENCE.nextval from dual")
    ...
    @Schema(name = "项目集合")
    private List<TblYqnsFundAuditProjectEntity> list;
