...
@Configuration
@MapperScan(basePackages = "com.huabo.audit.mysql.mapper" , sqlSessionTemplateRef = "mysqlSqlSessionTemplate")
public class DataSourceMySqlConfig {
	...
	public SqlSessionFactory mysqlSqlSessionFactory(@Qualifier(value = "mysqlDataSource") DataSource dataSource,MybatisProperties mybatisProperties) throws Exception {
		...
		bean.setTypeAliasesPackage("com.huabo.audit.mysql.entity");
