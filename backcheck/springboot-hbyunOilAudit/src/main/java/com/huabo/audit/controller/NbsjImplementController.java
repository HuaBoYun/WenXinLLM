...
public class NbsjImplementController {
	...
	public JsonBean in_meet_record_file_list(HttpServletRequest request, 
			...
			@Parameter(name = "enterid", description = "业务主键", required = true) @RequestParam(value = "enterid", required = true) Integer enterid) {
    ...
    public JsonBean met_delete(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "enterid", description = "主键", required = true)@RequestParam(value = "enterid", required = true) Integer enterid) {
...
//	}
	...
	public JsonBean out_meet_record_file_list(HttpServletRequest request, 
			@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,
			@Parameter(name = "leaveid", description = "业务主键", required = true) @RequestParam(value = "leaveid", required = true) Integer leaveid) {
    ...
    public JsonBean lev_delete(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "leaveid", description = "主键", required = true)@RequestParam(value = "leaveid", required = true) Integer leaveid) {
	...
	public void out_meet_record_export(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		String fileName1 = FREEMARKER_PATH +"/"+ fileName;
		fileName1=new String(fileName1.getBytes(StandardCharsets.UTF_8), StandardCharsets.ISO_8859_1);
//		logger.info("导出地址："+fileName1);
    ...
    public JsonBean check_final(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "operateid", description = "主键", required = true)@RequestParam(value = "operateid", required = true) Integer operateid,
    		@Parameter(name = "programId", description = "主键", required = true)@RequestParam(value = "programId", required = true) Integer programId) {
    ...
    public JsonBean workReportSave(HttpServletRequest request,@Parameter(name = "lev", description = "实体", required = true)TblNbsjWorkReportEntity wr,
			 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token,
			 @Parameter(name = "attids", description = "附件id数组", required = false)String attids)throws Exception{
		JsonBean jsonBean = null;
		try {
    ...
    public JsonBean project_standard_dg_add(HttpServletRequest request,@Parameter(name = "lev", description = "实体", required = true)TblNbsjSheetEntity sheet,
			 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token,
			 @Parameter(name = "attids", description = "附件id数组", required = false)@RequestParam(value="attids", required = false)String attids,
			 @Parameter(name = "certificateIds", description = "审计取证单ids", required = false)@RequestParam(value="certificateIds", required = false)String certificateIds,
			 @Parameter(name = "bugIds", description = "关联缺陷", required = false)@RequestParam(value="bugIds", required = false)String bugIds,
...
//					+ "{\"reportConcent\": \"报告错误内容222222\", \"sjdeptIds\": \"198328\" }]";
			...
			jsonBean = this.tBlNbsjSheetService.projectStandardDgAdd(sheet,token,attids,srJson,certificateIds,bugIds);
		} catch (Exception e) {
			ResponseFormat.retParam(1,1000,e.getMessage());
		}
		return jsonBean;
    ...
    @RequestMapping(value = "/sjss/getNbsjCertificateList", produces = "application/json; charset=utf-8", method = {RequestMethod.POST})
      ...
      public JsonBean getNbsjCertificateList(HttpServletRequest request,
      		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,@Parameter(name = "sheetid", description = "业务主键", required = true) @RequestParam(value = "sheetid", required = true) Integer sheetid)
    {
      	JsonBean jsonBean = null;
      	try {
	...
	public JsonBean project_standard_dg_file_list(HttpServletRequest request, 
			@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,
			@Parameter(name = "sheetid", description = "业务主键", required = true) @RequestParam(value = "sheetid", required = true) Integer sheetid) {
	...
	public void project_standard_dg_export(HttpServletRequest request, HttpServletResponse response,
										   ...
										   @Parameter(name = "projectid", description = "项目id，非必填", required = false)@RequestParam(value = "projectid", required = false) Integer projectid) throws Exception {
		...
		try {
			response.setHeader("Content-Disposition", "attachment; filename=" + new String("底稿管理".getBytes(), StandardCharsets.UTF_8) + ".xlsx");// 组装附件名称和格式
			ServletOutputStream outputStream = response.getOutputStream();
			List<Object[]> objList1 = new ArrayList<Object[]>();
			List<TblNbsjSheetEntity> objList = tBlNbsjSheetService.OBJfindAllByProjectidstaff(project.getProjectId(), token);
			if(type!=null && type.equals("1")) {
				objList = tBlNbsjSheetService.OBJfindAllByProjectid(project.getProjectId(), token);
			}
...
//				o.setEjfh(str1.equals("") ? "" : str1);
	...
	public JsonBean rwdggl_list(HttpServletRequest request, TBlNbsjSheetVo tBlNbsjSheetVo,
			@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,
			@Parameter(name = "operateid", description = "任务id", required = false) @RequestParam(value = "operateid", required = false) Integer operateid,
			@Parameter(name = "pageNumber", description = "分页当前页数", required = false) @RequestParam(value = "pageNumber", required = false, defaultValue = "1") Integer pageNumber,
			@Parameter(name = "pageSize", description = "每页记录数", required = false) @RequestParam(value = "pageSize", required = false, defaultValue = "15") Integer pageSize) {
...
//    }
	...
	public JsonBean defect_file_export(HttpServletRequest request, HttpServletResponse response,@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,TblNbsjQuestionVo tblNbsjQuestionVo) throws Exception {
		JsonBean jsonBean = null;
			try {
				...
				response.setContentType("application/binary;charset=UTF-8");
				response.setHeader("Content-Disposition", "attachment; filename=" + new String("审计发现".getBytes(), StandardCharsets.UTF_8) + ".xlsx");// 组装附件名称和格式
				ServletOutputStream outputStream = response.getOutputStream();
				List<Object[]> objList1 = new ArrayList<Object[]>();
				...
				for (int i = 0; i < list.size(); i++) {
					...
					tempob[4] = o.getBusinessAffiliation();
					tempob[5] = o.getTargetName();
					tempob[6] = o.getBusinessType();
					tempob[7] = o.getQuesTitle();
					tempob[8] = o.getSuditProcess();
					tempob[9] = o.getSjbwl();
					tempob[10] = o.getRealname();
					if(o.getSfssqr()!=null&&o.getSfssqr()>0){
						tempob[11]="是";
					}else{
						tempob[11]="未确认";
					}
					if(o.getSfzg()!=null&&o.getSfzg()>0){
						tempob[12]="是";
					}else{
						tempob[12]="否";
					}
    ...
    public JsonBean zgfp_fqStatus(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "questionid", description = "主键", required = true)@RequestParam(value = "questionid", required = true) Integer questionid) {
...
//    }
	...
	public JsonBean confirmation_file_list(HttpServletRequest request, 
			@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,
			@Parameter(name = "factid", description = "业务主键", required = true) @RequestParam(value = "factid", required = true) Integer factid) {
		JsonBean jsonBean = null;
		try {
    ...
    public JsonBean confirmation_del(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "factid", description = "主键", required = true)@RequestParam(value = "factid", required = true) Integer factid) {
	...
	public JsonBean confirmation_question_link(HttpServletRequest request, 
			@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,TblNbsjQuestionVo tblNbsjQuestionVo,
			@Parameter(name="factid",description="factid",required=false) @RequestParam(value = "factid", required = false) Integer factid) {
		JsonBean jsonBean = null;
		try {
	...
	public JsonBean dp_file_list(HttpServletRequest request, 
			@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,
			@Parameter(name = "dpointid", description = "业务主键", required = true) @RequestParam(value = "dpointid", required = true) Integer dpointid) {
    ...
    public JsonBean dp_del(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "dpointid", description = "主键", required = true)@RequestParam(value = "dpointid", required = true) Integer dpointid) {
