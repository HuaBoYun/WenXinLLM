...
@Schema(name="TblProcessAnalysis对象")
public class TblProcessAnalysis implements Serializable {
    ...
    private String usertaskid;
      ...
      public final static String TYPE_PJSH="评价管理";
      public final static String URL_PJSH="/nbsj/sjss/to_sp_pjsh_info?staffScoreid=";
