...
/**
 * @author wangys
 * @description 计划管理_建设项目基本情况汇总控制器
 * @createDate 2023-09-07 16:46:40
 */
@Tag(name="计划管理_建设项目基本情况汇总",description="计划管理_建设项目基本情况汇总")
@RestController
@RequestMapping(value = "/jsxmjbqkhz")
public class YqnsJsxmJbqkhzController {

    @Resource
    TblYqnsJsxmJbqkhzService service;
    ...
    @Operation(summary = "单个详情接口", description = "hzid=?")
    @GetMapping("/detail")
