...
public interface TblTargetTypeService extends IService<TblTargetTypeEntity>{
    ...
    */
	...
	List<TblTargetTypeEntity> getRoottype(BigDecimal tempId);
	...
	public List<Tree> getTreeByUser(BigDecimal parentId,BigDecimal tempId,Integer projectId, BigDecimal staffId,String url);
