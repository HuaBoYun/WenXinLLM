...
* @date: 2022-04-13
*/
public interface TblNbsjQuestionService extends IService<TblNbsjQuestionEntity> {
...
//			int i, int pageSize, String factid, String sheetidsstr);
	...
	JsonBean questionStorePageList(String token, Integer pageNumber, Integer pageSize,TblNbsjQuestionVo tblNbsjQuestionVo,Integer projectid) throws Exception;
	
	 List<TblNbsjSheetEntity>  getQuestionStorePageList(TblStaffUtil loginStaff,TblNbsjQuestionVo tblNbsjQuestionVo,Integer projectid) throws Exception;

	JsonBean questionStorePageAdd(TblNbsjQuestionEntity tnq, String token)throws Exception;
    
    JsonBean questionStorePageDelete(Integer questionid, String token) throws Exception;
    
    JsonBean questionStorePageFQZG(Integer questionid, String token) throws Exception;
	...
	JsonBean confirmationQuestionStoreLink(String token, Integer factid) throws Exception;
