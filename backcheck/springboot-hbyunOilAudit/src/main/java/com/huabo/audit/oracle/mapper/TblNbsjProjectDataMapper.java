...
public interface TblNbsjProjectDataMapper extends tk.mybatis.mapper.common.Mapper<TblNbsjProjectDataEntity>{
    ...
    @SelectProvider(method="selectCountByPageInfo",type=TblNbsjProjectDataMapperSqlConfig.class)
   	Integer selectCountByPageInfo(PageInfo<TblNbsjProjectDataEntity> pageInfo,DataProVo dataProVo,Integer orgid,Integer projectId,BigDecimal type) throws Exception;
    ...
    @Results({
   	...
   	TblNbsjProjectDataEntity selectById(@Param("dataId") Integer dataId) throws Exception;
	...
	List<TblNbsjProjectDataEntity> selectListByPageInfo(PageInfo<TblNbsjProjectDataEntity> pageInfo,DataProVo dataProVo,Integer orgid,Integer projectId,BigDecimal staffid) throws Exception;
    ...
    @Options(useGeneratedKeys=true, keyProperty="dataId", keyColumn="DATAID")
    ...
    Integer checkIssue(Integer dataid,Integer staffid);
