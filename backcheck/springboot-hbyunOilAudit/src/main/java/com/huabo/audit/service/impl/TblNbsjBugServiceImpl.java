...
//		}
		...
		com.hbfk.util.PageInfo<TblNbsjBugEntity> pageInfo = new com.hbfk.util.PageInfo<TblNbsjBugEntity>();
//    	tblNbsjWorkReport.setAuditorgid(loginStaff.getCurrentOrg().getOrgid());
//    	pageInfo.setCondition(tblNbsjWorkReport);

		Page<TblNbsjBugEntity> page = PageHelper.startPage(pageNumber, pageSize).doSelectPage(()-> this.tblNbsjBugMapper.selectListByInfo( tblNbsjBugVo,orgid,companyid));
		pageInfo = new PageInfoUtil<TblNbsjBugEntity>().parsePageInfo(page);
...
//			}
	...
	public JsonBean innerCommonQxwtList(String token, Integer pageNumber, Integer pageSize, Integer bugid)
		...
		Page<TblNbsjInnerrule> page = PageHelper.startPage(pageNumber, pageSize).doSelectPage(()-> this.tblNbsjBugMapper.selectInnerCommonListByInfo( bugid,orgid));
		com.hbfk.util.PageInfo<TblNbsjInnerrule> pageInfo = new PageInfoUtil<TblNbsjInnerrule>().parsePageInfo(page);
	...
	public JsonBean outerCommonQxwtList(String token, Integer pageNumber, Integer pageSize, Integer bugid)
		...
		Page<TblNbsjInnerrule> page = PageHelper.startPage(pageNumber, pageSize).doSelectPage(()-> this.tblNbsjBugMapper.selectOuterCommonListByInfo( bugid,orgid));
		com.hbfk.util.PageInfo<TblNbsjInnerrule> pageInfo = new PageInfoUtil<TblNbsjInnerrule>().parsePageInfo(page);
