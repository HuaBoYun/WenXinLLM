...
/**
 * @author wangxilu
 * @description 审计实施_我的任务_审减内容
 */
@Tag(name="审计实施_我的任务_审减内容",description="审计实施_我的任务_审减内容")
@RestController
@RequestMapping(value = "/sjssSjnr")
public class YqnsSjssWdrwSjnrController {

    @Resource
    TblYqnsSjssWdrwSjnrService service;
    ...
    public JsonBean saveOrUpdate(HttpServletRequest request,
                                 ...
                                 @RequestBody TblYqnsSjssWdrwSjnr vo
    ) {
        try {
