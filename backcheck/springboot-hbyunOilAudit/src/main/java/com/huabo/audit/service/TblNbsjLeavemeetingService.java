...
//	public List<TblNbsjLeavemeetingEntity> isNoteCode(String code,String projectid);
    ...
    JsonBean outmetDelete(Integer leaveid, String token) throws Exception;
    
    JsonBean findNbsjLeavemeetingDetail(String token, Integer leaveid) throws Exception;
    
    JsonBean outMetCalcel(Integer leaveid, String token) throws Exception;
