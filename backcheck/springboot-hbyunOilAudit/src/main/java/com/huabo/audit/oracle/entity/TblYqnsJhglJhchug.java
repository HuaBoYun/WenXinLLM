 ...
 * 计划管理计划初稿
 *
 * @TableName TBL_YQNS_JHGL_JHCHUG
 */
@TableName(value = "TBL_YQNS_JHGL_JHCHUG")
@Data
@KeySequence(value = "HIBERNATE_SEQUENCE")
public class TblYqnsJhglJhchug extends BaseReservedProperty implements Serializable {
     ...
     */
    @Schema(name = "计划初稿主键")
    @TableId(value = "JHCHUGID", type = IdType.INPUT)
    private BigDecimal jhchugid;
    ...
    @Schema(name = "计划管理计划初稿 关联表")
    @TableField(exist = false)
    private List<TblYqnsJhglJhchugGL> tblYqnsJhglJhchugGLList;
    ...
    @TableField(exist = false)
    private List<TblYqnsJhglJhchugGL> leaveAudit3LEntityList;
    ...
    @TableField(exist = false)
    private List<TblYqnsJhglJhchugGL> tblYqnsJsxmJbqkList;
    ...
    @TableField(exist = false)
    private List<TblYqnsJhglJhchugGL> tblYqnsGcxmjgYsjhList;
