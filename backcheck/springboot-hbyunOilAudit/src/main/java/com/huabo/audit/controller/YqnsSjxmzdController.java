...
/**
 * @author wangys
 * @description 针对表【TBL_YQNS_SJXMZD(审计项目制度表)】控制器
 * @Entity TblYqnsSjxmzd
 */
@Tag(name="项目管理_审计项目制度",description="项目管理_审计项目制度")
@RestController
@RequestMapping(value = "/xmglsjxmzd")
public class YqnsSjxmzdController {

    @Resource
    TblYqnsSjxmzdService service;
    ...
    @Operation(summary = "单个详情接口", description = "sjxmzdid=?")
    @GetMapping("/detail")
    ...
    @Operation(summary = "下发接口", description = "ids=?,?")
