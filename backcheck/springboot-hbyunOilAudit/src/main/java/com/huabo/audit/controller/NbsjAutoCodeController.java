...
public class NbsjAutoCodeController {
	...
	public JsonBean findAutoNumber(HttpServletRequest request,
			 ...
			 @Parameter(name="noId",description="noId",required=false)@RequestParam(value = "noId", required = false) Integer noId)throws Exception{
	...
	public JsonBean findRootNumberByParentId(HttpServletRequest request, 
			...
			String parnetOrgCol, Integer noId, String middleTblname, String middleChilCol, String middleParentCol,
	...
	public JsonBean findAutoNumberByChoice(HttpServletRequest request,
			@Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token,
			String tblName,String column, String orgCol, Integer noId, String chChoiceCol, String choiceVal, String bjf)throws Exception{
		 JsonBean jsonBean = null;
			try {
