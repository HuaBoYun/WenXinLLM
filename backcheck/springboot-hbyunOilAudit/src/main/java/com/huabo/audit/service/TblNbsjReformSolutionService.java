...
public interface TblNbsjReformSolutionService {
	...
	public JsonBean findAllcxs(String code, String name,Integer startIndex,Integer pageSize, String token,String type,Integer createstaffid,Integer runstatus) throws Exception ;
