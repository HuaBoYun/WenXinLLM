 ...
 *
 * @author wangys
 * @TableName TBL_YQNS_SQDCBG
 */
@TableName(value = "TBL_YQNS_SQDCBG")
@Data
@KeySequence(value = "HIBERNATE_SEQUENCE")
public class TblYqnsSqdcbg extends BaseReservedProperty implements Serializable {
    @Bean
     ...
     * 审前调查报告主键
     */
    @Schema(name = "审前调查报告主键")
    @TableId(value = "SQDCBGID")
    private BigDecimal sqdcbgid;
