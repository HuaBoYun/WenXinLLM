 ...
 * @Time:13:09
 */
public class TblWgzzWgjyYsMapperSqlConfig {

    public String getByContWgjyYsList(PageInfo<TblWgzzWgjyYs> pageInfo, String clueNaber) {
        StringBuffer sb = new StringBuffer("SELECT COUNT(0) FROM TBL_WGZZ_WGJY_YS TNA WHERE 1=1 ");
    ...
    public String getwgzzList(PageInfo<TblWgzzWgjyYs> pageInfo, String clueNaber) {
        StringBuffer sb = new StringBuffer("SELECT * FROM "
                + "(SELECT T1.*,ROWNUM RN  FROM "
                + "(SELECT TNA.* "
                + "FROM TBL_WGZZ_WGJY_YS TNA "
                + "WHERE 1=1 ");
