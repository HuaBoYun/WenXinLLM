...
public interface TblStaffService {
	...
	Map<String, Object> findAllPageBeanPid(String username,String ralename,String pid, Integer pageNumber, Integer pageSize, String token, BigDecimal staffId);
	...
	JsonBean findUsrDetail(String token, BigDecimal staffid) throws Exception;
