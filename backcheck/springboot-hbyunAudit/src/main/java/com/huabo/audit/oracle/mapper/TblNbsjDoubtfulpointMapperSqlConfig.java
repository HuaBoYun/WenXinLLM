...
public class TblNbsjDoubtfulpointMapperSqlConfig {
	...
	public String selectListByPageInfo(PageInfo<TblNbsjDoubtfulpointEntity> pageInfo,TblNbsjDoubtfulpointVo tblNbsjDoubtfulpointVo,TblStaffUtil loginStaff)throws Exception {
...
//				+ "LEFT JOIN TBL_STAFF CRESTAFF ON CRESTAFF.STAFFID = TNA.CREATESTAFFID "
		...
		if(tblNbsjDoubtfulpointVo.getStartDate()!=null && tblNbsjDoubtfulpointVo.getStartDate().length()>0) {
			sb.append(" AND TNA.edittime >= '"+tblNbsjDoubtfulpointVo.getStartDate()+"'");
		}
		if(tblNbsjDoubtfulpointVo.getEndDate()!=null && tblNbsjDoubtfulpointVo.getEndDate().length()>0) {
			sb.append(" AND TNA.edittime <= '"+tblNbsjDoubtfulpointVo.getEndDate()+"'");
		}
	...
	public String selectCountByPageInfo(PageInfo<TblNbsjDoubtfulpointEntity> pageInfo,TblNbsjDoubtfulpointVo tblNbsjDoubtfulpointVo,TblStaffUtil loginStaff)throws Exception {
