...
public interface TblNbsjPlanProjectService {
	...
	JsonBean removePlanProjectInfo(String token, BigDecimal planprojectid) throws Exception;

	JsonBean mergePlanProjectManageInfoList(List<TblNbsjPlanProject> projectList, String planId, String plancode,
			String token) throws Exception;
	
	JsonBean findPlanProjectListInfoByPlanId(String token, BigDecimal planId) throws Exception;
	
	List<Object[]> exportPlanProjectListInfoByPlanId(String token, BigDecimal planId,String ids) throws Exception;

	JsonBean getPlanProjectListByPlanIdPageInfo(String token, TblNbsjPlanProjectVo project) throws Exception;
	
	JsonBean findProjectListInfoByWspJhw(String token,BigDecimal planId) throws Exception;
