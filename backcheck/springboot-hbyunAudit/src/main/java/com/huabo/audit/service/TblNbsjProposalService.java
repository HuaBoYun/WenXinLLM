...
//	public PageBean findAll(TblNbsjProposalEntity sal,Integer projectId,String startTime,String endTime,Integer pageNumber, int pageSize);
	...
	//==
	JsonBean suggestPageList(String token, Integer pageNumber, Integer pageSize, TblNbsjProposalVo tblNbsjProposalVo, BigDecimal projectId) throws Exception;
	
	JsonBean suggestAdd(TblNbsjProposalEntity proposal, String token,String attids)throws Exception;
    
    JsonBean suggestCancel(BigDecimal proid, String token) throws Exception;
    
    JsonBean findSuggestDetail(String token, BigDecimal proid) throws Exception;
    
    JsonBean suggestDelete(BigDecimal proid, String token) throws Exception;
