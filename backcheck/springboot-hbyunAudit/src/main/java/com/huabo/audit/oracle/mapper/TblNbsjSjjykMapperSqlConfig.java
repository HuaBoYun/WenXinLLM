...
public class TblNbsjSjjykMapperSqlConfig {
	...
	public String selectNbsjjykByPageInfo(PageInfo<TblNbsjSjjyk> pageInfo,TblStaffUtil loginStaff,TblNbsjSjjyk jyk ) throws Exception {
	...
	public String selectNbsjjykByPageInfoCount(TblStaffUtil loginStaff, TblNbsjSjjyk jyk ) throws Exception {
		BigDecimal orgId = loginStaff.getCurrentOrg().getOrgid();
	...
	public String selectNbsjjykByDateperidPageInfo(BigDecimal dataperid ) throws Exception {
