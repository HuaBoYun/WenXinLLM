...
//		public PageBean projectDataList(Integer pageNumber,int pageSize,TblProjectDataPreEntity dataPre,String orgid);
		...
		//==
		JsonBean dataproPageList(String token, Integer pageNumber, Integer pageSize,DataProVo dataProVo,BigDecimal orgid,BigDecimal projectId) throws Exception;
		
		JsonBean dataproAdd(TblNbsjProjectDataEntity pd, String token,String attids,String mbids,String sjjykids)throws Exception;
	    
	    JsonBean dataproDelete(BigDecimal dataId, String token) throws Exception;
	    
	    JsonBean findDataProDetail(String token, BigDecimal dataId) throws Exception;
	    
	    R removeAttInfoByAttId(String token, String attId) throws Exception;
	    
		JsonBean dataproAddFile(BigDecimal dataId,BigDecimal attids)throws Exception;
