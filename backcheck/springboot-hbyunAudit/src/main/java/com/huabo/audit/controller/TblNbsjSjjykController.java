...
public class TblNbsjSjjykController {
	...
	@OperationLog(
			success = "审计经验库列表新增或修改",
			busType = "智能审计",
			fail = "审计经验库列表新增或修改",
			operationType = OperationType.ADD,
			subType = "基础配置——审计经验库——新增修改列表信息"
	)
	...
	@OperationLog(
			...
			fail = "审计经验库查看详情",
			operationType = OperationType.SELECT,
			subType = "基础配置——审计经验库列表——获取指定记录详细信息"
	)
	...
	@OperationLog(
			success = "根据资料id获取关联经验库内容",
			busType = "智能审计",
			fail = "根据资料id获取关联经验库内容",
			operationType = OperationType.SELECT,
			subType = "基础配置——经验库——根据资料id获取关联经验库内容"
	)
	...
	@OperationLog(
			success = "根据id删除关联经验库内容",
			busType = "智能审计",
			fail = "根据id删除关联经验库内容",
			operationType = OperationType.DELETE,
			subType = "基础配置——经验库——根据资料删除关联经验库内容"
	)
