...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
       ...
       /* AutoGenerator autoGenerator = new AutoGenerator();
        ...
        //得到当前项目的路径
        String oPath = System.getProperty("C:\\Dev\\Workspace\\JavaSpace\\Idea-Workspace\\New\\New-hbyunSystem\\springboot-hbyunAudit");
...
//        gc.setEntityName("%sVo");
        ...
        // 需要生成的表
        strategy.setInclude("TBL_NBSJ_StaffScore","TBL_NBSJ_StaffScore_details");
