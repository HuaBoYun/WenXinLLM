...
import com.huabo.audit.oracle.mapper.TblNbsjSheetMapperSqlConfig;
...
* @date: 2022-04-20
*/
public interface TblNbsjSheetService  {
    /**
     * 提交审批
     * @param token
     * @param sheetid
     ...
     * @throws Exception
     */
	JsonBean submitArrpoval(String token, BigDecimal sheetid, String examination) throws Exception ;
	/**
	 * 查看审批页面
	 * @param token
	 * @param sheetid
	 ...
	 * @throws Exception
	 */
	JsonBean getApprovalInfo(String token, BigDecimal sheetid,BigDecimal cyId) throws Exception;
	/**
	 * 办理
	 * @param token
	 * @param cyId
	 ...
	 * @throws Exception
	 */
	JsonBean dealApporval(String token, BigDecimal cyId, String taskId, String transition, String optDesc,
...
//	List<TblNbsjSheetEntity> findDgByProjectId(Integer projectId, Object object);
	...
	JsonBean projectStandardDgAdd(TblNbsjSheetEntity sheet, String token,String srJson)throws Exception;
    
    JsonBean projectStandardDgDelete(BigDecimal sheetid, String token) throws Exception;
    ...
    JsonBean findNbsjSheetDetail(String token, BigDecimal sheetid) throws Exception;

    
    
    List<TblNbsjSheetEntity> OBJfindAllByProjectid(BigDecimal projectid,String token ,TblNbsjSheetEntity tblSheet) throws Exception;
    
	JsonBean sheetReportDel(String token, BigDecimal reportid) throws Exception;
     ...
     * 我的底稿修改及详情页面--关联缺陷列表
     * */
    JsonBean getNbsjBugList(String token, BigDecimal sheetid) throws Exception;
	...
	JsonBean projectSaveCwFile(BigDecimal sheetid, String token, String attid) throws Exception;
	...
	JsonBean findNbsjSheetZGDetail(String token, BigDecimal sheetid) throws Exception;
	...
	JsonBean exportSheetWord(String token, BigDecimal sheetid, HttpServletResponse response) throws Exception;
}
