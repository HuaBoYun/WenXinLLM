...
public interface TblNbsjOuterruleMapper extends BaseMapper<TblNbsjOuterruleEntity>{
	  ...
	  @SelectProvider(method="selectOuterruleListView",type=TblNbsjOuterruleMapperSqlConfig.class)
		...
		List<TblNbsjOuterruleEntity> selectOuterruleListView(PageInfo<TblNbsjOuterruleEntity> pageInfo, TblStaffUtil loginStaff) throws Exception;

	  @SelectProvider(method="selectOuterruleCountView",type=TblNbsjOuterruleMapperSqlConfig.class)
		Integer selectOuterruleCountView(PageInfo<TblNbsjOuterruleEntity> pageInfo,TblStaffUtil loginStaff) throws Exception;
	...
	List<TblNbsjOuterruleEntity> selectOuterCommonListByPageInfoXml(@Param("bugid") BigDecimal bugid, @Param("orgid")BigDecimal orgid);

	List<TblNbsjOuterruleEntity> selectOuterCommonListByLinkXml(@Param("bugid") BigDecimal bugid, @Param("orgid")BigDecimal orgid);
