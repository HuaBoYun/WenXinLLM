...
//	@Select("SELECT * FROM TBL_NBSJ_AUDITEXPERIENCE_TYPE WHERE PARENTID = #{nodeId}")
	@SelectProvider(method="getlist",type=TblNbsjAuditExperienceTypeMapperSqlConfig.class)
	List<TblNbsjAuditExperienceTypeEntity> getBynoid(BigDecimal nodeId,String mpdeltype) throws Exception;
