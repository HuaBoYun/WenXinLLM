...
public interface TblNbsjQuestionMapper extends Mapper<TblNbsjQuestionEntity> {
	...
	List<TblNbsjQuestionEntity> findNbsjQuestionBySheetIdSp(BigDecimal sheetId) throws Exception;
    ...
    @Results({
   	...
   	TblNbsjQuestionEntity selectById(@Param("questionid") BigDecimal questionid) throws Exception;
    ...
    void deleteById(BigDecimal QUESTIONID) throws Exception;
    
    @Delete("DELETE FROM TBL_NBSJ_QUESTION WHERE SHEETID = #{sheetid}")
    void deleteBySheet(BigDecimal sheetid) throws Exception;
    ...
    Integer getQuestionCount(BigDecimal projectid) throws Exception;
    ...
    @SelectProvider(method="selectConfirmationCountByPageInfo",type=TblNbsjQuestionMapperSqlConfig.class)
   	Integer selectConfirmationCountByPageInfo(PageInfo<TblNbsjQuestionEntity> pageInfo,TblNbsjQuestionVo tblNbsjQuestionVo,BigDecimal projectId) throws Exception;
	...
	List<TblNbsjQuestionEntity> selectConfirmationListByPageInfo(PageInfo<TblNbsjQuestionEntity> pageInfo,TblNbsjQuestionVo tblNbsjQuestionVo,BigDecimal projectId) throws Exception;
	...
	List<TblNbsjQuestionEntity> selectConfirmationListByFact(PageInfo<TblNbsjQuestionEntity> pageInfo,BigDecimal factid) throws Exception;

    @Update("UPDATE TBL_NBSJ_QUESTION SET STATUS = #{statusyes} WHERE QUESTIONID = #{questionId}")
	void updateState(BigDecimal questionId, Integer statusyes);

	
    @SelectProvider(method="getNbsjQuestList",type=TblNbsjQuestionMapperSqlConfig.class)
    List<TblNbsjSheetEntity>  getNbsjQuestList(TblNbsjQuestionVo tblNbsjQuestionVo,BigDecimal projectId,@Param("sql") String sql) throws Exception;
    ...
    @Results({
    	...
    	@Result(column="IFSBG",property="ifsbg"),
    })
	List<TblNbsjQuestionEntity> selectListByPageInfoXml(@Param("tblNbsjQuestionVo") TblNbsjQuestionVo tblNbsjQuestionVo,@Param("sql") String sql);
    
    
    
    @Update("UPDATE TBL_NBSJ_SHEET SET IFSBG =#{ifsbg}  WHERE sheetid = #{questionId}")
	void updateIsstatus(BigDecimal questionId,Integer ifsbg);
