...
public class JDBCProperties {
	...
	public static Properties properties = JedisUtil.loadPropertyFile("application-dev.yml");
	
	public static JsonBean GetGather(String username,String sql,PageInfo<Map<String,Object>> pageInfo) throws Exception {
		...
		pageInfo.setTotalRecord(columncountc);
	...
	public static List<String> getTbable(String sql,String bookName) throws SQLException {
		Statement stmt = null;
		...
		try {
			...
			String password = "1";
			Connection connGRC = DriverManager.getConnection(url,  bookName, password);
	...
	public static void executeSql(String tbaleName, String bookName, List<String> params) {
		...
		Statement stmt = null;
		try {
			connGRC = DriverManager.getConnection(url,  bookName, password);
			stmt = connGRC.createStatement();
	...
	public static List<Map<String, Object>> getData(String sql,String username) throws SQLException {
	      // String url = "jdbc:oracle:thin:@192.0.2.200:1521:orcl";
		String url = properties.getProperty("cwurl");
		System.out.println(url);
	...
	public static void insertData(String tableName, String bookName, List<Map<String, Object>> list, BigDecimal userId, String dateTime) {
		List<String> sqlList = new ArrayList<String>();
		long l = 0l;
	...
	public static boolean isNotExistsTable(String table, String bookName) {
		String password = "1";
		Connection connGRC =null;
	...
	public static void main(String[] args) {
    	...
    	String sql="SELECT * FROM  TBL_ACC_BSEG2017";
		try {
			
			List<String> cnmes = JDBCProperties.getTbableall(sql,"2","jdbc:oracle:thin:@192.0.2.200:1521:orcl", "HBFKCWZT2018", "1");
			List<Object[]> list = JDBCProperties.GetGatheroracleall("jdbc:oracle:thin:@192.0.2.200:1521:orcl", "HBFKCWZT2018", "1", sql,cnmes.size());
	...
	public static JsonBean GetGatherDMEightServer(String url,String username,String password,String sql,PageInfo<Map<String,Object>> pageInfo) throws Exception {
		 Class.forName("dm.jdbc.driver.DmDriver").newInstance();
	      // String url = "jdbc:oracle:thin:@192.0.2.200:1521:orcl";
		   //String url = properties.getProperty("cwurl");
		   System.out.println(url);
	...
	public static List<Object[]> GetGatherDMEightServerAll(String url,String username,String password,String sql,Integer length) throws Exception{
		 Class.forName("dm.jdbc.driver.DmDriver").newInstance();
		   System.out.println(url);
