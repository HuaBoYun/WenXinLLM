...
public class TblStaffMapperSqlConfig {
	...
	public String selectListByPageInfo(PageInfo<TblStaff> pageInfo,BigDecimal orgid) {
	...
	public String selectCountByPageInfo(PageInfo<TblStaff> pageInfo,BigDecimal orgid) {
