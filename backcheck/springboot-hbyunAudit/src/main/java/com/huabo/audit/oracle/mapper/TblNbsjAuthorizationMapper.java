...
public interface TblNbsjAuthorizationMapper extends tk.mybatis.mapper.common.Mapper<TblNbsjAuthorizationEntity>{
	...
	List<TblNbsjAuthorizationEntity> getByPjPg(BigDecimal projectId,BigDecimal aduitProGramId);
    ...
    void deleteByAuthid(BigDecimal authId) throws Exception;
