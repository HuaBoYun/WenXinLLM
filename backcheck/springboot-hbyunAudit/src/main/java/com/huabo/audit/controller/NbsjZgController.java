...
public class NbsjZgController {
	...
	@Resource
	public  TblTesttaskProblemFindService tblTesttaskProblemFindService;
    ...
    public JsonBean getzgContentsList(HttpServletRequest request,
   		...
   		@Parameter(name = "pageNumber", description = "分页当前页数", required = false)@RequestParam(value = "pageNumber", required = false, defaultValue = "1") Integer pageNumber,
   		@Parameter(name = "pageSize", description = "每页记录数", required = false)@RequestParam(value = "pageSize", required = false, defaultValue = "15") Integer pageSize,
   		@Parameter(name = "code", description = "问题编号", required = false)@RequestParam(value = "code", required = false) String code,
   		@Parameter(name = "selectidIdsstr", description = "方案已关联的内容问题ID拼接串", required = false)@RequestParam(value = "selectidIdsstr", required = false) String selectidIdsstr,
   	    @Parameter(name = "projectid", description = "整改方案关联项目id", required = false) @RequestParam(value = "projectid", required = false) BigDecimal projectid) {
    	JsonBean jsonBean = null;
    	try {
    ...
    public JsonBean getAuditPlanPageList(HttpServletRequest request,
   		...
   		@Parameter(name = "pageNumber", description = "分页当前页数", required = false)@RequestParam(value = "pageNumber", required = false, defaultValue = "1") Integer pageNumber,
   		@Parameter(name = "pageSize", description = "每页记录数", required = false)@RequestParam(value = "pageSize", required = false, defaultValue = "15") Integer pageSize,
   		@Parameter(name = "code", description = "整改方案编号", required = false)@RequestParam(value = "code", required = false) String code,
   		@Parameter(name = "name", description = "整改方案名称", required = false)@RequestParam(value = "name", required = false) String name,
   		@Parameter(name = "createstaffid", description = "创建人", required = false)@RequestParam(value = "createstaffid", required = false) BigDecimal createstaffid,
   		@Parameter(name = "runstatus", description = "状态", required = false)@RequestParam(value = "runstatus", required = false) Integer runstatus) {
    	JsonBean jsonBean = null;
    	try {
	...
	@OperationLog(
			...
			fail = "详情信息",
			operationType = OperationType.SELECT,
			subType = "整改跟踪-整改方案查看详情信息"
	)
    @GetMapping("/getSolutionDetail")
    @Operation(summary = "整改方案查看详情信息")
    public JsonBean getAuditPlanInfo(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "solutionid", description = "整改方案主键", required = true)@RequestParam(value = "solutionid", required = true) String solutionid) {
    	JsonBean jsonBean = null;
    	try {
	...
	public JsonBean mergePlanProjectManageInfo(HttpServletRequest request,@Parameter(name = "solution", description = "整改方案实体", required = true)TblNbsjReformSolution solution,
			 @Parameter(name = "solutionid", description = "整改方案主键 ，如果主键为空则根据编码新增信息", required = false) BigDecimal solutionid,
			 @Parameter(name = "endDate", description = "截止时间", required = false) @RequestParam(value="endDate", required = false) String endDate,
			 @Parameter(name = "reformid", description = "根据项目选择后的问题拼接id", required = false)@RequestParam(value="reformid", required = false) String reformid,
			 @Parameter(name = "attids", description = "上传附件的ID", required = false) @RequestParam(value="attids", required = false) String attids,
			 @Parameter(name = "projectid", description = "选择的关联项目id", required = false) @RequestParam(value="projectid", required = false)  String projectid,
    ...
    public JsonBean delSolutionnr(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "reformid", description = "整改内容ID", required = true)@RequestParam(value = "reformid", required = true) BigDecimal reformid) {
    	JsonBean jsonBean = null;
    	try {
    ...
    public JsonBean getAuditPlanAttInfo(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "solutionid", description = "整改方案主键 ", required = true)@RequestParam(value = "solutionid", required = true) BigDecimal solutionid) {
    	JsonBean jsonBean = null;
		try {
    ...
    public JsonBean issuePersonliable(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "solutionid", description = "整改方案ID ", required = true)@RequestParam(value = "solutionid", required = true) BigDecimal solutionid,
    		@Parameter(name = "bsjdwzrrid", description = "被审计单位整改责任人用户id ", required = true)@RequestParam(value = "bsjdwzrrid", required = true)  BigDecimal bsjdwzrrid,
    		@Parameter(name = "bsjdwzfr", description = "被审计单位整改责任人用户名 ", required = true)@RequestParam(value = "bsjdwzfr", required = true)  String bsjdwzfr,
    		@Parameter(name = "reformuserid", description = "整改联络人id ", required = true)@RequestParam(value = "reformuserid", required = true)  BigDecimal reformuserid) {
    	JsonBean jsonBean = null;
		try {
    ...
    public JsonBean closeSolution(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "solutionid", description = "整改方案ID ", required = true)BigDecimal solutionid) {
    	JsonBean jsonBean = null;
		try {
			TblNbsjReformSolution solution=new TblNbsjReformSolution();
			if(solutionid!=null) {
    ...
    public JsonBean getfpContentsList(HttpServletRequest request,
   		...
   		@Parameter(name = "pageSize", description = "每页记录数", required = false)@RequestParam(value = "pageSize", required = false, defaultValue = "15") Integer pageSize,
   		@Parameter(name = "code", description = "问题编号", required = false)@RequestParam(value = "code", required = false) String code,
   		@Parameter(name = "solutionid", description = "方案id", required = false)@RequestParam(value = "solutionid", required = false) BigDecimal solutionid) {
    	JsonBean jsonBean = null;
    	try {
    		TblNbsjRefopm re =new TblNbsjRefopm();
    		re.setCode(code);
	...
	public JsonBean fpSolutionRy(@Parameter(name = "userid", description = "分派的整改执行人员id", required = false)  BigDecimal userid,
			 @Parameter(name = "reformid", description = "分派任务id", required = false) BigDecimal reformid,
			 @Parameter(name = "solutionid", description = "方案id", required = false) BigDecimal solutionid,
			 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token)throws Exception{
    	JsonBean jsonBean = null;
		try {
			TblNbsjRefopm re =new TblNbsjRefopm();
	...
	@OperationLog(
			...
			fail = "分页查询",
			operationType = OperationType.SELECT,
			subType = "整改跟踪——整改落实——对整改落实列表分页查询操作"
	)
    ...
    @RequestMapping(value = "/getReformByid", produces = "application/json; charset=utf-8", method = {RequestMethod.POST})
   	...
   	public JsonBean getReformByid(
   			 @Parameter(name = "reformid", description = "任务id", required = false)  String reformid,
   			 @Parameter(name = "solutionid", description = "方案id", required = false)  BigDecimal solutionid,
   			 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token)throws Exception{
       	JsonBean jsonBean = null;
   		try {
    ...
    @RequestMapping(value = "/saveReformInfo", produces = "application/json; charset=utf-8", method = {RequestMethod.POST})
   	...
   	public JsonBean saveReformInfo(
   			 @Parameter(name = "reformid", description = "任务id", required = false)  BigDecimal reformid,
   			 @Parameter(name = "refopm", description = "整改任务实体", required = true)TblNbsjRefopm refopm,
   			 @Parameter(name = "solutionid", description = "方案id", required = false)  BigDecimal solutionid,
   			 @Parameter(name = "attids", description = "上传附件id拼接串", required = false) String attids,
   		     @Parameter(name = "plancomdate", description = "计划完成时间", required = false)  String plancomdate,
   		     @Parameter(name = "linedate", description = "整改截止时间", required = false)  String linedate,
   		     @Parameter(name = "zgproblem", description = "整改问题金额跟非金额json", required = false)  String zgproblem,
   			 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token)throws Exception{
       	JsonBean jsonBean = null;
   		try {
   			if(reformid!=null) {
	...
	@OperationLog(
			...
			fail = "分页查询",
			operationType = OperationType.SELECT,
			subType = "整改跟踪——整改评价——整改内容页面分页查询信息"
	)
    ...
    @RequestMapping(value = "/savepjReformInfo", produces = "application/json; charset=utf-8", method = {RequestMethod.POST})
   	...
   	public JsonBean savepjReformInfo(
   			 @Parameter(name = "reformid", description = "任务id", required = false)  BigDecimal reformid,
   			 @Parameter(name = "refopm", description = "整改评价实体", required = true)TblNbsjRefopm refopm,
   			 @Parameter(name = "solutionid", description = "方案id", required = false)  BigDecimal solutionid,
   			@Parameter(name = "attids", description = "上传附件id拼接串", required = false)  String attids,
   			 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token)throws Exception{
       	JsonBean jsonBean = null;
    ...
    public JsonBean getReformAttInfo(HttpServletRequest request,
    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
    		@Parameter(name = "reformid", description = "整改方案主键 ", required = true)@RequestParam(value = "reformid", required = true) BigDecimal reformid) {
    	JsonBean jsonBean = null;
		try {
	...
	@OperationLog(
			...
			fail = "删除附件",
			operationType = OperationType.DELETE,
			subType = "整改跟踪——整改落实或评价删除选择的附件【{{attid}}】"
	)
	...
	@OperationLog(
			...
			busType = "整改追责",
			fail = "信息提交",
			operationType = OperationType.SUBMIT_APPROVE,
			subType = "整改跟踪——整改评价-提交评价信息"
	)
    ...
    public JsonBean getwxhContentsList(HttpServletRequest request,
   		...
   		@Parameter(name = "pageSize", description = "每页记录数", required = false)@RequestParam(value = "pageSize", required = false, defaultValue = "15") Integer pageSize,
   		@Parameter(name = "code", description = "问题编号", required = false)@RequestParam(value = "code", required = false) String code,
   		@Parameter(name = "audiorgid", description = "被审计单位id", required = false)@RequestParam(value = "audiorgid", required = false) String audiorgid,
   		@Parameter(name = "projectname", description = "所属项目名称", required = false)@RequestParam(value = "projectname", required = false) String projectname) {
    	JsonBean jsonBean = null;
    	try {
    		TblNbsjRefopm re =new TblNbsjRefopm();
    		re.setCode(code);
	...
	@OperationLog(
			...
			fail = "查询结果",
			operationType = OperationType.SELECT,
			subType = "整改跟踪——整改查询-根据整改内容查询结果集合"
	)
    @GetMapping(value = "/getzgjgReformlist")
	@Operation(summary = "整改查询-根据整改内容查询结果集合")
	public JsonBean getzgjgReformlist(
			 @Parameter(name = "problemid", description = "整改内容id", required = false) @RequestParam(value="problemid", required = false) String problemid,
			 @Parameter(name = "soultionid", description = "方案id", required = false) @RequestParam(value="soultionid", required = false) BigDecimal soultionid,
			 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token)throws Exception{
    	JsonBean jsonBean = null;
		try {
	...
	@OperationLog(
			...
			fail = "获取问题整改结果",
			operationType = OperationType.SELECT,
			subType = "整改跟踪——获取问题整改结果信息"
	)
    @GetMapping(value = "/getzgjgReformByid")
   	@Operation(summary = "获取问题整改结果信息")
   	public JsonBean getzgjgReformByid(
   			 @Parameter(name = "reformid", description = "任务id", required = false) @RequestParam(value="reformid", required = false) String reformid,
   			 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token)throws Exception{
       	JsonBean jsonBean = null;
   		try {
   			jsonBean = refopmservice.getByid(reformid);
	...
	@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,
	@Parameter(name = "solutionid", description = "方案id", required = false)@RequestParam(value="soultionid", required = false)   BigDecimal solutionid) {
		try {
...
//					
	...
	@OperationLog(
			...
			fail = "分页查询",
			operationType = OperationType.SELECT,
			subType = "整改跟踪——整改台账-分页列表"
	)
	 @GetMapping(value = "/getzlAllReformlist")
		@Operation(summary = "整改台账-分页列表")
		public JsonBean getzlAllReformlist(
				 @Parameter(name = "auditorg", description = "公司id(查询条件)", required = false) @RequestParam(value="auditorg", required = false) BigDecimal auditorg,
				 @Parameter(name = "code", description = "问题编号", required = false) @RequestParam(value="code", required = false) String code,
	...
	@OperationLog(
			...
			fail = "获取整改金额信息",
			operationType = OperationType.SELECT,
			subType = "整改跟踪——整改落实-根据落实id获取整改金额或非金额信息"
	)
	 @GetMapping(value = "/getzgproblemlist")
		@Operation(summary = "整改落实-根据落实id获取整改金额或非金额信息")
		public JsonBean getzgproblemlistall(
				 @Parameter(name = "datatype", description = "类型：金额类为1，非金额类为2", required = false) @RequestParam(value="datatype", required = false) String datatype,
				 @Parameter(name = "reformid", description = "整改落实id", required = false)@RequestParam(value = "reformid", required = false) BigDecimal reformid,
				 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token)throws Exception{
	    	JsonBean jsonBean = null;
			try {
	...
	@OperationLog(
			...
			fail = "删除整改金额",
			operationType = OperationType.DELETE,
			subType = "整改跟踪——整改落实-删除整改金额或非金额信息"
	)
	 @GetMapping(value = "/deletezgproblem")
		@Operation(summary = "整改落实-删除整改金额或非金额信息")
		public JsonBean deletezgproblemlistak(
				 @Parameter(name = "problemid", description = "整改金额或非金额id", required = false)@RequestParam(value = "problemid", required = false) BigDecimal problemid,
				 @Parameter(name = "token", description = "登录用户token", required = false) @RequestHeader("token")String token)throws Exception{
	    	JsonBean jsonBean = null;
			try {
	 ...
	 /**
		 ...
		 */
	 	@OperationLog(
				 ...
				 fail = "审计问题汇总列表页",
				 operationType = OperationType.SELECT,
				 subType = "问题汇总——查看问题汇总——审计问题汇总列表内容"
	 	)
		@GetMapping("/summaryAudit_list")
		@Operation(summary = "整改--审计问题汇总")
		public JsonBean question_store_list(HttpServletRequest request, 
			...
			JsonBean jsonBean = null;
			try {
				jsonBean = tBlNbsjSheetService.projectStandardHthzZgList(token, pageNumber, pageSize,tBlNbsjSheetVo);
				//jsonBean = tblNbsjQuestionService.questionStorePageList(token, pageNumber, pageSize,tblNbsjQuestionVo,null);
			} catch (Exception e) {
				e.printStackTrace();
			}
			return jsonBean;
		...
		/**
		 * 
		 * 原审计--审计发现-发起整改-现挪为审计问题汇总模块 -发起整改
		 */
		@OperationLog(
				success = "发起整改",
				busType = "整改追责",
				fail = "发起整改",
				operationType = OperationType.UPDATE,
				subType = "问题汇总--审计问题汇总-发起整改"
		)
		@GetMapping("/summaryAudit_fqStatus")
		@Operation(summary = "整改--审计问题汇总-发起整改")
	    public JsonBean summaryAudit_fqStatus(HttpServletRequest request,
	    		@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token")String token,
		...
		@OperationLog(
				...
				fail = "内控问题汇总列表页",
				operationType = OperationType.SELECT,
				subType = "问题汇总——内控问题汇总列表内容"
		)
		 @GetMapping(value = "getProblemLedgerList")
		    @ResponseBody
		    @Operation(summary = "整改追责--内控问题汇总")
		    public JsonBean getProblemLedgerList (
		            ...
		            @Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,
					@Parameter(name="projectId",description="projectId",required=false) @RequestParam(value = "projectId", required = false) BigDecimal projectId) throws Exception {
				JsonBean jsonBean = null;
				try {
					TblTesttaskProblemFindVo find=new TblTesttaskProblemFindVo();
					find.setOneprocess(oneprocess);
					find.setProblemtype(problemtype);
					find.setDefectlevel(defectlevel);
					find.setTestYear(testYear == null ? 0 : testYear);
					jsonBean = 	tblTesttaskProblemFindService.findALLProblemLedgerList(pageNumber, pageSize,token, find);
				} catch (Exception e) {
					e.printStackTrace();
				}
				return jsonBean;
		 ...
		 @OperationLog(
				 ...
				 fail = "内控问题汇总导出",
				 operationType = OperationType.EXPORT,
				 subType = "问题汇总——整改内控问题汇总导出"
		 )
			@RequestMapping(value = "exportProblemLedger",method = {RequestMethod.POST}, produces = "application/html; charset=utf-8")
			@ResponseBody
		    @Operation(summary = "内控问题汇总导出")
			public void  exportProblemLedger(HttpServletRequest request, HttpServletResponse response,
				 @Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token ) {
				try {
					response.setContentType("application/binary;charset=UTF-8");
				    TblStaffUtil user = userProvider.get();
					List<TblTesttaskProblemFind> unitList =tblTesttaskProblemFindService.getExportProblemLedgerList(user.getStaffid().toString(), user.getCurrentOrg().getOrgid().toString());
					String[] cNames = {"内控评价年度","一级流程", "问题概述","缺陷具体描述","问题类别", "缺陷等级","定性依据", "主责部门", "反馈意见", "整改计划","预计完成时间","整改落实人","审批状态"};
					List<Object[]> contractlist = new ArrayList<Object[]>(0);
					Object[] objs = null;
			 ...
			 * 整改清单-新增与修改
			 */
			@RequestMapping(value = "/zg/project_standard_dg_add", produces = "application/json; charset=utf-8", method = {RequestMethod.POST})
			@Operation(summary = "整改清单-新增与修改")
		    public JsonBean project_standard_dg_add(HttpServletRequest request,TblNbsjSheetEntity sheet,
					 ...
					 @Parameter(name = "srJson", description = "报告内容json", required = false)String srJson,
					 @Parameter(name = "flag", description = "0:未生成底稿，1：已生成底稿", required = false)Integer flag)throws Exception{
				JsonBean jsonBean = null;
				try {
					System.out.println("+++++++++++++项目名称："+sheet.getProjectName());
					jsonBean = this.tBlNbsjSheetService.projectStandardZgAdd(sheet,token,attids,srJson,flag);
				} catch (Exception e) {
					e.printStackTrace();
			...
			@OperationLog(
					...
					fail = "整改清单详情",
					operationType = OperationType.SELECT,
					subType = "问题汇总--整改清单- 详情"
			)
		    @GetMapping("/zg/project_standard_dg_detail")
		    @Operation(summary = "整改清单- 详情")
		    public JsonBean project_standard_dg_detail(HttpServletRequest request,
		    	...
		    	JsonBean jsonBean = null;
		    	try {
					jsonBean = tBlNbsjSheetService.findNbsjSheetZGDetail(token,sheetid);
				} catch (Exception e) {
					e.printStackTrace();
				}
		        return jsonBean;
			...
			@OperationLog(
					...
					fail = "整改清单列表",
					operationType = OperationType.SELECT,
					subType = "问题汇总--整改清单-整改清单列表"
			)
			@GetMapping("/zg/project_standard_listdg")
			@Operation(summary = "整改清单列表")
			public JsonBean project_standard_listdg(HttpServletRequest request, 
				...
				try {
					...
					jsonBean = tBlNbsjSheetService.projectStandardDgZgList(token, pageNumber, pageSize,tBlNbsjSheetVo);
				} catch (Exception e) {
					e.printStackTrace();
				}
				return jsonBean;
			...
			@OperationLog(
					...
					fail = "外部项目",
					operationType = OperationType.SELECT,
					subType = "问题汇总--整改方案--获取外部项目列表"
			)
			@GetMapping("/zg/project_wb_list")
			@Operation(summary = "整改方案-外部项目列表")
			public JsonBean project_wb_list(HttpServletRequest request, 
					@Parameter(name = "token", description = "登录用户token", required = true) @RequestHeader("token") String token,
					@Parameter(name = "pageNumber", description = "分页当前页数", required = false) @RequestParam(value = "pageNumber", required = false, defaultValue = "1") Integer pageNumber,
					@Parameter(name = "pageSize", description = "每页记录数", required = false) @RequestParam(value = "pageSize", required = false, defaultValue = "15") Integer pageSize) {
				...
				JsonBean jsonBean = null;
				try {
					jsonBean = tBlNbsjSheetService.projectZgWbList(token, pageNumber, pageSize);
				} catch (Exception e) {
					e.printStackTrace();
				}
				return jsonBean;
