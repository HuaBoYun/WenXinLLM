...
public class TblNbsjProjectDataMapperSqlConfig {
	...
	public String selectListByPageInfo(PageInfo<TblNbsjProjectDataEntity> pageInfo,DataProVo dataProVo,BigDecimal orgid,BigDecimal projectId,BigDecimal staffid) {
...
//				+ " AND TNA. ");
	...
	public String selectCountByPageInfo(PageInfo<TblNbsjProjectDataEntity> pageInfo,DataProVo dataProVo,BigDecimal orgid,BigDecimal projectId,BigDecimal type) {
