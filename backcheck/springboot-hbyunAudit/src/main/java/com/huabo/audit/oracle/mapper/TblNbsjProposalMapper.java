...
public interface TblNbsjProposalMapper extends BaseMapper<TblNbsjProposalEntity>{
    ...
    @SelectProvider(method="selectCountByPageInfo",type=TblNbsjProposalMapperSqlConfig.class)
   	Integer selectCountByPageInfo(PageInfo<TblNbsjProposalEntity> pageInfo,TblNbsjProposalVo tblNbsjProposalVo,BigDecimal projectId) throws Exception;
	...
	List<TblNbsjProposalEntity> selectListByPageInfo(PageInfo<TblNbsjProposalEntity> pageInfo,TblNbsjProposalVo tblNbsjProposalVo,BigDecimal projectId) throws Exception;
    ...
    void calcelById(BigDecimal proid) throws Exception;
    
    
    @Delete("DELETE FROM TBL_LEGAL_AUDITSUGGEST_ATT WHERE attid=#{attid}")
	void deleteFileInfoByAttId(BigDecimal attid);

	List<TblNbsjProposalEntity> selectListByPageInfoXml(@Param("tblNbsjProposalVo") TblNbsjProposalVo tblNbsjProposalVo);
}
