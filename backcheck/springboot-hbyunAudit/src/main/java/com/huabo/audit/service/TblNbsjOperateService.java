...
//	public PageBean findPorgram(Integer targetId,Integer projectId,Integer pageNumber,int pageSize);
    ...
    JsonBean checkListMyDetail(String token, BigDecimal operateid) throws Exception;
    
    JsonBean checkListFinal(BigDecimal operateid, BigDecimal programId, String token) throws Exception;
	
    //==
    JsonBean checkAllListMyPageList(String token, Integer pageNumber, Integer pageSize,String businessType,BigDecimal targetId,BigDecimal projectId) throws Exception;
	
    JsonBean pjArchiveMyPageList(String token) throws Exception;
    
    //==
    JsonBean projRwList(String token, Integer pageNumber, Integer pageSize , BigDecimal projectid, BigDecimal targetId) throws Exception;
    
    //==
    JsonBean getTree(String token, BigDecimal projectId, BigDecimal nodeId,String type) throws Exception;

    JsonBean getMyWorkTree(String token) throws Exception;
	...
	JsonBean getTreeZy(String token, BigDecimal tempId, BigDecimal nodeId, String type, BigDecimal projectId)throws Exception;
    
	 JsonBean findPorgramByUser(String token,BigDecimal targetId,Integer pageNumber,Integer pageSize,String bsunitname) throws Exception;
