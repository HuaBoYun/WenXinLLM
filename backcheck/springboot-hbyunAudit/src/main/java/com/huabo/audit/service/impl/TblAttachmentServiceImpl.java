...
@Service
public class TblAttachmentServiceImpl extends ServiceImpl<TblAttachmentMapper, TblAttachment>  implements TblAttachmentService {
	...
	@Override
	public TblAttachment selectEntityById(BigDecimal attId) throws Exception {
	...
	@Override
	public JsonBean inMeetRecordFileList(String token, BigDecimal enterid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean outMeetRecordFileList(String token, BigDecimal leaveid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean dgFileList(String token, BigDecimal sheetid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean workReportFileList(String token, BigDecimal reportid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean dpFileList(String token, BigDecimal dpointid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean projectFileList(String token, BigDecimal projectId) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
...
//					return ResponseFormat.retParam(0,10001,resultMap);
	...
	@Override
	public JsonBean dataprojectFileList(String token, BigDecimal dataId) throws Exception {
		TblStaffUtil loginStaff = userProvider.get();
		if(loginStaff == null) {
			return ResponseFormat.retParam(0,20006,null);
		}
	...
	@Override
	public JsonBean noticeFileList(String token, BigDecimal adviceid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean reportFileList(String token, BigDecimal reportid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean reportOpinionFileList(String token, BigDecimal reportid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
			List<TblAttachment> attList = this.tblAttachmentMapper.findAttListByOpinionReport(reportid);
			resultMap.put("data", attList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Override
	public JsonBean reportFinalFileList(String token, BigDecimal reportid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
			List<TblAttachment> attList = this.tblAttachmentMapper.findAttListByFinalReport(reportid);
			resultMap.put("data", attList);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Override
	public JsonBean auditSuggestFileList(String token, BigDecimal proid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean confirmationFileList(String token, BigDecimal factid) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean outFileList(String token, BigDecimal outerId) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
	...
	@Override
	public JsonBean certificateFileList(String token, BigDecimal certificateId) throws Exception {
		Map<String, Object> resultMap = new HashMap<String, Object>(0);
		try {
