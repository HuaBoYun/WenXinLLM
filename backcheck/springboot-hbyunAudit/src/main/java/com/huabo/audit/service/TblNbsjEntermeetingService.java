...
//	List<TblNbsjEntermeetingEntity> isNoteCode(String code, String string);
    ...
    JsonBean metDelete(BigDecimal enterid, String token) throws Exception;
    
    JsonBean findNbsjEntermeetingDetail(String token, BigDecimal enterid) throws Exception;
    
    JsonBean metCalcel(BigDecimal enterid, String token) throws Exception;
