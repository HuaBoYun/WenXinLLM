...
@Data
@Entity
@TableName("TBL_PREVIOUS_YEAR_AUDIT_ISSUES")
public class TblPreviousYearAuditIssuesEntity {
    @Id
    ...
    @Schema(name="整改责任单位")
    @TableField(value= "RECTIFICATION_RESPONSIBLE_UNIT")
    private String rectificationResponsibleUnit;

    @Schema(name="审计整改类型")
    @TableField(value= "AUDIT_RECTIFICATION_TYPE")
    private String auditRectificationType;
    ...
    @Schema(name="追责问题情况-是否向司法机关移送问题线索")
    @TableField(value= "HAS_JUDICIAL_REFERRAL")
    private String hasJudicialReferral;
