...
//	List<TblNbsjEntermeetingEntity> approachList(ExecPhraseVo vo);
    ...
    @Results({
   	...
   	TblNbsjEntermeetingEntity selectNbsjEntermeetingEntityById(@Param("enterid") BigDecimal enterid) throws Exception;
    ...
    void deleteEntermeetingEntityById(BigDecimal enterid) throws Exception;
    ...
    void calcelEntermeetingEntityById(BigDecimal enterid) throws Exception;
