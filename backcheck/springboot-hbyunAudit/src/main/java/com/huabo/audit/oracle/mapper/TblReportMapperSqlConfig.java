...
public class TblReportMapperSqlConfig {
	...
	public String selectListByPageInfo(PageInfo<TblReportEntity> pageInfo,TblReportVo tblReportVo,Integer orgid,Integer projectId,TblStaffUtil loginStaff)throws Exception {
...
//				+ "LEFT JOIN TBL_STAFF CRESTAFF ON CRESTAFF.STAFFID = TNA.REPORTERIDID "
				+ "WHERE 1=1");
		
		//安全保密SQL
		sb.append(GeneralSQLConcatConfig.concatSecrectSql(loginStaff.getCurrentOrg().getUseSecrect(), true, "TNA.ORGID", "TNA.REPORTDEPARTMENTID",
	...
	public String selectCountByPageInfo(PageInfo<TblReportEntity> pageInfo,TblReportVo tblReportVo,Integer orgid,Integer projectId,TblStaffUtil loginStaff)throws Exception {
