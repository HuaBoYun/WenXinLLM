...
//		fb.setAuditStaffId(loginStaff.getStaffid().intValue());
		...
		if(null != questionIds) {
			...
			for (int i = 0; i < questionIdss.length; i++) {
	            ...
	            n.setQuestionId(new BigDecimal(questionIdss[i]));
	...
	@Override
	public JsonBean confirmationDelete(BigDecimal factid, String token) throws Exception {
		TblStaffUtil loginStaff = userProvider.get();
		if(loginStaff == null) {
			return ResponseFormat.retParam(0,20006,null);
		}
...
//        }
	...
	@Override
	public JsonBean findNbsjFactbookDetail(String token, BigDecimal factid) throws Exception {
		TblStaffUtil loginStaff = userProvider.get();
		if(loginStaff == null) {
			return ResponseFormat.retParam(0,20006,null);
		}
	...
	@Override
	public JsonBean submitArrpoval(String token, BigDecimal factid) throws Exception {
	...
	@Override
	public JsonBean getApprovalInfo(String token, BigDecimal factid, String taskId, BigDecimal cyId) throws Exception {
	...
	private R deleteRealtionAttInfo(String attId) throws Exception {
        ...
        this.tblNbsjFactbookMapper.deleteFileInfoByAttId(att.getAttid());
