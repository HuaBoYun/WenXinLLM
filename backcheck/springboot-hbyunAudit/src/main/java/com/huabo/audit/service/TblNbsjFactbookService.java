...
public interface TblNbsjFactbookService {
     ...
     * @throws Exception
     */
	JsonBean submitArrpoval(String token, BigDecimal factid) throws Exception ;
	/**
	 * 查看审批页面
	 * @param token
	 * @param adviceid
	 ...
	 * @throws Exception
	 */
	JsonBean getApprovalInfo(String token, BigDecimal factid, String taskId, BigDecimal cyId) throws Exception;
	/**
	 * 办理
	 * @param token
	 * @param cyId
...
//	public PageBean findAll(Find find,Integer integer,Integer startIndex,Integer pageSize);
    ...
    JsonBean confirmationDelete(BigDecimal factid, String token) throws Exception;
    
    JsonBean findNbsjFactbookDetail(String token, BigDecimal factid) throws Exception;
