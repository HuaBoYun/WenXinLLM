 ...
 */
@Mapper
public interface TblProductInterestRuleMapper extends BaseMapper<TblProductInterestRule> {
    ...
    List<TblProductInterestRule> selectByProductType(@Param("productType") String productType, @Param("orgId") Long orgId);
