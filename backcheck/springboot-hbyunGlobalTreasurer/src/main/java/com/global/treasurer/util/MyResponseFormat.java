...
public class MyResponseFormat<T> {
	...
	public static <T> MyJsonBean<T> success() {
		return new MyJsonBean<>(1, "操作成功", null);
	}

	public static <T> MyJsonBean<T> success(T data) {
		return new MyJsonBean<>(1, "成功", data);
	}

	public static <T> MyJsonBean<T> success(T data, String message) {
		return new MyJsonBean<>(1, message, data);
	}

	public static <T> MyJsonBean<T> error(String msg) {
		return new MyJsonBean<>(0, msg, null);
	}

	public static <T> MyJsonBean<T> error(Integer code, String msg) {
		return new MyJsonBean<>(code, msg, null);
	}
}
