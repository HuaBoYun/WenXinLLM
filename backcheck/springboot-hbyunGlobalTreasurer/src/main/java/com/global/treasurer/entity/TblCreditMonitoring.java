...
@TableName("TBL_CREDIT_MONITORING")
public class TblCreditMonitoring implements Serializable {
    ...
    public Long getRelatedCreditId() { return relatedCreditId; }
    public void setRelatedCreditId(Long relatedCreditId) { this.relatedCreditId = relatedCreditId; }
    ...
    public String getHandleComments() { return handleComments; }
    public void setHandleComments(String handleComments) { this.handleComments = handleComments; }
