...
public class BdAcccountController {
	...
	@Operation(summary = "数据采集-会计科目基本信息列表")
	public JsonBean getFinanceDataList(HttpServletRequest request, HttpServletResponse response,BdAccountVo vo) throws Exception {
		TblStaffUtil staff = userProvider.get();
		if(staff == null) {
			return ResponseFormat.retParam(0, 20006, null);
		}
		return this.iBdAccountService.getFinanceDataList(staff,vo);
	}
