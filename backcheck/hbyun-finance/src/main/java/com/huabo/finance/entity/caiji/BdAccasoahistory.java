...
@Data
  @EqualsAndHashCode(callSuper = false)
    @TableName("BD_ACCASOAHISTORY")
@Schema(name="BdAccasoahistory对象", description="科目关联信息历史")
public class BdAccasoahistory implements Serializable {

    private static final long serialVersionUID = 1L;

      @Schema(name = "主键")
      @TableField("PK_ACCASOAHISTORY")
    private String pkAccasoahistory;
