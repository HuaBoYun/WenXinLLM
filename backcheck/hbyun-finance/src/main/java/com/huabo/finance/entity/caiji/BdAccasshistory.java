...
@Data
  @EqualsAndHashCode(callSuper = false)
    @TableName("BD_ACCASSHISTORY")
@Schema(name="BdAccasshistory对象", description="辅助核算历史")
public class BdAccasshistory implements Serializable {

    private static final long serialVersionUID = 1L;

      @Schema(name = "主键")
      @TableField("PK_ACCASSHISTORY")
    private String pkAccasshistory;
