...
@Mapper
public interface TblAssessPlanMapper extends BaseMapper<TblAssessPlan> {

	List<TblAssessPlan> findList(@Param("queryParam")TblAssessPlanVo queryParam,@Param("sql")String sql);
