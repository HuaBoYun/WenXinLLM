...
import com.huabo.monitor.mysql.entity.TblFlowMySql;
...
public class TblFlowMapperSqlMySqlConifg {

    public String selectTblFlowList(PageInfo<TblOrganizationMySql> pageInfo, String orgid, String faflowid, String name, String code) {
        StringBuffer sqlSb = new StringBuffer("");
        if (faflowid != null && !"".equals(faflowid)) {
            sqlSb = new StringBuffer("SELECT * FROM (SELECT BUDGET.* FROM (SELECT f.FLOWID,f.FLOWNAME,f.FLOWNUMBER,o.ORGNAME as comname,deo.ORGNAME as depname,f.CREATETIME,f.FLOWSTATUS,f.RELATEDRULES" +
    ...
    public String selectTblFlowCount(PageInfo<TblOrganizationMySql> pageInfo, String orgid, String faflowid, String name, String code) {
        ...
        String sqlCount = "select count(*) from (" + sql + ") as a ";
        return sqlCount.toString();
    }

    public String findBysqAllversion(PageInfo<TblFlowMySql> pageInfo, String orgid, String flowid) {
        StringBuffer sqlSb = new StringBuffer("SELECT * FROM (SELECT BUDGET.* FROM (SELECT 	f.FLOWID,	f.FLOWNAME,	f.FLOWNUMBER,	o.ORGNAME AS comname,	deo.ORGNAME AS depname,	"
        ...
        sqlSb.append(" ORDER BY VERSION desc ) BUDGET LIMIT " + pageInfo.getCurrentRecord() + " , " + pageInfo.getPageSize() + " ) as a ");
        return sqlSb.toString();
    }

    public String findBysqAllversionCount(PageInfo<TblFlowMySql> pageInfo, String orgid, String flowid) {
    ...
    public String findListByPageInfo(PageInfo<TblFlowMySql> pageInfo, BigDecimal orgid, String faflowid, String flowname, String flownumber, String stutes, String desc, String belongsto, BigDecimal fatherFlowid, Integer firingStatus) {
        StringBuffer sqlSb = new StringBuffer("");
        if (faflowid == null || "".equals(faflowid)) {
            sqlSb = new StringBuffer("SELECT * FROM (SELECT BUDGET.* FROM (SELECT f.FLOWID,f.FLOWNUMBER,f.FLOWNAME,f.COMPANY,f.DEPARTINCHARGE,f.CREATETIME," +
    ...
    public String findListByPageInfoFlow(PageInfo<TblFlowMySql> pageInfo, String orgid, CopyVo vo) {
        StringBuffer sqlSb = new StringBuffer("");
