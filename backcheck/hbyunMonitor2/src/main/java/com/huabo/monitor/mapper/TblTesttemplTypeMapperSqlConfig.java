...
public class TblTesttemplTypeMapperSqlConfig {
	...
	public String selectTreeListInfo(BigDecimal parentId, BigDecimal testtempletaid) {
		String sql = "SELECT * FROM TBL_TESTTEMPL_TYPE WHERE TESTTEMPLETAID = "+testtempletaid;
		if(parentId != null) {
	...
	public String insertEntity(TblTesttemplType newType) {
		String colSql = "INSERT INTO TBL_TESTTEMPL_TYPE(TYPEID, TYPENAME, TESTTEMPLETAID, CREATETIME ";
	...
	public String updateEntity(TblTesttemplType type) {
		String sql = "UPDATE TBL_TESTTEMPL_TYPE SET TYPENAME = '"+type.getTypename()+"',TESTTEMPLETAID = "+type.getTesttempletaid();
