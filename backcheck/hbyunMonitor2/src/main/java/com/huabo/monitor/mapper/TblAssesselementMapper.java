...
*/
	 ...
	 List<TblAssesselement> selectPageInfo(@Param("queryParam")TblAssesselement queryParma,@Param("sql")String sql);
    ...
    @Select("select * FROM TBL_ASSESSELEMENT  WHERE ASSELEID = #{id} order by ASSELEID FETCH FIRST 1 ROW ONLY")
    TblAssesselement selectById(BigDecimal id);
