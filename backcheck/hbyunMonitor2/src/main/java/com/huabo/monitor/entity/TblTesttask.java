 ...
 */
@Data
@TableName("TBL_TESTTASK")
@Schema(name="TblTesttask对象")
@KeySequence(value="HIBERNATE_SEQUENCE")
public class TblTesttask extends FlexibleFieldEntity implements Serializable {
    ...
    @Schema(name="测试有效性")
    @TableField("TESTPOINTVALIDITY")
    private String testpointvalidity;

    @Schema(name="执行有效性")
    @TableField("EXECUTEPOINTVALIDITY")
    private String executepointvalidity;
    
    @Schema(name="设计有效性")
    @TableField("DESIGNPOINTVALIDITY")
    ...
    @TableField("DUTYSTATION")
    @Schema(name="责任岗位")
    private String dutystation;
    
    @TableField("INSYSTEMNAME")
    @Schema(name="内部制度名称")
    ...
    @TableField(exist=false)
	@Column(name = "TWOPROCESS")
    @Schema(name="二级流程")
    private String twoprocess;
    
    @TableField(exist=false)
	@Column(name = "threeprocess")
    @Schema(name="三级流程")
    ...
    @TableField(exist=false)
	@Column(name = "EVALUATIONPOINT")
    @Schema(name="评价要点")
    private String evaluationpoint;
    
    @TableField(exist=false)
	@Column(name = "EVALUATIONPRO")
    @Schema(name="评价程序")
    private String evaluationpro;
    
    @TableField(exist=false)
	@Column(name = "EVALUATIONNODE")
    @Schema(name="评价记录")
	...
	//查询条件赋值到主表
   	public void setFieldActivationCopy(ControlTestImplSaveParam file){
