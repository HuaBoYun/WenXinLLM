...
@Configuration
@MapperScan(basePackages = {"com.huabo.central.enterprises.audit.mysql.mapper"}, sqlSessionTemplateRef = "mysqlSqlSessionTemplate")
public class DataSourceMySqlConfig {
	...
	public SqlSessionFactory mysqlSqlSessionFactory(@Qualifier(value = "mysqlDataSource") DataSource dataSource, MybatisProperties mybatisProperties)
		...
		bean.setTypeAliasesPackage("com.huabo.central.enterprises.audit.mysql.entity");
