...
@Configuration
@MapperScan(basePackages = "com.huabo.central.enterprises.audit.oracle.mapper", sqlSessionTemplateRef = "oracleSqlSessionTemplate")
public class DataSourceOracleConfig {
	...
	public SqlSessionFactory oracleSqlSessionFactory(@Qualifier(value = "oracleDataSource") DataSource dataSource,
		...
		bean.setTypeAliasesPackage("com.huabo.central.enterprises.audit.oracle.entity");
