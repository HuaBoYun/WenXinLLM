...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "TBL_CEA_CANCEL_HOLIDAY_EXP")
public class TblCeaCancelHolidayExp implements Serializable {
	...
	public static TblCeaCancelHolidayExp ofId(Long id) {
		TblCeaCancelHolidayExp tblCeaCancelHolidayOracle = new TblCeaCancelHolidayExp();
