package com.hbfk.util.redis.Random;

import com.github.yitter.contract.IdGeneratorOptions;
import com.github.yitter.idgen.YitIdHelper;
import com.hbfk.util.redis.CacheKeyUtil;
import com.hbfk.util.redis.context.SpringContext;
...
public class RandomUtil {
    ...
    private static byte WorkerIdBitLength = 7;
    private static byte SeqBitLength = 3;
    private static short TopOverCostCount = 200;
    ...
    private static int MaxWorkerIdNumberByMode = 65535;
     ...
     * @return
     */
    public static String uuStringId() {
     ...
     * @return
     */
    public static BigDecimal uuBigDecimalId() {
        long newId = YitIdHelper.nextId();
        return new BigDecimal(newId);
    }
