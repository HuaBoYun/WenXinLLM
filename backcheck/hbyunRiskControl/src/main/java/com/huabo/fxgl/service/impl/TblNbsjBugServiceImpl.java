...
//		}
		...
		PageInfo<TblFxgkBugEntity> pageInfo = new PageInfo<TblFxgkBugEntity>();
...
//			List<Object[]> objList1 = new ArrayList<Object[]>();
			//SELECT ORGNAME FROM TBL_ORGANIZATION org WHERE 1 = 1 AND ORGTYPE <> 0 AND orgtype < 100 START WITH ORGID = BU.BUGDEPARTMENT CONNECT BY PRIOR FATHERORGID = ORGID AND ROWNUM = 1
