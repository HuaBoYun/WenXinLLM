 ...
 */
@RestController
@RequestMapping(value = "/competition",method = {RequestMethod.GET, RequestMethod.POST})
@Tag(name="风险监控-竞争对手监控",description="风险监控-竞争对手监控")
@Slf4j
public class CompetitionMonitorController {
    @Autowired
