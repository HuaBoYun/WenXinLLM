...
//		}
	...
	public String selectCountByPageInfo(PageInfo<TblNbsjBugEntity> pageInfo,TblFxgkBugVo tblNbsjBugVo,BigDecimal orgid,Integer companyid) {
...
//				+ " AND TNA.BUGBYSYSTEM LIKE '%nbsj%' ");
	...
	//==
	public String selectInnerCommonListByPageInfo(PageInfo<TblNbsjInnerrule> pageInfo,Integer bugid,BigDecimal orgid) {
		StringBuffer sb = new StringBuffer("SELECT * FROM "
				+ "(SELECT T1.*,ROWNUM RN  FROM "
	...
	public String selectInnerCommonCountByPageInfo(PageInfo<TblNbsjInnerrule> pageInfo,Integer bugid,BigDecimal orgid) {
		StringBuffer sb = new StringBuffer("SELECT COUNT(0) "
				+ "FROM TBL_NBSJ_INNERRULE TNA "
				+ "WHERE INNRULID not in "
				+ "(SELECT DISTINCT INNRULID from TBL_NBSJ_BUG_INNERRULE "
	...
	public String selectInnerCommonListByLink(PageInfo<TblNbsjInnerrule> pageInfo,Integer bugid,BigDecimal orgid) {
		StringBuffer sb = new StringBuffer("SELECT * FROM "
				+ "(SELECT T1.*,ROWNUM RN  FROM "
				+ "(SELECT TNA.innrulid,TNA.rulecode,TNA.rulename,TNA.publishorg,TNA.publishdate,TNA.rulenumber,ORG.ORGNAME "
				+ "FROM TBL_NBSJ_INNERRULE TNA "
