...
//@MapperScan(basePackages = "com.huabo.cybermonitor.mapper", sqlSessionTemplateRef = "sqlSessionTemplate")
...
//		bean.setMapperLocations(mappers);
        bean.setTypeAliasesPackage("com.huabo.cybermonitor.entity");
    ...
    @Primary
    public SqlSessionTemplate dmSqlSessionTemplate(@Qualifier(value = "sqlSessionFactory") SqlSessionFactory sqlSessionFactory) throws Exception {
