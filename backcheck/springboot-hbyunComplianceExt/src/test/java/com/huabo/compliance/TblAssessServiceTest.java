...
import com.huabo.compliance.service.impl.CsjgServiceImpl;
...
//        System.out.println(new JsonBean(200,"",iPage));
        ...
        String sql="select lin.*,\n" +
                ...
                "       from(\n" +
                "SELECT distinct te.* from TBL_COM_EXT_TESTPLAN te\n" +
...
//        System.out.println(new JsonBean(200,"",treeListByTemid));
    ...
    public void test2() throws Exception {
        ...
        final IPage<Map<String, Object>> allWCSjCSHZ = this.csjgService.findAllWCSjCSHZ(null, 1, new BigDecimal(127822),16);
