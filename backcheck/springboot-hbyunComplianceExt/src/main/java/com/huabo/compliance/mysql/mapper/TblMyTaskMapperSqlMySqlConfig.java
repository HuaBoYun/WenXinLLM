...
import com.huabo.compliance.mysql.entity.TblMyTaskMySql;

public class TblMyTaskMapperSqlMySqlConfig {
    ...
    public String insertMyTaskSetting(TblMyTaskMySql task) {
        StringBuffer column = new StringBuffer("INSERT INTO TBL_MY_TASK (ID");
        StringBuffer value = new StringBuffer(" VALUES ("+task.getTaskId()+"");
        ...
        if(task.getApprovaldate() != null && !"".equals(task.getApprovaldate())){
            ...
            value.append(",TO_DATE('"+ DateUtil.parseDate(task.getApprovaldate(),"yyyy-MM-dd HH:mm:ss") + "'");
        }
    ...
    public String updateSetting(TblMyTaskMySql task) {
