...
import com.huabo.compliance.entity.TblOrgNoId;
import com.huabo.compliance.mapper.TblAutonoNumberMapper;
...
//						}
    ...
    public String findNumberLevelNexidByParent(Integer noId, String parentNumberCol, String parentTblName, String parentIdCol, String parentId,
                                               String chilNumberCol, String chilTblName, String chilOrgCol, Integer orgid, Map<String, String> choiceMap) throws Exception {
        Integer isUse = this.getIsUseAutoNoInfo(orgid);
        if (isUse == 0) {
...
//					childIds = this.tblAutonoNumberMapper.excuteFunReturnUnique("select getChildrenDeptList("+orgid+")");
    ...
    public String getNewCodeByHyZsk(BigDecimal orgid, Integer noId, String parentId, String parentTblName, String parentIdCol,
        ...
        Integer isUse = this.getIsUseAutoNoInfo(Integer.parseInt(orgid.toString()));
        if (isUse == 0) {
            return "-1";//该组织没有使用自定义编码
        } else {
            TblOrgNoId orgNo = this.getCodeRule(Integer.parseInt(orgid.toString()), noId);
            if (orgNo == null) {
                return "-1";
            } else {
                ...
                if (ancestorsNo.equals(fatherId)) {
                    ...
                    code = this.findNumberLevelNexidByParent(noId, parentNumberCol, parentTblName, parentIdCol, parentId, chilNumberCol, chilTblName, chilOrgCol, Integer.parseInt(orgid.toString()), choiceMap);
                }
                return code;
            }
        }
     ...
     * @throws Exception
     */
    public Integer getIsUseAutoNoInfo(Integer orgid) throws Exception {
     ...
     * @throws Exception
     */
    private TblOrgNoId getCodeRule(Integer orgid, Integer noId) throws Exception {
