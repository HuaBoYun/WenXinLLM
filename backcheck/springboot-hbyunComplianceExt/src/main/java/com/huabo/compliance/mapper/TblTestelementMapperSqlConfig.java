...
public class TblTestelementMapperSqlConfig {
	...
	public String selectPageList(PageInfo<TblTestelement> pageInfo) {
		...
		String sql = "SELECT T2.* FROM (SELECT T1.*,ROWNUM ROW_ID FROM (SELECT * FROM TBL_COM_EXT_TESTELEMENT WHERE TEMPLID = "+ele.getTemplid();
	...
	public String selectPageCount(PageInfo<TblTestelement> pageInfo) {
		...
		String sql = "SELECT COUNT(0) FROM TBL_COM_EXT_TESTELEMENT WHERE TEMPLID = "+ele.getTemplid();
	...
	public String insertEntity(TblTestelement newEle) {
		String colSql = "INSERT INTO TBL_COM_EXT_TESTELEMENT(ELEMENTID, CREATETIME ";
	...
	public String updateEntity(TblTestelement newEle) {
		String sql = "UPDATE TBL_COM_EXT_TESTELEMENT SET TEMPLID = "+newEle.getTemplid()+",TYPEID = "+newEle.getTypeid()+",ELEMENTCODE = '"+newEle.getElementcode()+"'";
