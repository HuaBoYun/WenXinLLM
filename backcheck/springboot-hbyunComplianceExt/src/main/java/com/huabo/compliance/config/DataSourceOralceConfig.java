...
@Configuration
@MapperScan(basePackages = "com.huabo.compliance.mapper", sqlSessionTemplateRef = "oracleSqlSessionTemplate")
...
//		bean.setMapperLocations(mappers);
		bean.setTypeAliasesPackage("com.huabo.compliance.entity");
