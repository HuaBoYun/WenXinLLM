...
import com.huabo.compliance.mysql.entity.TblBiReportMenuMySql;
import com.huabo.compliance.mysql.entity.TblCourseMySql;

import java.math.BigDecimal;

public class TblBiReportMenuMapperSqlMySqlConfig {

    public String selectType(PageInfo<TblBiReportMenuMySql> pageInfo, String type, BigDecimal orgid) {
        ...
        sbSql.append(" order by PAGEID  LIMIT " + pageInfo.getCurrentRecord() + "," + pageInfo.getPageSize());
        return sbSql.toString();
    }

    public String selectOrgid(PageInfo<TblCourseMySql> pageInfo, String type, BigDecimal orgid) {
    ...
    public String selectMenuList(PageInfo<TblBiReportMenuMySql> pageInfo, Integer type, BigDecimal orgid) {
    ...
    public String insertTbrm(TblBiReportMenuMySql tbrm) {
        StringBuffer column = new StringBuffer("INSERT INTO TBL_BI_REPORT_MENU (PAGEID ");
        StringBuffer value = new StringBuffer(" VALUES (" + tbrm.getPageid() + "");
        ...
        if (tbrm.getCreatedate() != null) {
            ...
            value.append(",'" + DateUtil.parseDate(tbrm.getCreatedate(), "yyyy-MM-dd HH:mm:ss") + "'");
        }
    ...
    public String updateReportMenu(TblBiReportMenuMySql page) {
    ...
    public String addPage(TblBiReportMenuMySql page) {
        StringBuffer column = new StringBuffer("INSERT INTO TBL_BI_REPORT_MENU (PAGEID");
        StringBuffer value = new StringBuffer(" VALUES (" + page.getPageid() + "");
        ...
        if (page.getCreatedate() != null) {
            column.append(",CREATEDATE");
            value.append(",'" + DateUtil.parseDate(page.getCreatedate(), "yyyy-MM-dd HH:mm:ss") + "'");
        }
