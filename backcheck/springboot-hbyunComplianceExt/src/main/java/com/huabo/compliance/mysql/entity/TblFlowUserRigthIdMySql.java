...
@Schema(name="TblFlowUserRigthIdMySql")
public class TblFlowUserRigthIdMySql implements java.io.Serializable {
     ...
     * default constructor
     */
    public TblFlowUserRigthIdMySql() {
    }

    /**
     * full constructor
     */
    public TblFlowUserRigthIdMySql(BigDecimal flowid, BigDecimal staffid) {
        this.flowid = flowid;
    ...
    public boolean equals(Object other) {
        ...
        if ((other == null))
            return false;
        if (!(other instanceof TblFlowUserRigthIdMySql))
            return false;
        TblFlowUserRigthIdMySql castOther = (TblFlowUserRigthIdMySql) other;
