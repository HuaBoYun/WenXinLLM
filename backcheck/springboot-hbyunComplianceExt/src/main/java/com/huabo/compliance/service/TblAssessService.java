...
public interface TblAssessService extends IService<TblAssess> {
    ...
    IPage<TblAssessVo> initiatePjgl ( boolean isAudit,BigDecimal orgid,BigDecimal staffid,String realName,Integer pageNumber,String assNumnber, String assName, String startDate, String startDates, String endDate, String endDates,Integer pageSize);

    /**
     *  评价结果列表
     */
    IPage<TblAssessVo> initiatePjjg ( Integer pageNumber,String assNumnber, String assName, String startDate, String startDates, String endDate, String endDates,TblStaffUtil staff,Integer pageSize);
    ...
    void findAll(IPage<Map<String,Object>> page ,String tblComany, String templeNumber ,String templename, String orgids);


    Long selectTblassessNumber(String assessid, BigDecimal orgids);


    // 评价立项-新建页面-保存
    JsonBean saveAssEss(TblStaffUtil staff, TblAssess tblAssess, String orgid);
    // 评价模板  双百测算
    ...
    JsonBean updateAssEss(TblStaffUtil staff,String assid,String assessname,String start,String end,String staffid,BigDecimal templatekey,String orgid );
    /**
     *项目评分列表
     *
     * @return
