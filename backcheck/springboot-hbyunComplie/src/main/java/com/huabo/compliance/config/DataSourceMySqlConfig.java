...
@Configuration
@MapperScan(basePackages = {"com.huabo.compliance.mysql.mapper"}, sqlSessionTemplateRef = "mysqlSqlSessionTemplate")
public class DataSourceMySqlConfig {
	...
	public SqlSessionFactory mysqlSqlSessionFactory(@Qualifier(value = "mysqlDataSource") DataSource dataSource, MybatisProperties mybatisProperties)
		...
		bean.setTypeAliasesPackage("com.huabo.legal.mysql.entity");
