package com.huabo.compliance.config;
...
@Configuration
@MapperScan(basePackages = "com.huabo.compliance.oracle.mapper", sqlSessionTemplateRef = "oracleSqlSessionTemplate")
public class DataSourceOracleConfig {
	...
	public SqlSessionFactory oracleSqlSessionFactory(@Qualifier(value = "oracleDataSource") DataSource dataSource,
		...
		bean.setTypeAliasesPackage("com.huabo.compliance.oracle.entity");
