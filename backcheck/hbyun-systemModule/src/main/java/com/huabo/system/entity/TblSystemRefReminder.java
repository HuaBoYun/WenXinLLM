 ...
 * 人员催办表
 */
@Schema(name = "TblSystemRefReminder")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "TBL_SYSTEM_REF_REMINDER")
public class TblSystemRefReminder {
	...
	@Schema(name="关联ID-TBL_SYSTEM_REFOPM_REMINDER ID")
	...
	public static TblSystemRefReminder ofId(Long id) {
		TblSystemRefReminder tblSystemRefReminder = new TblSystemRefReminder();
