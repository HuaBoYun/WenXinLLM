...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "TBL_SYSTEM_REFOPM_REMINDER_V")
public class TblSystemRefopmReminderV {
	...
	@Schema(name="催办类型：1-自动催办 2-手动催办 3-定制催办")
	private Integer reminderId;

	@Column(name = "REMINDERTYPE")
	@Schema(name="催办周期类型：1-月 2-周 3-定制")
	...
	@Column(name = "REMINDERBUSINESSSTAFF")
	@Schema(name="催办业务人员字段")
	private String reminderBusinessStaff;

	@Column(name = "REMINDERBUSINESSTIME")
	@Schema(name="催办业务时间字段")
	private String reminderBusinessTime;

	@Column(name = "REMINDERBUSINESSCONTENT")
	@Schema(name="催办业务内容字段")
	private String reminderBusinessContent;

	@Column(name = "REMINDERBUSINESSID")
	@Schema(name="催办业务表主键名")
	private String reminderBusinessId;

	@Column(name = "DATETIME")
	@Schema(name = "提前催办日（例子：1/-1）")
	...
	public static TblSystemRefopmReminderV ofId(Long id) {
		TblSystemRefopmReminderV tblSystemRefopmReminder = new TblSystemRefopmReminderV();
		tblSystemRefopmReminder.setId(id);
		return tblSystemRefopmReminder;
	}

	public static TblSystemRefopmReminderV ofIsStop(Long id, Integer isStop) {
		TblSystemRefopmReminderV tblSystemRefopmReminder = new TblSystemRefopmReminderV();
		tblSystemRefopmReminder.setId(id);
