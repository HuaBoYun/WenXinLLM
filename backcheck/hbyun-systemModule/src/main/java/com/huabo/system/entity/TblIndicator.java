...
@Schema(name="TblIndicator对象", description="")
public class TblIndicator implements Serializable {

    private static final long serialVersionUID = 1L;

      @TableId(value="INDICATORID",type = IdType.INPUT)
   ...
   @Transient
    ...
    @Transient
    private Set<TblFlow> tblIndicatorFlows = new HashSet();
}
