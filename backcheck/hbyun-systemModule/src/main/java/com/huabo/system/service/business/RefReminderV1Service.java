...
public interface RefReminderV1Service {
	 ...
	 * @return
	 */
	MyJsonBean<TblSystemRefReminderV> getRefReminderList(TblSystemRefReminderQueryParam param);
	 ...
	 * @return
	 */
	MyJsonBean<TblSystemRefReminderAccessV> getRefReminderAccessList(TblSystemRefReminderAccessQueryParam param);
	 ...
	 * @return
	 */
	MyJsonBean<TblSystemRefReminderV> getRefReminder(TblStaffUtil loginStaff, Long id, String token);
}
