...
public class PageResult<T> {
	...
	public PageResult<T> build(IPage<T> pageList) {
		this.totalRecord = (int) pageList.getTotal();
		this.currentPage = (int) pageList.getCurrent();
		this.totalPage = (int) pageList.getTotal();
		this.pageSize = (int) pageList.getSize();
		this.tlist = pageList.getRecords();
		return this;
	}
}
