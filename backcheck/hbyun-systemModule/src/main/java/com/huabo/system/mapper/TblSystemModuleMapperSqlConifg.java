...
public class TblSystemModuleMapperSqlConifg {

    public String selectPageInfoByOrgId(IPage<TblSystemModule> page,BigDecimal orgid,TblSystemModule module) throws Exception {
        StringBuffer sqlSb = new StringBuffer("SELECT MODELID,MODELNAME,MODELSTATUS,MODELTYPE,MODELNO,TS.REALNAME createPersonName,T1.CREATETIME FROM " +
                ...
                "WHERE MODELORG = "+orgid+" AND MODELTYPE NOT IN ('nk','fxgl','nbsj','znjk','fcobc')) AS " + DataBaseSqlConfig.setTableAliasName("T1") +
        ...
        sqlSb.append(" ORDER BY MODELSTATUS DESC,MODELID ASC ");
        return sqlSb.toString();
    }

    public String insertSystemModule(TblSystemModule module) throws Exception {
        StringBuffer column = new StringBuffer("INSERT INTO TBL_SYSTEM_MODULE (MODELID");
        StringBuffer value = new StringBuffer(" VALUES (").append(module.getModelId());
        ...
        if(module.getCreateTime() != null) {
            ...
            value.append(",").append(DataBaseSqlConfig.getDateStrFormat(module.getCreateTime()));
        }
        if(module.getModifyTime() != null) {
            column.append(",MODIFYTIME");
            value.append(",").append(DataBaseSqlConfig.getDateStrFormat(module.getModifyTime()));
        }
    ...
    public String updateByModule(TblSystemModule oldModule) throws Exception {
        ...
        if(oldModule.getCreateTime() != null) {
            sql.append(" ,CREATETIME = ").append(DataBaseSqlConfig.getDateStrFormat(oldModule.getModifyTime()));
        }
        ...
        if(oldModule.getModifyTime() != null) {
            sql.append(" ,MODIFYTIME = ").append(DataBaseSqlConfig.getDateStrFormat(oldModule.getModifyTime()));
        }
