...
public class TblLoginTypeMapperSqlConfig {
    ...
    public String selectListByPageInfo(IPage<TblLoginType> page, BigDecimal orgid) {
        StringBuffer sqlSb = new StringBuffer("SELECT * from TBL_LOGINTYPE WHERE ORGID =" +orgid);
        sqlSb.append(" ORDER BY LOGINID DESC ");
