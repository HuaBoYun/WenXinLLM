...
@Schema(name="RiskCoping")
public class RiskCoping {
	...
	@TableId(value="RISKCOPINGID",type = IdType.INPUT)
	...
	public TblRisk getRisk() {
		return risk;
	}
	public void setRisk(TblRisk risk) {
		this.risk = risk;
	}
