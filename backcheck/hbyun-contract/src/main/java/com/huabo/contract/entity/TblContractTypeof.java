...
@Schema(name="TblContractTypeof对象")
public class TblContractTypeof implements Serializable {

	private static final long serialVersionUID = 1L;

    
	public static final String delfaultSetting = "HTDL";
    ...
    @Schema(name = "只能审计  nbsj")
    @TableField("TYPE")
    private String type;

    @Transient
	@TableField(exist = false)
    private List<TblContractTypeof> childrenList = new ArrayList(0);
