...
@Data
  @EqualsAndHashCode(callSuper = false)
    @TableName("TBL_CONTRACT_TRAN")

@Schema(name="合同移交")
public class TblContractTran implements Serializable {

	private static final long serialVersionUID = 1L;

	@TableId(value = "TRANID",type=IdType.INPUT)
    ...
    @Schema(name = "经办人")
    @TableField("HANDSTAFFNAME")
    private String handStaffName;
    
    @Schema(name = "经办部门")
    @TableField("HANDDEPTID")
    private BigDecimal handDeptId;
    
    @Schema(name = "经办部门")
    @TableField("HANDDEPTNAME")
    private String handDeptName;
    
    @Schema(name = "所属单位")
    @TableField("TRANORGID")
    private BigDecimal tranOrgId;
    
    @Schema(name = "所属单位")
    @TableField("TRANORGNAME")
    ...
    @Schema(name = "移交情况")
    @TableField("TRANSITUATION")
    private String tranSituation;
