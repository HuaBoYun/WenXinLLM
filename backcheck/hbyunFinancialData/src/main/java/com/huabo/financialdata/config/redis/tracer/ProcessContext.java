...
public class ProcessContext {
    ...
    public enum Type {
        Controller, Service, DataAccess, RedisMessageConsumer, RabbitMessageConsumer, RestTemplate, DubboProvider, DubboConsumer, URLPermissionFilter, Filter, NetHandler, Other
    }
    ...
    private void doSetAttribute(String name, Object value) {
        if (value == null) {
            ...
            if (this.attributes.containsKey(name)) {
                logger.warn("duplicated context attribute [" + name + "]");
            }
