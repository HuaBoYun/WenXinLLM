...
public class MyResponseFormat {
	...
	public static MyJsonBean retParam(Integer code, Integer status, Object data) {
		MyJsonBean json = new MyJsonBean(code, messageMap.get(status), data);
		return json;
	}


	public static MyJsonBean retParam(Integer code, String msg, Object data) {
		MyJsonBean json = new MyJsonBean(code, msg, data);
		return json;
	}
	 ...
	 * 成功响应
	 */
	public static MyJsonBean success() {
		return new MyJsonBean(200, "成功", null);
	}

	/**
	 * 成功响应-带数据
	 */
	public static MyJsonBean success(Object data) {
		return new MyJsonBean(200, "成功", data);
	}

	/**
	 * 成功响应-带数据和消息
	 */
	public static MyJsonBean success(Object data, String message) {
		return new MyJsonBean(200, message, data);
	}

	/**
	 * 成功响应-带消息
	 */
	public static MyJsonBean success(String message) {
		return new MyJsonBean(200, message, null);
	}

	/**
	 * 成功响应-带两个字符串参数
	 */
	public static MyJsonBean success(String data, String message) {
		return new MyJsonBean(200, message, data);
	}
	 ...
	 * 错误响应
	 */
	public static MyJsonBean error() {
		return new MyJsonBean(500, "服务器错误", null);
	}

	/**
	 * 错误响应-带消息
	 */
	public static MyJsonBean error(String message) {
		return new MyJsonBean(500, message, null);
	}

	/**
	 * 错误响应-带状态码
	 */
	public static MyJsonBean error(Integer code, String message) {
		return new MyJsonBean(code, message, null);
	}
}
