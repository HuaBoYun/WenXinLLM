    ...
    children: [
      {
        path: 'project',
        name: 'ProjectAnalyse',
        component: '@/views/audit/analyse/project',
        meta: {
          title: '项目情况分析',
          icon: 'booklet-line',
        },
      },
      {
        path: 'audit',
        name: 'Audit',
        component: '@/views/audit/analyse/audit',
        meta: {
          title: '审计问题分析',
          icon: 'eye-line',
        },
      },
      {
        path: 'corrective',
        name: 'Corrective',
        component: '@/views/audit/analyse/corrective',
        meta: {
          title: '整改问题分析',
          icon: 'archive-line',
        },
    ...
    children: [
      {
        path: 'index',
        name: 'Index',
        component: '@/views/audit/plan/index',
        meta: {
          title: '计划管理',
          icon: 'booklet-line',
        },
      },
      {
        path: 'look',
        name: 'Look',
        component: '@/views/audit/plan/look',
        meta: {
          title: '计划查看',
          icon: 'eye-line',
        },
      },
      {
        path: 'record',
        name: 'Record',
        component: '@/views/audit/plan/record',
        meta: {
          title: '审计档案',
          icon: 'archive-line',
        },
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'evidence',
        name: 'Evidence',
        component: '@/views/audit/implement/auditEvidence',
        meta: {
          title: '审计取证',
          icon: 'draft-line',
        },
