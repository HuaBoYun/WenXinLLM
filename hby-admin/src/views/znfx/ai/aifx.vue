            ...
            <div class="answerBox">
              ...
              <div class="tipBox">
                ...
                <div
                  ...
                  @click="
                    question =
                      '近五年来，每年招标项目有多少，用折线图表示（“招标项目”去重计数）'
                  "
                >
                  近五年来，每年招标项目有多少，用折线图表示（“招标项目”去重计数）
                </div>
                <div
                  ...
                  @click="
                    question =
                      '近五年来，参与投标最多的十家投标人，用柱状图表示（“投标人名称”计数，排序取前十）'
                  "
                >
                  近五年来，参与投标最多的十家投标人，用柱状图表示（“投标人名称”计数，排序取前十）
                </div>
                <div
                  ...
                  @click="
                    question =
                      '2019-2023年中标次数最多的十家投标人，用柱状图表示（“中标人”为“是”，“投标人名称”计数，排序取前十）'
                  "
                >
                  2019-2023年中标次数最多的十家投标人，用柱状图表示（“中标人”为“是”，“投标人名称”计数，排序取前十）
                </div>
                <div
                  ...
                  @click="
                    question =
                      '2023年中标次数最多五家投标人都有谁，用柱状图表示（“年度”为2023，“中标人”为“是”，“投标人名称”计数，排序取前五）'
                  "
                >
                  2023年中标次数最多五家投标人都有谁，用柱状图表示（“年度”为2023，“中标人”为“是”，“投标人名称”计数，排序取前五）
                </div>
        ...
        axios({
          ...
          .then((res) => {
            const isChartRelated =
              that.question.includes('折线图') ||
              that.question.includes('柱状图')

            if (isChartRelated) {
              this.newTest(res.data.table)
            } else {
              this.newTest({
                chart: {
                  type: 'table',
