        ...
        <!-- <h3>权限配置</h3>
				<el-card style="margin-top: 20px">
					...
					<div v-if="postForm.openType === 2">
						...
						<el-tree v-loading="treeLoading" ref="tree" :data="treeData" :default-checked-keys="postForm.departIds"
							:props="defaultProps" :filter-node-method="filterNode" empty-text=" " default-expand-all show-checkbox
...
<script>
  ...
  import { getDetail, saveData } from '@/api/fwgl/ksgl'
