<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="尽调单位" prop="firmRegulationsAuditNumber">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="尽调内容" prop="regulationsAuditRatio">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="尽调时间" prop="firmEconomicsContractNumber">
            <el-date-picker
        ...
        <el-col :span="12">
          <el-form-item label="尽调人" prop="economicsContractRatio">
            <el-input
