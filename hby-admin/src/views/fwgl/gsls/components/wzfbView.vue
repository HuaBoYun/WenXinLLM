<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="题目" prop="firmRegulationsAuditNumber">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="发表载体" prop="regulationsAuditRatio">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="发表时间" prop="firmEconomicsContractNumber">
            <el-date-picker
        ...
        <el-col :span="12">
          <el-form-item label="作者" prop="economicsContractRatio">
            <el-input
