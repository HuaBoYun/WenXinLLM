  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        <el-table-column align="center" label="案件名称" prop="courtfirst">
...
<script>
  ...
  import ArbitrationEdit from '@/views/fwgl/legal/components/ArbitrationEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        total: 0,
        localKey: 'fwgl-legal-arbitration-search',
        tableKey: 'fwgl-legal-arbitration-list',
        searchNow: [],
        searchMore: true,
        searchItem: [],
