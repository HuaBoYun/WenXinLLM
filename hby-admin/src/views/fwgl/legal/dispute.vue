      ...
      <el-table v-loading="listLoading" :data="list">
        ...
        <div v-for="(item, index) in filedNow" :key="index">
          ...
          >
            <template slot-scope="scope">
              <span>
                {{ typeList[+scope.row.whethersued] }}
              </span>
            </template>
          </el-table-column>
          <el-table-column
...
<script>
  ...
  import DisputeEdit from '@/views/fwgl/legal/components/DisputeEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        total: 0,
        localKey: 'fwgl-legal-dispute-search',
        tableKey: 'fwgl-legal-dispute-list',
        searchNow: [],
        searchMore: true,
        searchItem: [],
