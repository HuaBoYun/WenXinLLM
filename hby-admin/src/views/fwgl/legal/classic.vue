  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        <el-table-column align="center" label="案例编号" prop="disputeno" />
        ...
        <el-table-column
          align="center"
          label="操作"
          v-if="!this.list.isDeleteDisplay"
        >
          <template #default="{ row }">
            <!-- <el-button type="text" @click="handleApproval(row)">
              提交审批
            </el-button>
            <el-button type="text" v-if="userInfo.staffid === row.createstaff" @click="handleEdit(row)">修改</el-button> -->
            <el-button
              type="text"
...
<script>
  import { getlegalList, RemoveLegalAccountList } from '@/api/fwgl/legal'
  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import AccountEdit from '@/views/fwgl/legal/components/AccountEdit'
  export default {
    name: 'classic',
    components: { AccountEdit, filterTable, filterSearch },
    data() {
      return {
        list: [],
        listLoading: true,
        ...
        total: 0,
        localKey: 'fwgl-legal-classic-search',
        tableKey: 'fwgl-legal-classic-list',
        searchNow: [],
        searchMore: true,
        searchItem: [],
    ...
    methods: {
      ...
      async fetchData() {
        ...
        } = await getlegalList(this.queryForm)
        this.list = tlist
      ...
      handleDelete(row) {
        this.$baseConfirm('你确定要删除当前项吗', null, async () => {
          //
          const { msg } = await RemoveLegalAccountList({
