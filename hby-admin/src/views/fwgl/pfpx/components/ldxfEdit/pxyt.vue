  ...
  <div>
    ...
    >
      <el-row :gutter="24">
        ...
        >
          <el-col :span="12">
            <el-form-item label="研讨主题" prop="discussTopic">
              <el-input
                v-model="formData.discussTopic"
                clearable
                placeholder="请输入研讨主题"
                :style="{ width: '100%' }"
              />
          ...
          <el-col :span="12">
            <el-form-item label="培训时间" prop="discussTime">
              <el-date-picker
                style="width: 100%"
                v-model="formData.discussTime"
                placeholder="选择培训时间"
                type="datetime"
                format="yyyy-MM-dd "
          ...
          <el-col :span="24">
            <el-form-item label="研讨主题内容" prop="discussContent">
              <el-input
                type="textarea"
                v-model="formData.discussContent"
                clearable
                placeholder="请输入研讨主题内容"
                :style="{ width: '100%' }"
              />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="参加对象" prop="discussParticipant">
              <el-input
                type="textarea"
                v-model="formData.discussParticipant"
                clearable
                :style="{ width: '100%' }"
              />
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="新闻链接" prop="discussNewsLink">
              <el-input
                placeholder="请输入新闻链接"
                v-model="formData.discussNewsLink"
                :style="{ width: '100%' }"
              ></el-input>
            </el-form-item>
          </el-col>
