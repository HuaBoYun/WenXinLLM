  ...
  <div>
    ...
    >
      <el-row :gutter="24">
        ...
        >
          <el-col :span="12">
            <el-form-item label="学习主题" prop="centralGroupTopic">
              <el-input
                v-model="formData.centralGroupTopic"
                clearable
                placeholder="请输入学习主题"
                :style="{ width: '100%' }"
              />
          ...
          <el-col :span="12">
            <el-form-item label="学习时间" prop="centralGroupTime">
              <el-date-picker
                style="width: 100%"
                v-model="formData.centralGroupTime"
                placeholder="选择学习时间"
                type="date"
                format="yyyy-MM-dd"
          ...
          <el-col :span="24">
            <el-form-item label="学习安排" prop="centralGroupContent">
              <el-input
                v-model="formData.centralGroupContent"
                type="textarea"
                clearable
                placeholder="请输入学习安排"
                :style="{ width: '100%' }"
          ...
          <el-col :span="24">
            <el-form-item label="参加对象" prop="centralGroupParticipant">
              <el-input
                v-model="formData.centralGroupParticipant"
                clearable
                type="textarea"
                :style="{ width: '100%' }"
              />
          ...
          <el-col :span="12">
            <el-form-item label="新闻链接" prop="centralGroupNewsLink">
              <el-input
                placeholder="请输入新闻链接"
                v-model="formData.centralGroupNewsLink"
                :style="{ width: '100%' }"
              ></el-input>
            </el-form-item>
          </el-col>
  ...
  export default {
    ...
    data() {
      return {
        ...
        formData: {
          centralGroupContent: '',
          centralGroupNewsLink: '',
          centralGroupParticipant: '',
          centralGroupTime: '',
          centralGroupTopic: '',
          leaderType: '1',
        },
