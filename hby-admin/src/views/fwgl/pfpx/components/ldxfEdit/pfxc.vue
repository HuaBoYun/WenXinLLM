  ...
  <div>
    ...
    >
      <el-row :gutter="24">
        ...
        >
          <el-col :span="12">
            <el-form-item label="活动主题" prop="propagandaTopic">
              <el-input
                v-model="formData.propagandaTopic"
                clearable
                placeholder="请输入活动主题"
                :style="{ width: '100%' }"
              />
          ...
          <el-col :span="12">
            <el-form-item label="活动时间" prop="propagandaTime">
              <el-date-picker
                style="width: 100%"
                v-model="formData.propagandaTime"
                placeholder="选择活动时间"
                type="datetime"
          ...
          <el-col :span="24">
            <el-form-item label="活动内容" prop="propagandaContent">
              <el-input
                type="textarea"
                v-model="formData.propagandaContent"
                clearable
                placeholder="请输入活动内容"
                :style="{ width: '100%' }"
              />
          ...
          <el-col :span="24">
            <el-form-item label="活动对象" prop="propagandaParticipant">
              <el-input
                type="textarea"
                v-model="formData.propagandaParticipant"
                clearable
                :style="{ width: '100%' }"
              />
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="新闻链接" prop="propagandaNewslink">
              <el-input
                placeholder="请输入新闻链接"
                v-model="formData.propagandaNewslink"
                :style="{ width: '100%' }"
              ></el-input>
            </el-form-item>
          </el-col>
