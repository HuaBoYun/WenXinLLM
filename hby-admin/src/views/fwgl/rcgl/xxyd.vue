<template>
  <div class="system-log-container">
    ...
    <XXYDview ref="edit" @fetchData="fetchData"></XXYDview>
    <el-pagination
      class="pagination"
      background
...
<script>
  import { getXXYDList, XXYDDelete } from '@/api/systemLog'

  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import XXYDview from './components/xxydView.vue'

  export default {
    name: 'NormalReportList',
    components: { filterTable, filterSearch, XXYDview },
    data() {
      return {
        list: [],
        listLoading: true,
        ...
        localKey: 'fwgl-rcgl-xxyd-search',
        tableKey: 'fwgl-rcgl-xxyd-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
      }
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$baseConfirm('你确定要删除当前项吗', null, async () => {
          const res = await XXYDDelete({ lingid: row.lingid })
          if (res.code == 1) {
