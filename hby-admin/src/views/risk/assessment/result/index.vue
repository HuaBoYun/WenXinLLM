  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel class="option-row">
        ...
        <!-- <el-button type="success" @click="handleEdit(false)">新建</el-button> -->
...
<script>
  ...
  export default {
    ...
    created() {
      // 接收riskname参数
      if (this.$route.query.riskname) {
        this.queryForm.riskname = this.$route.query.riskname
      }
      this.fetchData()
    ...
    methods: {
      ...
      async fetchData(type) {
        ...
        } = await riResultQueryList(this.queryForm)
        this.list = list
        this.total = total
