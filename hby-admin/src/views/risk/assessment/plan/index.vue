          ...
          <template #default="{ row }">
            ...
            <el-dropdown style="margin-left: 10px">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                >
                  <el-button type="text" :disabled="!+row.aprstatus">
                    办理
                  </el-button>
                </el-dropdown-item>
                <el-dropdown-item
                ...
                <el-dropdown-item @click.native="handleIssued(row)">
                  <el-button
                    :disabled="
                      row.planStatus != '1' ||
                      row.aprstatus != '6' ||
                ...
                <el-dropdown-item
                  :disabled="row.planStatus != '1' || !!+row.aprstatus"
...
<script>
  import { getList, deletePlan, down, riskPlanSituation } from '@/api/systemLog'
  ...
  export default {
    name: 'PlanList',
    components: {
      PlanEdit: () => import('./components/PlanEdit.vue'),
      PlanRead,
      filterSearch,
      filterTable,
      ProcessList,
    ...
    methods: {
      ...
      async handleIssued(row) {
        const { code, msg } = await down({ id: row.assplanid })
        if (code == 1) {
      ...
      handleDelete(row) {
        ...
        // }
        // const data = {
        //   assplanid: row.assessmentstd.assstdid,
        //   selectList: '',
        // }
        // riskadd().then((res) => {
        //   console.log('res', res)
