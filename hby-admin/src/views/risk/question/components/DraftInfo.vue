<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="底稿编号" label-width="140px" prop="worksheetnumber">
            <el-input
              v-model="formData.worksheetnumber"
              clearable
              placeholder="请输入底稿编号"
              :style="{ width: '100%' }"
              :disabled="!footer"
        ...
        <el-col :span="12">
          <el-form-item label="底稿名称" label-width="140px" prop="worksheetname">
            <el-input
              v-model="formData.worksheetname"
              clearable
              placeholder="请输入底稿名称"
              :style="{ width: '100%' }"
              :disabled="!footer"
        ...
        <el-col :span="12">
          <el-form-item label="被审计单位" label-width="140px" prop="auditedorg">
            <el-input
              v-model="formData.auditedorg"
              clearable
        ...
        <el-col :span="12">
          <el-form-item label="审计人员" label-width="140px" prop="recorder">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="审计目的" label-width="140px" prop="audittarget">
            <el-input
              v-model="formData.audittarget"
              clearable
              placeholder="请输入审计目的"
              :style="{ width: '100%' }"
              :disabled="!footer"
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        baseApi: baseURL,
        api: '/riskcontrol/file/uploadFileAttInfo',
        headers: {
    ...
    methods: {
      ...
      showEdit(title, row) {
        ...
        if (row) {
          this.formData = row.ws
          this.tableData = row.fj
        }
        if (title == 'edit') {
          this.title = '编辑'
