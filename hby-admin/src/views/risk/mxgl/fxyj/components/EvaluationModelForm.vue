  ...
  methods: {
    ...
    async loadDataModelManagement() {
      try {
        ...
        console.log('📊 风险预警表单 - 调用 getAvailableDataModels API...')
        ...
        console.log('📊 风险预警表单 - 数据模型API响应:', dataModelResponse)
    ...
    async loadCombinationAnalysis() {
      try {
        ...
        console.log('📊 风险预警表单 - 调用指标组合分析API...')
        ...
        console.log('📊 风险预警表单 - 指标组合分析API响应:', combinationResponse)
