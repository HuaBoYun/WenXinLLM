        ...
        >
            ...
            >
              ...
              >
                <!-- <template slot="append">
                  <el-button type="primary"     disabled @click="handleShowUser">
                    选 择
                  </el-button>
                </template> -->
              </el-input>
          ...
          <el-col :span="12">
            <el-form-item
              class="form-inlink"
              label="控制频率"
              prop="controlfrequency"
            >
              <el-input v-model="formData.controlfrequency" disabled></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item
          ...
          <el-col :span="12">
            ...
            >
              ...
              >
                <el-option
                  v-for="item in financialreportidentifyOptions"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                />
