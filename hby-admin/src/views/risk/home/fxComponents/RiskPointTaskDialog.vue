...
<script>
  import { getRiskPointTaskList } from '@/oapi/risk/index'
  import { formatDay } from '@/utils/index'

  export default {
    name: 'RiskPointTaskDialog',
    props: {
      orgid: {
        type: [String, Number],
        default: '',
    ...
    methods: {
      ...
      async fetchData() {
        ...
        try {
          const {
            data: { data },
          } = await getRiskPointTaskList(this.queryForm)
