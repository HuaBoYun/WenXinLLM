...
<template>
  <div class="container">
    <!-- 切换到风险模块默认进入驾驶舱，不预加载消息/催办列表；进入消息中心时再调用流程信息接口。 -->
    <!-- <el-card>
      <div
        class="xiafa-title"
      ...
      <el-row :gutter="10">
        ...
        <el-card>
          <el-row :gutter="10">
            ...
            <el-col :span="6">
              <div style="border: 1px solid #d2d2d2">
                <chat9 :orgid="orgid" :orgname="selectedOrgname"></chat9>
              </div>
            </el-col>
            <el-col :span="6">
              <el-col :span="24">
    ...
    >
      <ScreenDisplay :risk-data="riskScreenData" @close="closeFullScreen" />
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      selectedOrgname() {
        const found = this.companyList.find((item) => item.orgid === this.orgid)
        return found ? found.orgname : ''
      },
    },
    watch: {
      orgid: {
