          ...
          <template #default="{ row }">
            ...
            <el-dropdown style="margin-left: 10px">
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item>
                  <el-button
                    :disabled="row.status != 6 || row.toreport == 1"
...
<script>
  import { getMajorRiskCreateList, majorTransfer } from '@/api/risk/create.js'
    ...
    methods: {
      ...
      getFiled() {
        let fields = [
          { name: '季度', key: 'jd' },
          { name: '年度', key: 'nd' },
          { name: '填报单位', key: 'linkOrgName' },
          { name: '创建人', key: 'createname' },
          { name: '上报状态', key: 'toreport' },
      ...
      handleSubmit(row) {
        ...
        this.$baseConfirm('你确定要提交审批当前项吗', null, async () => {
          this.$refs['process'].save(213, row.id)
        })
      },
