        ...
        <vab-query-form-left-panel style="width: 100%">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              />
              <el-input
                v-model="queryForm.jxName"
                clearable
                placeholder="结息日名称"
                v-if="item.name === '结息日名称'"
              />
              <el-select
                v-model="queryForm.jxType"
                placeholder="结息日方式"
                clearable
                v-if="item.name === '结息日方式'"
              >
                <el-option
              ...
              <el-select
                v-model="queryForm.jx"
                placeholder="结息日"
                clearable
                v-if="item.name === '结息日'"
              >
                <el-option
                  v-for="item in jxList"
                  :key="item.value"
                  :label="item.label"
                  :value="item.value"
                ></el-option>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-czgg-jsr-search',
        tableKey: 'globalTreasurer-czgg-jsr-list',
        searchMore: false,
        select: [],
        jxTypeList: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          { name: '编码', key: 'sxName' },
          { name: '结息日名称', key: 'jxName' },
          { name: '结息日方式', key: 'jxType' },
          { name: '结息日', key: 'jx' },
