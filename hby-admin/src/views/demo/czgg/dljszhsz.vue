...
<template>
  <div class="system-log-container">
        ...
        <vab-query-form-left-panel style="width: 100%">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              />
              <el-input
                v-model="queryForm.agencyCloseAccount"
                clearable
                placeholder="代理结算账户"
                v-if="item.name === '代理结算账户'"
              />
              <el-input
                v-model="queryForm.agencyCloseAccountMember"
                clearable
                placeholder="代理结算账户成员单位"
                v-if="item.name === '代理结算账户成员单位'"
              />
              <el-date-picker
                ...
                unlink-panels
                range-separator="至"
                start-placeholder="确认开始时间日期"
                end-placeholder="确认结束时间日期"
    ...
    />
    <dljszhszEdit ref="edit" @fetch-data="fetchData"></dljszhszEdit>
  </div>
</template>
...
<script>
  ...
  import dljszhszEdit from './components/dljszhszEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        queryForm: {
          capital: undefined,
          agencyCloseAccount: undefined,
          agencyCloseAccountMember: undefined,
          day: undefined,
          status: undefined,
          pageNumber: 1,
          pageSize: 10,
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-czgg-dljszhsz-search',
        tableKey: 'globalTreasurer-czgg-dljszhsz-list',
        searchMore: false,
        select: [],
        pickerOptions: {
          shortcuts: [
    ...
    methods: {
      ...
      getFiled() {
        return [
          { name: '资金组织', key: 'capital' },
          { name: '代理结算账户', key: 'agencyCloseAccount' },
          { name: '代理结算账户成员单位', key: 'agencyCloseAccount' },
          { name: '时间', key: 'day' },
      ...
      handleEdit(row, disabled, type) {
        this.$refs['edit'].handleOpenDlJszhszDialog(
          row,
          disabled,
          this.planNum,
          type
