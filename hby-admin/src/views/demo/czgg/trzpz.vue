...
<script>
  ...
  import Edit from './components/trzpzEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-czgg-trzpz-search',
        tableKey: 'globalTreasurer-czgg-trzpz-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      ...
      getFiled() {
        return [
          { name: '品种名称', key: 'sxName' },
          { name: '分类', key: 'startStatus' },
          { name: '启用状态', key: 'startStatus1' },
          { name: '品种大类', key: 'startStatus2' },
        ]
      },
