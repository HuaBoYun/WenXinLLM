          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-input
                ...
                clearable
                placeholder="集成业务域"
                v-if="item.name === '集成业务域'"
              />
              <el-input
                v-model="queryForm.startStatus"
                clearable
                placeholder="集成接口类型"
                v-if="item.name === '集成接口类型'"
              />
              <el-input
                v-model="queryForm.startStatus"
                clearable
                placeholder="包含内容参考"
                v-if="item.name === '包含内容参考'"
              />
              <el-input
                v-model="queryForm.startStatus"
                clearable
                placeholder="对接系统数"
                v-if="item.name === '对接系统数'"
              />
              <el-input
                v-model="queryForm.startStatus"
                clearable
...
<script>
  ...
  import Edit from './components/czjcfwEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-czgg-czjcfw-search',
        tableKey: 'globalTreasurer-czgg-czjcfw-list',
        searchMore: false,
        select: [],
      }
    },
