...
<template>
  <div class="system-log-container">
    ...
    />
    <sxlbEditDialog ref="edit" @fetch-data="fetchData"></sxlbEditDialog>
  </div>
</template>
...
<script>
  ...
  import sxlbEditDialog from './components/sxlbEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-czgg-sxlb-search',
        tableKey: 'globalTreasurer-czgg-sxlb-list',
        searchMore: false,
        select: [],
      }
    },
