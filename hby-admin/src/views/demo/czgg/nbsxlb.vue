...
<template>
  <div class="system-log-container">
    ...
    />
    <nbsxlbEditDialog ref="edit" @fetch-data="fetchData"></nbsxlbEditDialog>
  </div>
</template>
...
<script>
  ...
  import nbsxlbEditDialog from './components/nbsxlbEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-czgg-nbsxlb-search',
        tableKey: 'globalTreasurer-czgg-nbsxlb-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
