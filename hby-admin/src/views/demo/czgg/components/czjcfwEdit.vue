<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="编码" prop="organization">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="集成业务域" prop="name">
            <el-input v-model="formData.name" placeholder="请输入集成业务域" />
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="集成接口类型" prop="code">
            <el-input
              v-model="formData.code"
              placeholder="请输入集成接口类型"
              :style="{ width: '100%' }"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="包含内容参考" prop="province">
            <el-input v-model="formData.province" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="对接系统数" prop="city">
            <el-input v-model="formData.city" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="是否调用" prop="phone">
        ...
        <el-col :span="12">
          <el-form-item label="最后修改人" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="最后修改时间" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
      </el-form>
