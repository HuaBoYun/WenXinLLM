        ...
        <vab-query-form-left-panel style="width: 100%">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              <el-input
                v-model="queryForm.financialOrganization"
                clearable
                placeholder="财务组织"
                v-if="item.name === '财务组织'"
              />
  ...
  export default {
    ...
    data() {
      return {
        ...
        total: 0,
        queryForm: {
          financialOrganization: undefined,
          pageNumber: 1,
          pageSize: 10,
          xmnd: '',
        },
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-czgg-djjhxmdz-search',
        tableKey: 'globalTreasurer-czgg-djjhxmdz-list',
        searchMore: false,
        select: [],
        pickerOptions: {
          shortcuts: [
    ...
    methods: {
      ...
      getFiled() {
        return [{ name: '财务组织', key: 'financialOrganization' }]
      },
