...
<script>
  ...
  import Edit from './components/djxtszEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-djxtsz-search',
        tableKey: 'globalTreasurer-jsgl-djxtsz-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          { name: '编码', key: 'sxName' },
          { name: '集成业务域', key: 'startStatus' },
          { name: '集成接口类型', key: 'startStatus1' },
          { name: '包含内容参考', key: 'startStatus2' },
          { name: '对接系统数', key: 'startStatus3' },
          { name: '是否调用', key: 'startStatus4' },
        ]
      },
