          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-input
                ...
                clearable
                placeholder="委托收款回单号"
                v-if="item.name === '委托收款回单号'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="收款资金组织"
                v-if="item.name === '收款资金组织'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-wtskhd-search',
        tableKey: 'globalTreasurer-jsgl-wtskhd-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '时间', key: 'day' },
          { name: '委托收款回单号', key: 'receiptsNo' },
          { name: '收款资金组织', key: 'supplier' },
