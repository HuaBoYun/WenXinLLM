  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="待领用" name="first"></el-tab-pane>
        <el-tab-pane label="待报销" name="second"></el-tab-pane>
        <el-tab-pane label="已报销" name="third"></el-tab-pane>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-gl-search',
        tableKey: 'globalTreasurer-jsgl-gl-list',
        searchMore: false,
        select: [],
        activeName: 'second',
      }
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '票据类型', key: 'startStatus1' },
          { name: '领用时间范围', key: 'startStatus2' },
          { name: '票据状态', key: 'startStatus12' },
        ]
      },
