          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-input
                ...
                clearable
                placeholder="原币金额开始"
                v-if="item.name === '原币金额开始'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="原币金额结束"
                v-if="item.name === '原币金额结束'"
              />
...
<script>
  ...
  import Edit from './components/xjzqEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-xjzq-search',
        tableKey: 'globalTreasurer-jsgl-xjzq-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '原币金额开始', key: 'supplier' },
          { name: '原币金额结束', key: 'supplier' },
