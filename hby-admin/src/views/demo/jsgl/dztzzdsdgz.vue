  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <!-- <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="自动匹配待确认" name="first"></el-tab-pane>
        <el-tab-pane label="手工匹配待确认" name="second"></el-tab-pane>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-dztzzdsdgz-search',
        tableKey: 'globalTreasurer-jsgl-dztzzdsdgz-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '本方账户', key: 'supplier' },
          { name: '对方单位名称', key: 'supplier' },
          { name: '对方账号', key: 'receiptsNo' },
          { name: '状态', key: 'receiptsNo' },
        ]
      },
