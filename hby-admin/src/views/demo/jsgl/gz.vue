...
<script>
  ...
  import Edit from './components/gzEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-gz-search',
        tableKey: 'globalTreasurer-jsgl-gz-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '购置日期范围', key: 'startStatus1' },
          { name: '购置人', key: 'startStatus2' },
          { name: '银行账户', key: 'startStatus3' },
        ]
      },
