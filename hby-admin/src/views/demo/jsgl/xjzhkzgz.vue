          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-input
                ...
                clearable
                placeholder="最低余额范围"
                v-if="item.name === '最低余额范围'"
              />
              <el-select
                v-model="queryForm.contracttype"
                filterable
                placeholder="最低余额控制方案"
...
<script>
  ...
  import Edit from './components/xjzhkzgzszEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-xjzhkzgz-search',
        tableKey: 'globalTreasurer-jsgl-xjzhkzgz-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '最低余额控制', key: 'startStatus' },
          { name: '最低余额范围', key: 'startStatus1' },
          { name: '最低余额控制方案', key: 'startStatus2' },
        ]
      },
