  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zdxzrzcx-search',
        tableKey: 'globalTreasurer-jsgl-zdxzrzcx-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '所属集团', key: 'supplier' },
          { name: '日期', key: 'day' },
          { name: '交易类型', key: 'supplier' },
          { name: '下载状态', key: 'supplier' },
        ]
      },
