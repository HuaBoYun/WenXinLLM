...
<script>
  ...
  import Edit from './components/zftdszEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zftdsz-search',
        tableKey: 'globalTreasurer-jsgl-zftdsz-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
