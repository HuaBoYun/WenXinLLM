        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              />
              <el-input
                v-model="queryForm.brankAccount"
                clearable
                placeholder="银行账户"
                v-if="item.name === '银行账户'"
              />
              <el-input
                v-model="queryForm.brankType"
                clearable
                placeholder="银行类别"
                v-if="item.name === '银行类别'"
              />
              ...
              <el-input
                v-model="queryForm.currentAccount"
                clearable
                placeholder="现金账户"
                v-if="item.name === '现金账户'"
              />
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zhyeb-search',
        tableKey: 'globalTreasurer-jsgl-zhyeb-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      initTable() {
        ...
        this.$nextTick(function () {
          ...
          if (data) {
            ...
            console.log('this.filedAll===', this.filedAll)
      ...
      getFiled() {
        return [
          ...
          { name: '银行账户', key: 'brankAccount' },
          { name: '银行类别', key: 'brankType' },
          { name: '账户类型', key: 'accountType' },
          { name: '资金形态', key: 'capitalForm' },
