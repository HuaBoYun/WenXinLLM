  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        ...
        <el-table-column label="库存现金" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="qdcode"
        ...
        <el-table-column label="银行存款" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="qdcode"
        ...
        <el-table-column label="应收票据" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="qdcode"
  ...
  export default {
    ...
    data() {
      return {
        ...
        currProjectId: '',
        filedAll: [{ name: '财务组织' }, { name: '币种' }], //所有表格项
        filedNow: [], //当前表格项
        searchAll: this.getFiled(), //所有搜索项
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zjyehz-search',
        tableKey: 'globalTreasurer-jsgl-zjyehz-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
