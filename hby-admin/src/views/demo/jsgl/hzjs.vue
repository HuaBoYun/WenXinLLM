...
<script>
  ...
  import Edit from './components/hzjsEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-hzjs-search',
        tableKey: 'globalTreasurer-jsgl-hzjs-list',
        searchMore: false,
        select: [],
        activeName: 'second',
      }
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '划出账户', key: 'startStatus2' },
          { name: '划入账户', key: 'startStatus12' },
        ]
      },
