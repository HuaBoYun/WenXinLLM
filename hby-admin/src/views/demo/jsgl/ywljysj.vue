  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="success">一键更新</el-button>
...
<script>
  ...
  import Edit from './components/ywljysjEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-ywljysj-search',
        tableKey: 'globalTreasurer-jsgl-ywljysj-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          // { name: '金额结束', key: 'receiptsNo' },
          // { name: '确认结果', key: 'receiptsNo' },
        ]
      },
