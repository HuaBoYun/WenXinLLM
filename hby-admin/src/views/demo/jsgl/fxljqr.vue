  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="确认拦截" name="second"></el-tab-pane>
        <el-tab-pane label="确认放行" name="third"></el-tab-pane>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-fxljqr-search',
        tableKey: 'globalTreasurer-jsgl-fxljqr-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
