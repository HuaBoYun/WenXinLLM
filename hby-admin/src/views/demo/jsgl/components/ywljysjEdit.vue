  ...
  >
    <el-row :gutter="14">
      ...
      >
        <div>一、查询更细说明</div>
        <div>
          列表界面为系统自动查询出的需要升级的业务流，查询内容为包含收款单、付款单、资金付款单（原付款结算单）、资金收款单（收款结算单）、报销单、借款单、还款单的业务流
        </div>
        <div>二、更新说明：</div>
        <div>
          未更新过以及更新结果为失败的业务流，可进行自动更新。
          对业务流进行升级时，系统将自动在原业务流中插入结算的单据，核心单据与结算单的驱动动作为传结算；如需委托给资金结算中心，结算单与资金结算的单据驱动动作仍然为委托办理。
          示例：如原业务流为开始-付款单-委托付款-结束，则升级后业务流为：开始-付款单-委托中心付款-委托付款-结束
          更新结果为不更新的业务流，可通过修改，进行手工更新，一旦进行修改，业务流即标记为手工调整，本工具不再提供更新或修改功能，可在动态建模平台-业务流定义中继续维护业务流
          更新后请预览查看升级结果，确认升级正确。
        </div>
      </el-form>
    </el-row>
