      ...
      >
        ...
        <el-col :span="24">
          <div class="dialog-add">
            <div>
              <span>票据池数据下载设置-组织明细 ({{ tableData.length }})</span>
          ...
          >
            ...
            <el-table-column label="下载质押及解除质押" width="180">
              <template slot-scope="scope">
                <el-input
                  v-model="scope.row.createDate"
                  autocomplete="off"
            ...
            <el-table-column label="下载票据池额度" width="160">
              <template slot-scope="scope">
                <el-input
                  v-model="scope.row.createDate"
                  autocomplete="off"
