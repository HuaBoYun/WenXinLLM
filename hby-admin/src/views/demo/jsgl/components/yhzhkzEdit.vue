<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="发送方财务组织" prop="organization">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="接收方财务组织" prop="name">
            <el-input v-model="formData.name" placeholder="接收方财务组织" />
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="协同消息接收人" prop="code">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="发送方单据类型" prop="province">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="接收方单据类型" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="接收方单据类型"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="业务名称" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="业务名称"
              :style="{ width: '100%' }"
