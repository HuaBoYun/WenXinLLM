      ...
      >
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow1">
            <el-col :span="12">
              <el-form-item label="票据类型" prop="creator">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="票据号" prop="createDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="币种" prop="updateCreator">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="银行账户" prop="updateDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="领用部门" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="领用人" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="领用日期" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="领用限额" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="领用用途" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="领用备注" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="领用张数" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            ...
            <el-col :span="12">
              <el-form-item label="修改人" prop="updateCreator">
                <el-input
                  v-model="formData.updateCreator"
                  :style="{ width: '100%' }"
                />
