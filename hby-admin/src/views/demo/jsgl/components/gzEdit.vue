      ...
      >
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow1">
            ...
            <el-col :span="12">
              <el-form-item label="票据编号" prop="createDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="购置日期" prop="updateCreator">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="购置部门" prop="updateDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="购置人" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="币种" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="银行名称" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="工本费" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="手续费" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="购置张数" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
