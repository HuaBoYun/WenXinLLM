  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="审批状态" prop="address">
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow1">
            <el-col :span="12">
              <el-form-item label="摘要" prop="creator">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="币种" prop="createDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="划出银行" prop="updateCreator">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="划出账户" prop="updateDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="划入银行" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="划入账户" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="金额" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="本币汇率" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="结算方式" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow2">
            <el-col :span="12">
              <el-form-item label="是否被退回" prop="creator">
                <el-checkbox v-model="formData.checked"></el-checkbox>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="退回原因" prop="createDate">
                <el-input
                  v-model="formData.createDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="来源系统" prop="updateCreator">
                <el-input
                  v-model="formData.updateCreator"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="来源单据类型" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="来源单据号" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            ...
            <el-col :span="12">
              <el-form-item label="提交人" prop="updateCreator">
                <el-input
                  v-model="formData.updateCreator"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="提交日期" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
            ...
            <el-col :span="12">
              <el-form-item label="审批人" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
