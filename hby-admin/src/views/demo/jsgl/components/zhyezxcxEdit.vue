  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12" v-if="this.title === '在线下载'">
        ...
        <el-col :span="12">
          <el-form-item label="银行账号" prop="brankAccount">
            <el-input v-model="formData.brankAccount" placeholder="银行账号" />
          </el-form-item>
        </el-col>
        ...
        <el-col :span="12" v-if="this.title === '调整余额'">
        ...
        <el-col :span="12" v-if="this.title === '调整余额'">
          <el-form-item label="期末余额" prop="endingBalance">
            <el-input v-model="formData.endingBalance" placeholder="期末余额" />
          </el-form-item>
        </el-col>
        <el-col :span="12" v-if="this.title === '调整余额'">
          <el-form-item label="调整日期之前" prop="beforeAdjustment">
            <el-checkbox v-model="formData.beforeAdjustment" />
          </el-form-item>
        </el-col>
      </el-form>
    </el-row>
  ...
  export default {
    ...
    methods: {
      async showEdit(type) {
        ...
        this.title = type === 'on_line' ? '在线下载' : '调整余额'
