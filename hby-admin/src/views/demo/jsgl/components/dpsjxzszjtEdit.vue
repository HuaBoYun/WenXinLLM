<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="集团" prop="serviceCode">
            <el-input v-model="formData.serviceCode" placeholder="集团" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="组织版本" prop="ipAdress">
            <el-input v-model="formData.ipAdress" placeholder="组织版本" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="方案" prop="port">
            <el-input v-model="formData.prot" placeholder="方案" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="默认方案" prop="servletService">
            <el-checkbox v-model="formData.servletService"></el-checkbox>
          </el-form-item>
        </el-col>
        ...
        <el-col :span="24">
          <div class="dialog-add">
            <div>
              <span>电票数据下载设置-集团 ({{ tableData.length }})</span>
          ...
          >
            ...
            <el-table-column label="下载质押/解除质押" width="180">
              <template slot-scope="scope">
                <el-input
                  v-model="scope.row.createDate"
                  autocomplete="off"
            ...
            <el-table-column label="下载票据状态信息" width="160">
              <template slot-scope="scope">
                <el-input
                  v-model="scope.row.createDate"
                  autocomplete="off"
            ...
            <el-table-column label="下载不得转让标记撤销" width="180">
              <template slot-scope="scope">
                <el-input
                  v-model="scope.row.createDate"
                  autocomplete="off"
