  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="单据状态" prop="receiptsStatus">
            <el-select
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow1">
            ...
            <el-col :span="12">
              <el-form-item label="现金账户" prop="currentAccount">
            ...
            <el-col :span="12">
              <el-form-item label="组织本币汇率" prop="exchangeRate">
                <el-input v-model="formData.exchangeRate" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="组织本币金额" prop="money">
                <el-input v-model="formData.money" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="结算方式" prop="accountsType">
                <el-input v-model="formData.accountsType" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
