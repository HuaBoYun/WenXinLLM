<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="付款组织" prop="organization">
            <el-input v-model="formData.organization" placeholder="付款组织" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="申请付款日期" prop="name">
            <el-input v-model="formData.name" placeholder="申请付款日期" />
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="付款申请编号" prop="code">
        ...
        <el-col :span="12">
          <el-form-item label="业务流程" prop="city">
            <el-input v-model="formData.city" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="单据状态" prop="phone">
            <el-input v-model="formData.phone" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="付款财务组织" prop="address">
        ...
        <el-col :span="12">
          <el-form-item label="申请付款金额合计" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="申请付款金额合计(组织本币)" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="付款金额合计" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="未付金额合计" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="已报计划金额合计" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="未报计划金额合计" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="实付金额合计" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="付款方式" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="由上级下拨" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="付款账户" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="回拨收款账户" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="收款单位" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="收款银行名称" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="经办部门" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="详细说明" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="紧急" prop="status">
            <el-input v-model="formData.status" :style="{ width: '100%' }" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            ...
            <el-col :span="12">
              <el-form-item label="审批人" prop="updateCreator">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="审批日期" prop="updateDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="最后修改人" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  :style="{ width: '100%' }"
                />
