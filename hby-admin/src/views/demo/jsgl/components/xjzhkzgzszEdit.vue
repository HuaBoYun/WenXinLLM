  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="现金账户" prop="name">
            <el-input v-model="formData.name" placeholder="现金账户" />
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="现金账户编码" prop="code">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="现金账户名称" prop="province">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="所属组织" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="所属组织"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="最低余额控制" prop="province">
            <el-checkbox v-model="formData.checked" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="最低余额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="最低余额"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="最低余额控制方案" prop="province">
            <el-input
              v-model="formData.province"
        ...
        <el-col :span="12">
          <el-form-item label="最高余额控制" prop="province">
            <el-checkbox v-model="formData.checked1" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="最高余额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="最高余额"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="最高余额控制方案" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="最高余额控制方案"
              :style="{ width: '100%' }"
            />
          </el-form-item>
        </el-col>
