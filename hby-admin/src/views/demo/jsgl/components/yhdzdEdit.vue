  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="对账账户" prop="receiptsCode">
        ...
        <el-col :span="12">
          <el-form-item label="账户币种" prop="settlementStatus">
            <el-select
        ...
        <el-col :span="12">
          <el-form-item label="启用日期" prop="receiptsDate">
            <el-date-picker
        ...
        <el-col :span="12">
          <el-form-item label="停用日期" prop="receiptsDate">
            <el-date-picker
              v-model="formData.receiptsDate"
              type="date"
              placeholder="选择日期"
