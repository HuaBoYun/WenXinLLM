      ...
      >
        <el-col :span="12">
          <el-form-item label="组织" prop="organization">
            <el-input v-model="formData.organization" placeholder="组织" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="银行类别" prop="name">
            <el-input v-model="formData.name" placeholder="银行类别" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="票据类型" prop="city">
            <el-select
        ...
        <el-col :span="12">
          <el-form-item label="开始日期" prop="province">
            <el-date-picker
        ...
        <el-col :span="12">
          <el-form-item label="结束日期" prop="province">
            <el-date-picker
              v-model="formData.receiptsDate"
              type="date"
              placeholder="选择日期"
        ...
        <el-col :span="12">
          <el-form-item label="查询人类型" prop="phone">
            <el-select
              v-model="formData.value"
              placeholder="请选择"
              :style="{ width: '100%' }"
