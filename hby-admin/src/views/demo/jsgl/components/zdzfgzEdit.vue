  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="规则状态" prop="organization">
            <el-input v-model="formData.organization" placeholder="规则状态" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="业务系统" prop="organization">
            <el-input v-model="formData.organization" placeholder="业务系统" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="业务单据" prop="organization">
            <el-input v-model="formData.organization" placeholder="业务单据" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="结算或支付经审批" prop="name">
            <el-checkbox v-model="formData.membershipGroup"></el-checkbox>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="提交与审批人非同一人" prop="name">
            <el-checkbox v-model="formData.membershipGroup"></el-checkbox>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="非风险拦截且非灰名单" prop="name">
            <el-checkbox v-model="formData.membershipGroup"></el-checkbox>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="收款方为白名单" prop="code">
            <el-checkbox v-model="formData.membershipGroup"></el-checkbox>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="自动支付方式" prop="organization">
            <el-select
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            ...
            <el-col :span="12">
              <el-form-item label="复核人" prop="updateDate">
                <el-input v-model="formData.updateDate" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="复核日期" prop="updateDate">
                <el-date-picker
                  v-model="formData.receiptsDate"
                  type="date"
                  placeholder="选择日期"
