  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="限额类型" prop="name">
            <el-input v-model="formData.name" placeholder="限额类型" />
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="银行账号" prop="code">
            <el-input v-model="formData.code" placeholder="银行账号" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="币种" prop="code">
            <el-input v-model="formData.code" placeholder="币种" />
          </el-form-item>
        </el-col>
        <!-- <el-col :span="12">
