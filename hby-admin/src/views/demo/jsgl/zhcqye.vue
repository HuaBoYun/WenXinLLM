        ...
        <el-card shadow="never">
          ...
          >
            ...
            <div v-for="(item, index) in filedNow" :key="index">
              ...
              />
              <el-table-column
                v-if="item.name === '期初原币金额'"
                align="center"
                prop="date3"
                label="期初原币金额"
              />
              <el-table-column
                v-if="item.name === '期初本币金额'"
                prop="date7"
                label="期初本币金额"
                align="center"
              />
...
<script>
  ...
  import Edit from './components/zhcqyeEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zhcqye-search',
        tableKey: 'globalTreasurer-jsgl-zhcqye-list',
        searchMore: true,
      }
    },
    created() {
