  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-tzfkhd-search',
        tableKey: 'globalTreasurer-jsgl-tzfkhd-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
