        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              <el-input
                v-model="queryForm.accountantPeriod"
                clearable
                placeholder="会计期间方案"
    ...
    <el-card shadow="never" class="secondCard">
      <div class="top_box">
        <vab-query-form-right-panel style="width: 100%">
          ...
          <el-button type="success">批量关帐</el-button>
          <el-button type="success">批量反关帐</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zjjzgz-search',
        tableKey: 'globalTreasurer-jsgl-zjjzgz-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          { name: '会计期间方案', key: 'accountantPeriod' },
          { name: '会计期间', key: 'period' },
          { name: '组织', key: 'organization' },
        ]
      },
