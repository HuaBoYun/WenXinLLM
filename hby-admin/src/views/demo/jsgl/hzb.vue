  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        ...
        <el-table-column label="本期流入" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="qdcode"
        ...
        <el-table-column label="净发生额" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="qdcode"
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-hzb-search',
        tableKey: 'globalTreasurer-jsgl-hzb-list',
        searchMore: false,
        select: [],
        sortType: [
          {
