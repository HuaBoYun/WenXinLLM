...
<script>
  ...
  import Edit from './components/shhEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-shh-search',
        tableKey: 'globalTreasurer-jsgl-shh-list',
        searchMore: false,
        select: [],
        optionsStatusList: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '商务号', key: 'receiptsNo' },
          { name: '启用状态', key: 'supplier' },
        ]
      },
