        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-input
                v-model="queryForm.accountTitle"
                clearable
                placeholder="账户名称"
                v-if="item.name === '账户名称'"
              />
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zhhdsyd-search',
        tableKey: 'globalTreasurer-jsgl-zhhdsyd-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          { name: '所属组织', key: 'organization' },
          { name: '时间', key: 'day' },
          { name: '币种', key: 'currency' },
          { name: '账户名称', key: 'accountTitle' },
          { name: '银行账户', key: 'bankAccount' },
        ]
      },
