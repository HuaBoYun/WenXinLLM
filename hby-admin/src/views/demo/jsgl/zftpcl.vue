...
<script>
  ...
  import Edit from './components/zftpclAutoEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zftpcl-search',
        tableKey: 'globalTreasurer-jsgl-zftpcl-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
