        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              />
              <el-select
                v-model="queryForm.settleAccounts"
                placeholder="账户类型"
                clearable
                v-if="item.name === '账户类型'"
              >
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zhyecx-search',
        tableKey: 'globalTreasurer-jsgl-zhyecx-list',
        searchMore: false,
        select: [],
        capitalType: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '资金形态', key: 'organization' },
          { name: '银行类别', key: 'organization' },
          { name: '银行账户', key: 'organization' },
          { name: '币种', key: 'organization' },
          { name: '账户类型', key: 'organization' },
        ]
      },
