        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              ></el-date-picker>
              <el-date-picker
                v-model="queryForm.day2"
                type="daterange"
                align="right"
                unlink-panels
                range-separator="至"
                start-placeholder="转账日期开始日期"
                end-placeholder="转账日期结束日期"
                v-if="item.name === '转账时间'"
              ></el-date-picker>
              <el-input
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-xjzqhd-search',
        tableKey: 'globalTreasurer-jsgl-xjzqhd-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
