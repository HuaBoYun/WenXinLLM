  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="支付中" name="first"></el-tab-pane>
        <el-tab-pane label="支付失败" name="second"></el-tab-pane>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zfjk-search',
        tableKey: 'globalTreasurer-jsgl-zfjk-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '时间', key: 'day' },
          { name: '支付状态', key: 'supplier' },
          { name: '付款金额开始', key: 'receiptsNo' },
          { name: '付款金额结束', key: 'receiptsNo' },
        ]
      },
