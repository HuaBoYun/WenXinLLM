          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-date-picker
                ...
                unlink-panels
                range-separator="至"
                start-placeholder="指令提交日期开始"
                end-placeholder="指令提交日期结束"
                v-if="item.name === '提交指令日期'"
              ></el-date-picker>
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="票据金额开始"
                v-if="item.name === '票据金额开始'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="票据金额结束"
                v-if="item.name === '票据金额结束'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-pjczlzt-search',
        tableKey: 'globalTreasurer-jsgl-pjczlzt-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '提交指令日期', key: 'day' },
          { name: '票据金额开始', key: 'receiptsNo' },
          { name: '票据金额结束', key: 'supplier' },
          { name: '票据金额结束', key: 'supplier' },
          { name: '票据号', key: 'supplier' },
          { name: '银行档案', key: 'supplier' },
          { name: '指令状态', key: 'supplier' },
          { name: '额度调整类型', key: 'supplier' },
        ]
      },
