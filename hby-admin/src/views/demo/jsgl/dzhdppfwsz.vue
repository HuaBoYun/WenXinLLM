    ...
    <div class="container_r">
      ...
      <el-card shadow="never" class="secondCard">
        <!-- <el-tabs v-model="activeName" @tab-click="handleClick">
          <el-tab-pane label="未匹配" name="first"></el-tab-pane>
          <el-tab-pane label="待确认" name="second"></el-tab-pane>
          <el-tab-pane label="匹配异常" name="all"></el-tab-pane>
...
<script>
  ...
  import Edit from './components/dzhdppfwszEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-dzhdppfwsz-search',
        tableKey: 'globalTreasurer-jsgl-dzhdppfwsz-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          // { name: '时间', key: 'day' },
          // { name: '回单编号', key: 'supplier' },
          // { name: '本方账户', key: 'supplier' },
          // { name: '业务单据编号', key: 'receiptsNo' },
        ]
      },
