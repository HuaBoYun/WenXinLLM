  ...
  <div class="system-log-container">
        ...
        <div class="header_l_top">
          <div class="l_top_1">
            <div class="top_box">
              ...
              <div>
                <span class="title_1">内部账户余额</span>
                <div>
        ...
        <div class="">
          <div class="">
            <div class="title_r_box">
              ...
              <span class="title_r_box_2">结算进度</span>
            </div>
            <div
              ref="gauge1"
              id="main"
    ...
    <el-card shadow="never" class="secondCard">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        ...
        <el-tab-pane label="结算完成" name="third3"></el-tab-pane>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-wtzxfk-search',
        tableKey: 'globalTreasurer-jsgl-wtzxfk-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    mounted() {
      ...
      this.chart.setOption({
        ...
        legend: {
          ...
          right: '2%', // 设置图例到容器右侧的距离，以百分比表示
          top: 'middle', // 设置图例垂直居中显示
          data: ['内部账户余额', '直联账户余额', '资金缺口'], // 图例的数据项
        },
        series: [
          {
            left: '-90px',
            ...
            data: [
              { value: 335, name: '内部账户余额' },
              { value: 310, name: '直联账户余额' },
              { value: 135, name: '资金缺口' },
            ],
          },
        ],
