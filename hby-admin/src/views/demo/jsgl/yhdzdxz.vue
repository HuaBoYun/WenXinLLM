  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="success" @click="handleEdit('on_line')">
          在线下载
        </el-button>
...
<script>
  ...
  import Edit from './components/yhdzdxzEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zhyezxcx-search',
        tableKey: 'globalTreasurer-jsgl-zhyezxcx-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '日期', key: 'day' },
          { name: '本方账号', key: 'receiptsNo' },
          { name: '银行类别', key: 'supplier' },
          { name: '对方账号', key: 'supplier' },
          { name: '币种', key: 'supplier' },
          { name: '金额下限', key: 'supplier' },
          { name: '金额上限', key: 'supplier' },
          { name: '交易流水号', key: 'supplier' },
        ]
      },
