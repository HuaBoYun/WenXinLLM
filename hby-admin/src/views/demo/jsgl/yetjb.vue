  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-yetjb-search',
        tableKey: 'globalTreasurer-jsgl-yetjb-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '截止日期', key: 'supplier' },
          { name: '时间', key: 'day' },
          { name: '确认人', key: 'receiptsNo' },
        ]
      },
