          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-input
                ...
                clearable
                placeholder="应付金额开始"
                v-if="item.name === '应付金额开始'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="应付金额结束"
                v-if="item.name === '应付金额结束'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
              ...
              <el-input
                ...
                clearable
                placeholder="收方账户名称"
                v-if="item.name === '收方账户名称'"
              />
              <el-select
                v-model="queryForm.supplier"
                placeholder="交易支付状态"
                clearable
                v-if="item.name === '交易支付状态'"
              >
                <el-option
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zfzlzt-search',
        tableKey: 'globalTreasurer-jsgl-zfzlzt-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '日期', key: 'day' },
          { name: '支付参考号', key: 'supplier' },
          { name: '银行类别', key: 'supplier' },
          { name: '应付金额开始', key: 'supplier' },
          { name: '应付金额结束', key: 'supplier' },
          { name: '付方账号', key: 'supplier' },
          { name: '付方账户名称', key: 'supplier' },
          { name: '收方账号', key: 'supplier' },
          { name: '收方账户名称', key: 'supplier' },
          { name: '交易支付状态', key: 'supplier' },
        ]
      },
