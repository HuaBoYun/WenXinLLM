...
<script>
  ...
  import Edit from './components/sjxzszjtEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-sjxzszjt-search',
        tableKey: 'globalTreasurer-jsgl-sjxzszjt-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          { name: '组织', key: 'jsFinance' },
          { name: '方案', key: 'supplier' },
        ]
      },
