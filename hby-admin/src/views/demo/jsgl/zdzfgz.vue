  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="待复核" name="first"></el-tab-pane>
        <el-tab-pane label="未启用" name="second"></el-tab-pane>
        <el-tab-pane label="启用" name="third"></el-tab-pane>
            ...
            <el-dropdown style="margin-left: 10px">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  ...
                  <el-button type="text">复核</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zdzfgz-search',
        tableKey: 'globalTreasurer-jsgl-zdzfgz-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
