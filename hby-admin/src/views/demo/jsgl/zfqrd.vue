  ...
  <div class="system-log-container">
        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-select
                v-model="queryForm.supplier"
                placeholder="银行确认支付状态"
                clearable
                v-if="item.name === '银行确认支付状态'"
              >
                <el-option
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <!-- <el-button type="success" @click="handleEdit()">在线明细查询</el-button> -->
        <!-- <el-button type="success" @click="handleEdit('exports')">
          导入
        </el-button> -->
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zfqrd-search',
        tableKey: 'globalTreasurer-jsgl-zfqrd-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '日期', key: 'day' },
          { name: '付款银行账号', key: 'supplier' },
          { name: '单据编号', key: 'supplier' },
          { name: '来源单据类型', key: 'supplier' },
          { name: '来源单据编号', key: 'supplier' },
          { name: '银行确认支付状态', key: 'supplier' },
          { name: '收款银行账户', key: 'supplier' },
          { name: '金额', key: 'supplier' },
        ]
      },
