...
<script>
  ...
  import Edit from './components/jshbgzjtEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-jshbgzjt-search',
        tableKey: 'globalTreasurer-jsgl-jshbgzjt-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          { name: '规则名称', key: 'jsFinance' },
          { name: '单据类型', key: 'jsFinance' },
          { name: '交易类型', key: 'jsFinance' },
          { name: '来源单据类型', key: 'jsFinance' },
        ]
      },
