...
<script>
  ...
  import Edit from './components/gzqdEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-gzqd-search',
        tableKey: 'globalTreasurer-jsgl-gzqd-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
