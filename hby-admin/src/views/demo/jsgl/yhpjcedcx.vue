          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-date-picker
                ...
                unlink-panels
                range-separator="至"
                start-placeholder="查询日期开始"
                end-placeholder="查询日期结束"
                v-if="item.name === '查询日期'"
              ></el-date-picker>
              <el-input
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-yhpjcedcx-search',
        tableKey: 'globalTreasurer-jsgl-yhpjcedcx-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          { name: '资金组织', key: 'jsFinance' },
          { name: '查询日期', key: 'day' },
          { name: '金额下限', key: 'receiptsNo' },
