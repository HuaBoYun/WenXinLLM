          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-input
                ...
                clearable
                placeholder="买入内部账户"
                v-if="item.name === '买入内部账户'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="买入金额开始"
                v-if="item.name === '买入金额开始'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="买入金额结束"
                v-if="item.name === '买入金额结束'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="卖出金额开始"
                v-if="item.name === '卖出金额开始'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
                placeholder="卖出金额结束"
                v-if="item.name === '卖出金额结束'"
              />
              <el-input
                v-model="queryForm.supplier"
                clearable
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-wbdhhd-search',
        tableKey: 'globalTreasurer-jsgl-wbdhhd-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '买入内部账户', key: 'receiptsNo' },
          { name: '买入金额开始', key: 'supplier' },
          { name: '买入金额结束', key: 'supplier' },
          { name: '卖出金额开始', key: 'supplier' },
          { name: '卖出金额结束', key: 'supplier' },
          { name: '资金组织', key: 'supplier' },
        ]
      },
