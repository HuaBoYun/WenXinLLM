  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-yhckrjz-search',
        tableKey: 'globalTreasurer-jsgl-yhckrjz-list',
        searchMore: false,
        select: [],
        sortType: [
          {
