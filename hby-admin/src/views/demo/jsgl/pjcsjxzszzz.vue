...
<script>
  ...
  import Edit from './components/pjcsjxzszzzEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-pjcsjxzszzz-search',
        tableKey: 'globalTreasurer-jsgl-pjcsjxzszzz-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
    ...
    methods: {
      ...
      getFiled() {
        return [
          ...
          { name: '方案', key: 'receiptsNo' },
          { name: '默认方案', key: 'supplier' },
        ]
      },
