...
<script>
  ...
  import Edit from './components/zhzfxeszEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-zhzfxesz-search',
        tableKey: 'globalTreasurer-jsgl-zhzfxesz-list',
        searchMore: false,
        select: [],
        optionsStatus: [
          {
