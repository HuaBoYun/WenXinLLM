<template>
  <el-dialog v-if="dialogFormVisible" :close-on-click-modal="false" :append-to-body="true" :title="title"
    :visible.sync="dialogFormVisible" width="1000px" @close="close">
    <el-row :gutter="14">
      <el-form ref="ruleForm" label-width="100px" :model="formData" :rules="rules" size="mini">
        <el-col :span="12">
          <el-form-item label="风险编号" prop="risknumber">
            <el-input v-model="formData.risknumber" clearable placeholder="请输入风险编号" :style="{ width: '100%' }" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="风险名称" prop="riskname">
            <el-input v-model="formData.riskname" clearable placeholder="请输入风险名称" :style="{ width: '100%' }"
              :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="发现日期" prop="discovereddate">
            <el-date-picker :style="{ width: '100%' }" v-model="formData.discovereddate" placeholder="请输入发现日期" type="date"
              format="yyyy-MM-dd" value-format="yyyy-MM-dd" :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="发生日期" prop="occureddate">
            <el-date-picker :style="{ width: '100%' }" v-model="formData.occureddate" placeholder="请输入发生日期" type="date"
              format="yyyy-MM-dd" value-format="yyyy-MM-dd" :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="责任部门" prop="orgname">
            <el-input v-model="formData.orgname" clearable placeholder="请输入责任部门" :style="{ width: '305px' }"
              :disabled="true" />
        ...
        <el-col :span="12">
          <el-form-item label="发现人" prop="realname">
            <el-input v-model="formData.realname" clearable placeholder="请输入发现人" :style="{ width: '305px' }"
              :disabled="true" />
        ...
        <el-col :span="24">
          <el-form-item label="相关部门" prop="sysOrgName">
            <el-input v-model="formData.sysOrgName" clearable placeholder="请输入相关部门" :style="{ width: '92%' }"
              :disabled="true" />
            <el-button :style="{ marginLeft: '10px' }" type="primary" @click="$refs.department.show(true)"
              :disabled="!footer">
              选择
            </el-button>
          </el-form-item>
        ...
        <el-col :span="24">
          <el-form-item label="风险描述" prop="riskdes">
            <el-input v-model="formData.riskdes" clearable type="textarea" :rows="2" maxlength="300" show-word-limit
              placeholder="请输入风险描述" :style="{ width: '100%' }" :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="24">
          ...
          <el-table :data="rrdTableList">
            <el-table-column align="center" width="120" label="序号" prop="rtcode">
              <template slot-scope="scope">
                <el-input :disabled="!footer" v-model="scope.row.rtcode" placeholder="序号"></el-input>
              </template>
            </el-table-column>
            <el-table-column align="center" label="基准线下边界" prop="lowerborder" width="160">
              <template slot-scope="scope">
                <el-input-number :disabled="!footer" v-model="scope.row.lowerborder" label="基准线下边界"></el-input-number>
              </template>
            </el-table-column>
            <el-table-column align="center" label="基准线上边界" prop="upperborder" width="160">
              <template slot-scope="scope">
                <el-input-number v-model="scope.row.upperborder" label="基准线下边界" :disabled="!footer"></el-input-number>
              </template>
            </el-table-column>
            <el-table-column align="center" label="颜色块编码" prop="colorstring" width="200">
              <template slot-scope="scope">
                <div style="display: flex; align-items: center">
                  <div :style="scope.row.colorstring === '绿'
                    ...
                    "></div>
                  <el-select v-model="scope.row.colorstring" placeholder="请选择" :disabled="!footer"
            ...
            <el-table-column align="center" label="描述" show-overflow-tooltip>
              <template slot-scope="scope">
                <el-input :disabled="!footer" v-model="scope.row.description" placeholder="描述"></el-input>
              </template>
            </el-table-column>
            <el-table-column align="center" label="操作" show-overflow-tooltip width="100">
              <template slot-scope="scope">
                <el-button type="text" @click="handleAddRrd(scope.row)" v-if="footer">
                  保存
                </el-button>
                <el-button type="text" @click="handleRrd(scope.row, scope.$index)" v-if="footer">
                  删除
                </el-button>
              </template>
            </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleExecutorSelected(node) {
      ...
      this.formData.createorid = node.staffid
      this.$forceUpdate()
    },
