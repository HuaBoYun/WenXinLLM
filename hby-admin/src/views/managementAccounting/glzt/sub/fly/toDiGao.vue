<template>
  <div>
    <el-dialog v-if="dialogFormVisible" :append-to-body="true" :title="title" :visible.sync="dialogFormVisible"
      width="1000px" @close="close" :close-on-click-modal="false">
      <el-row :gutter="14">
        <el-form ref="ruleForm" label-width="100px" :model="formData" :rules="rules" size="mini" :disabled="allDisabled">
          <el-col :span="12">
            <el-form-item label="底稿编号" label-width="140px" prop="sheetCode">
              <el-input v-model="formData.sheetCode" clearable placeholder="请输入底稿编号" :style="{ width: '100%' }"
                disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="底稿名称" label-width="140px" prop="sheetName">
              <el-input v-model="formData.sheetName" clearable placeholder="请输入底稿名称" :style="{ width: '100%' }"
                :disabled="!footer" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="被审计对象" label-width="140px" prop="orgIdNames">
              <el-input v-model="formData.orgIdNames" clearable placeholder="请输入被审计对象" :style="{ width: '100%' }"
                disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="审计事项" label-width="140px" prop="businessAffiliation">
              <el-input v-model="formData.businessAffiliation" clearable placeholder="请输入审计事项" :style="{ width: '100%' }"
                :disabled="!footer" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="审计人员" label-width="140px" prop="realname">
              <el-input v-model="formData.realname" clearable placeholder="请输入审计人员" :style="{ width: '100%' }" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="底稿创建时间" label-width="140px" prop="createTime">
              <el-date-picker style="width: 100%" v-model="formData.createTime" placeholder="请输入底稿创建时间" type="date"
          ...
          <el-col :span="12">
            <el-form-item label="是否发现问题" label-width="140px" prop="riskLevel">
              <el-select style="width: 100%" v-model="formData.riskLevel" placeholder="是否发现问题" @change="risklevelChange"
                :disabled="!footer">
          ...
          <el-col :span="12" v-if="showBelongType">
            <el-form-item label="所属类型" label-width="140px" prop="belongType">
              <el-select v-model="formData.belongType" placeholder="请选择所属类型" :style="{ width: '100%' }"
                :disabled="!footer" @change="selectBelongType">
          ...
          <el-col :span="12" v-if="showDetailType">
            <el-form-item label="问题类型" label-width="140px" prop="detailType">
              <el-select v-model="formData.detailType" placeholder="请选择问题类型" :style="{ width: '100%' }"
          ...
          <el-col :span="12" v-if="showMoneyInput">
            <el-form-item label="涉及金额" label-width="140px" prop="relatedMoney">
              <el-input v-model="formData.relatedMoney" clearable placeholder="请输入金额" :style="{ width: '100%' }"
                :disabled="!footer" />
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="showhgDetailType">
            <el-form-item label="合规性分类" label-width="140px" prop="hgDetailType">
              <el-select v-model="formData.hgDetailType" placeholder="请选择合规性分类" :style="{ width: '100%' }"
                :disabled="!footer">
          ...
          <el-col :span="12">
            <el-form-item label="一级复核" label-width="140px" prop="yjfh">
              <el-input v-model="formData.yjfh" clearable placeholder="请选择一级复核人" style="width: 266px" disabled />
              <el-button @click="projectManager1" style="margin-left: 10px" type="primary" :disabled="!footer">
                选择
              </el-button>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="二级复核" label-width="140px" prop="ejfh">
              <el-input v-model="formData.ejfh" clearable placeholder="请选择二级复核人" style="width: 266px" disabled />
              <el-button @click="projectManager2" style="margin-left: 10px" type="primary" :disabled="!footer">
                选择
              </el-button>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="是否汇总底稿" label-width="140px" prop="hzdg" v-if="showHZDG">
              <el-select v-model="formData.hzdg" placeholder="请选择" style="width: 266px" @change="selectHZDG">
                <el-option label="是" value="是" />
                <el-option label="否" value="否" />
              </el-select>
              <el-button @click="selectSFDG()" style="margin-left: 10px" type="primary" v-if="showHZDGButton">
                选择
              </el-button>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="问题单元" label-width="140px" prop="businessType">
              <el-input v-model="formData.businessType" clearable placeholder="请选择问题单元" style="width: 266px" disabled />
              <el-button @click="selectYWDY" style="margin-left: 10px" type="primary" :disabled="!footer">
                选择
              </el-button>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="内部问题类型" label-width="140px" prop="internalType">
              <el-checkbox-group v-model="formData.internalType">
                <el-checkbox v-for="item in SJWTData" :key="item.typeId" :label="item.typeId">
                  {{ item.auditType }}
                </el-checkbox>
              </el-checkbox-group>
            </el-form-item>
          ...
          <el-col :span="24" v-if="formData.riskLevel === '是'">
            <el-form-item label="问题标题" label-width="140px" prop="quesTitle">
              <el-input v-model="formData.quesTitle" clearable placeholder="请输入问题标题" :style="{ width: '100%' }"
                :disabled="!footer" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="审计程序" label-width="140px" prop="suditProcess ">
              <el-input v-model="formData.suditProcess" clearable placeholder="请输入审计程序" :style="{ width: '100%' }"
                type="textarea" :rows="4" :disabled="!footer" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="审计程序执行过程" label-width="140px" prop="auditDesc">
              <el-input v-model="formData.auditDesc" clearable placeholder="请输入审计程序执行过程" :style="{ width: '100%' }"
                type="textarea" :rows="4" :disabled="!footer" />
            </el-form-item>
          </el-col>
          <!-- <el-col :span="24" v-if="formData.risklevel === '是'">
          ...
          <el-col :span="24" v-if="formData.riskLevel === '是'">
            <el-form-item label="审计发现" label-width="140px" prop="auditDiscoverable">
              <el-input v-model="formData.auditDiscoverable" clearable placeholder="请输入审计发现" :style="{ width: '100%' }"
                type="textarea" :rows="4" :disabled="!footer" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="审计意见及建议" label-width="140px" prop="auditCourse">
              <el-input v-model="formData.auditCourse" clearable placeholder="请输入审计意见及建议" :style="{ width: '100%' }"
                type="textarea" :rows="4" :disabled="!footer" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="审计备忘录" label-width="140px" prop="sjbwl">
              <el-input v-model="formData.sjbwl" clearable placeholder="请输入审计备忘录" :style="{ width: '100%' }"
                type="textarea" :rows="4" :disabled="!footer" />
            </el-form-item>
          </el-col>
          <!-- <el-col :span="24">
        ...
        <el-col :span="24">
          ...
          <el-col :span="24">
            ...
            <el-table :data="tableData2">
              ...
              <el-table-column align="center" label="审计（调查）事项标题 " prop="auditMatter" />
              <el-table-column align="center" label="审计（调查）事项概述" prop="auditAbstract" show-overflow-tooltip />
              <el-table-column align="center" label="证据提供者" prop="certificateUser" />
              <!-- <el-table-column
                align="center"
                label="日期"
              ...
              <el-table-column align="center" label="操作" show-overflow-tooltip width="120">
                <template #default="{ row, $index }">
                  <el-button type="text" @click="handleEditDelte(row, $index)" v-if="footer">
                    删除
                  </el-button>
                </template>
              </el-table-column>
          ...
          <el-col :span="24">
            ...
            <el-table :data="BugtableData">
              ...
              <el-table-column align="center" label="缺陷描述" prop="bugdescripte" show-overflow-tooltip />
              <el-table-column align="center" label="发现时间" prop="discovertime" show-overflow-tooltip
                :formatter="formatDate" />
              <el-table-column align="center" label="缺陷性质" prop="bugproperty" show-overflow-tooltip />
              <el-table-column align="center" label="缺陷级别" prop="bugcrilevel" show-overflow-tooltip />
              <el-table-column align="center" label="操作" show-overflow-tooltip width="120">
                <template #default="{ row }">
                  <el-button type="text" @click="$refs['bug'].showEdit('edit', row)">
                    修改
                  </el-button>
          ...
          <el-col :span="24">
            <div style="text-align: right; margin-top: 5px" v-if="footer">
              <el-upload class="upload-demo" :show-file-list="false" :action="baseApi + api" :headers="headers"
                :on-success="handleSuccess" :file-list="tableData" :before-upload="handleBeforeUpload">
            ...
            <el-table :data="tableData">
              ...
              <el-table-column align="center" label="操作" show-overflow-tooltip width="120">
                <template #default="{ row }">
                  ...
                  <el-button type="text" @click="handlePreview(row)" :disabled="false">
                    预览
                  </el-button>
        ...
        <!-- 复核人选择 -->
        <SelectPersonModal1 @projectManage="selectPerson" ref="manage3"></SelectPersonModal1>
        <projectManage :modal="false" ref="manage" @reviewTypeSelect="reviewTypeSelect" />
        <DepartmentOption ref="DepartmentOptions" :multiSelect="true" @selectByTable="selected" />
      </el-row>
    ...
    <!-- 提交 -->
    <el-dialog @close="currentClose" title="选择分支" :visible="visible" :append-to-body="true" :close-on-click-modal="false">
      <el-form label-width="100px" ref="fzforms" :modal="fzforms" :rules="fzRules">
        <el-form-item label="分支选择" prop="branchStrs">
          <el-select style="width: 100%" v-model="fzforms.branchStrs" @change="handlefzChange" multiple>
            <el-option v-for="item in fzoptions" :label="item.nodeName" :value="item.nodeId"
              :key="item.nodeId"></el-option>
          </el-select>
        </el-form-item>
        <div v-for="(item, index) in this.runderList" :key="item.value">
          <el-form-item :label="item.label" prop="transferStaffName" v-if="item.hasCandidates">
            <!-- <el-input
              disabled
              placeholder="请选择候选人"
            ...
            <CandidateUserSelect :clearType="clearType" @selected="handleCandSelect" :index="index" :nodeId="item.nodeId"
              :candidateData="candidateData" multiple placeholder="请选择候选人" />
          </el-form-item>
        </div>
      </el-form>
      <div slot="footer">
    ...
    <el-dialog @close="close1" title="选择分支" :visible="visible1" :append-to-body="true" :close-on-click-modal="false"
      v-if="visible1">
      <el-form :modal="fzform1" label-width="100px" ref="fzform1" :rules="fzRules1">
        <el-form-item label="分支选择" prop="branchStrs">
          <el-select style="width: 100%" v-model="fzform1.branchStrs" @change="selectValue" multiple>
            <el-option v-for="item in fzoptions" :key="item.nodeId" :label="item.nodeName"
    ...
    <el-dialog title="选择候选人" :visible.sync="visible2" :close-on-click-modal="false" width="40%" :modal="false"
      @close="close2" v-if="visible2">
      <el-form :model="formData2" :rules="rules2" ref="ruleForm2" label-width="80px">
        <el-form-item label="候选人" prop="transferStaffName">
          ...
          <CandidateUserSelect :clearType="clearType" @selected="handleCandSelect1" :index="0"
            :nodeId="candidateData.nodeId" :candidateData="candidateData" multiple placeholder="请选择候选人" />
        </el-form-item>
      </el-form>
...
<script>
import SelectPersonModal1 from '@/views/audit/implement/components/options/selectZBSJRY.vue'
import {
  createDrafCode,
  deleteFile,
  deleteSheetReport,
...
export default {
  ...
  methods: {
    ...
    async showEdit(title, row, fileInfo) {
      this.tableData = [fileInfo] //附件表格
      this.BugtableData = []
      //获取审计问题类型数据
