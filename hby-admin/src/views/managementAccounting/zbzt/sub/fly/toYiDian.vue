<template>
  <el-dialog :append-to-body="true" :title="title" :visible.sync="dialogFormVisible" width="1000px" @close="close"
      ...
      <el-form ref="ruleForm" label-width="100px" :model="formData" :rules="rules" size="mini">
        <el-col :span="12">
          <el-form-item label="疑点编号" label-width="140px" prop="dpnumber">
            <el-input v-model="formData.dpnumber" clearable placeholder="请输入疑点编号" :style="{ width: '100%' }" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="疑点名称" label-width="140px" prop="dpname">
            <el-input v-model="formData.dpname" clearable placeholder="请输入疑点名称" :style="{ width: '100%' }"
              :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="编制人" label-width="140px" prop="editor">
            <el-input v-model="formData.editor" clearable placeholder="请输入编制人" :style="{ width: '100%' }" disabled />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="编制时间" label-width="140px" prop="edittime">
            <el-date-picker v-model="formData.edittime" placeholder="请输入编制时间" type="date" format="yyyy-MM-dd"
              value-format="yyyy-MM-dd" :style="{ width: '100%' }" :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="疑点描述" label-width="140px" prop="dpdescribe">
            <el-input v-model="formData.dpdescribe" clearable placeholder="请输入疑点描述" :style="{ width: '100%' }"
              type="textarea" :rows="4" :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="测试结果" label-width="140px" prop="testresult">
            <el-input v-model="formData.testresult" clearable placeholder="请输入测试结果" :style="{ width: '100%' }"
              type="textarea" :rows="4" :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="备注" label-width="140px" prop="memo">
            <el-input v-model="formData.memo" clearable placeholder="请输入备注" :style="{ width: '100%' }" type="textarea"
              :rows="4" :disabled="!footer" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
        ...
        <el-col :span="24">
          <div style="text-align: right; margin-bottom: 5px" v-if="footer">
            <el-upload class="upload-demo" :show-file-list="false" :action="baseApi + api" :headers="headers"
              :on-preview="handlePreview" :on-success="handleSuccess" :file-list="tableData"
