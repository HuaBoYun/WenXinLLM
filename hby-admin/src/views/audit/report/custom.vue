...
<script>
  import { zdyList, zdyDel, zdyDetail, reportExport } from '@/api/audit/report'
  import CustomView from '@/views/audit/report/components/CustomView'
  ...
  export default {
    ...
    methods: {
      ...
      async fetchData() {
        ...
        } = await zdyList({ ...other, startDate, endDate })
        this.list = list
        this.total = total
