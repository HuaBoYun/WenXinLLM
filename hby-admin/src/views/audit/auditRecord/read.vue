...
<script>
  import { getDajyNewlist } from '@/api/audit/archives'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'audit-auditRecord-read-search',
        tableKey: 'audit-auditRecord-read-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
      }
    ...
    methods: {
      ...
      async fetchData() {
        ...
        } = await getDajyNewlist(this.queryForm)
        this.list = tlist
