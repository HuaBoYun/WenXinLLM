      ...
      <el-table :data="list" v-loading="loading">
        ...
        <el-table-column align="center" label="参照文件" prop="file1">
          <template #default="{ row, $index }">
            <el-button
              ...
              @click="handlePreview(row.ori_file1)"
            >
        ...
        <el-table-column align="center" label="比较文件" prop="file2">
          <template #default="{ row, $index }">
            <el-button
              ...
              @click="handlePreview(row.ori_file2)"
            >
        ...
        <el-table-column align="center" label="操作" width="120">
          <template #default="{ row, $index }">
            <el-button
              type="text"
              v-if="row.tableData1.length != 0 && row.tableData2.length != 0"
              @click="handleOpen(row)"
            >
              开始对比
            </el-button>
            <el-button type="text" @click="handleDelete($index, row.id)">
              删除
            </el-button>
          </template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      fetchData() {
        ...
        // 构建查询参数
        const params = {}
        if (this.queryForm.pageNumber) {
          params.page = this.queryForm.pageNumber
        }
      ...
      handlePreview(fileUrl) {
        ...
        this.$iFrameDialog({ iframeUrl: fileUrl })
      },
    },
  }
</script>
