<template>
  <div class="system-log-container">
    ...
    <Deal ref="deal" />
    <PaymentBanli ref="banlifk" @fetch-data="fetchData1" />
    <ReceivingBanli ref="banlisk" @fetch-data="fetchData1" />
    <ShenjiModal ref="shenji" @reload-data="fetchData1" />
    <reportModal ref="report" @reload-data="fetchData1" />
    ...
    methods: {
      ...
      async fetchData1() {
        ...
        try {
          ...
          } = await my_circulation1(this.queryForm1)
          this.list1 = list
