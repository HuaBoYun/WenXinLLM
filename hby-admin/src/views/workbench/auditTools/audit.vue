<template>
  <div class="system-log-container">
    ...
    />
    <AuditEdit ref="edit" @fetch-data="fetchData" />
    <Tables ref="table" />
  </div>
</template>
...
<script>
  ...
  import AuditEdit from '@/views/workbench/auditTools/components/AuditEdit'
  ...
  export default {
    ...
    components: { filterSearch, filterTable, AuditEdit, Tables },
    data() {
      return {
        list: [],
        listLoading: true,
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'workbench-auditTools-audit-search',
        tableKey: 'workbench-auditTools-audit-list',
        searchMore: true,
      }
    },
    created() {
