    ...
    >
      <div v-loading="listLoading">
        ...
        <div class="el-divider el-divider--horizontal">
          <div class="el-divider__text is-center">行政处罚</div>
        </div>
        ...
        <!-- 环保处罚 -->
        <div class="el-divider el-divider--horizontal">
          <div class="el-divider__text is-center">环保处罚</div>
        </div>
        ...
        <!-- 欠税信息 -->
        <div class="el-divider el-divider--horizontal">
          <div class="el-divider__text is-center">欠税信息</div>
        </div>
        ...
        <!-- 动产抵押 -->
        <div class="el-divider el-divider--horizontal">
          <div class="el-divider__text is-center">动产抵押</div>
        </div>
        ...
        <!-- 股权出质 -->
        <div class="el-divider el-divider--horizontal">
          <div class="el-divider__text is-center">股权出质</div>
        </div>
        ...
        <!-- 司法冻结 -->
        <div class="el-divider el-divider--horizontal">
          <div class="el-divider__text is-center">司法冻结</div>
        </div>
        ...
        <!-- 军采黑名单 -->
        <div class="el-divider el-divider--horizontal">
          <div class="el-divider__text is-center">军采黑名单</div>
        </div>
        ...
        <!-- 政采黑名单 -->
        <div class="el-divider el-divider--horizontal">
          <div class="el-divider__text is-center">政采黑名单</div>
        </div>
  ...
  export default {
    ...
    methods: {
      async showEdit(name, creditCode) {
        ...
        this.govList = []
        try {
          // 批量查询经营风险类别: 行政处罚(6)/环保(7)/欠税(8)/抵押(9)/股权出质(10)/冻结(11)/军采(12)/政采(13)
          ...
          if (res.code === 200 && res.data) {
            ...
            for (const r of results) {
              if (r.status === 1) {
                if (r.detailItems) {
                  const items = Array.isArray(r.detailItems) ? r.detailItems : [r.detailItems]
                  const map = {
                    6: 'penaltyList', 7: 'envList', 8: 'taxList', 9: 'mortgageList',
                    10: 'pledgeList', 11: 'freezeList', 12: 'militaryList', 13: 'govList',
                  }
                  if (map[r.categoryId]) this[map[r.categoryId]] = items
                } else if (r.companyId) {
