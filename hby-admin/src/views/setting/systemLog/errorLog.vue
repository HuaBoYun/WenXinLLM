  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'setting-systemLog-errorLog-search',
        tableKey: 'setting-systemLog-errorLog-list',
        searchMore: true,
        select: [],
      }
    },
    ...
    methods: {
      ...
      async handleExport(row) {
        ...
        const data = await exportErrorLog(this.queryForm)
        let fileName = '异常日志'
        let blob = new Blob([data], {
