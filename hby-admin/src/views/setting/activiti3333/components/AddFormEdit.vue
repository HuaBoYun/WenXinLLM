<template>
  ...
  >
    <el-form ref="form" label-width="100px" :model="form" :rules="rules">
      <el-form-item label="表单名称" prop="jobname">
        <el-select v-model="form.jobname" placeholder="请选择表单">
          <el-option label="合同范本" value="shanghai"></el-option>
          <el-option label="合同规范" value="beijing"></el-option>
        </el-select>
      </el-form-item>
    </el-form>
    <template #footer>
