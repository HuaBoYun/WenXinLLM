          ...
          >
            ...
            >
              ...
              >
                ...
                <el-option label="定制催办" value="3"></el-option>
              </el-select>
              <el-select
              ...
              <el-dropdown-menu slot="dropdown">
                ...
                <el-dropdown-item @click.native="handleStop(row)">
                  <el-button
                    ...
                    v-if="row.reminderId == '1' || row.reminderId == '3'"
                  >
                    停止
                  </el-button>
                </el-dropdown-item>
                <el-dropdown-item @click.native="handleStart(row)">
                  <el-button
                    type="text"
                    :disabled="row.isStop == '0'"
                    v-if="row.reminderId == '1' || row.reminderId == '3'"
                  >
                    开始
                  </el-button>
  ...
  export default {
    ...
    methods: {
      ...
      async handleStart(row) {
        this.$baseConfirm('你确定要开始当前项吗', null, async () => {
          const { msg } = await startBList({ id: row.id })
          this.$baseMessage(msg, 'success', 'vab-hey-message-success')
          await this.fetchData()
        })
      },
