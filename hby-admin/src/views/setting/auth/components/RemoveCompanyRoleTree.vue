...
<template>
  ...
  >
    ...
    >
      <el-table-column width="48" type="selection"></el-table-column>
      <el-table-column
        align="center"
        label="公司名称"
        prop="orgname"
      ></el-table-column>
      <el-table-column align="center" label="公司编号" prop="orgnumber" />
    </el-table>
    <el-pagination
      background
...
<script>
  import { getCompanyList, delrqorg } from '@/api/setting/auth'
  ...
  export default {
    ...
    methods: {
      ...
      resetQueryForm() {
        this.queryForm.orgname = undefined
      ...
      handleSelectionChange(selection) {
        ...
        this.select = selection.map((item) => item.orgid)
      },
      // 4、回显已勾选的数据
      setCheckedRows() {
        let selectItem = []
