          ...
          <el-table v-loading="listLoading" :data="list" @sort-change="sortChange">
            ...
            <div v-for="(item, index) in filedNow" :key="index">
              ...
              <el-table-column
                ...
                label="结果"
                prop="data"
                v-if="item.name === '结果' && hasAuth('GZZXresult')"
              >
                <template #default="{ row }">
                  <span
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableKey: 'monitor-monitorExecute-ruleExecute-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
        filedAll: [
    ...
    methods: {
      ...
      fetchData() {
        ...
        getRuleExecuteList({...this.queryForm,sortFields: this.sortFields,
