<template>
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        ...
        <el-table-column align="center" label="操作" width="120">
          <template #default="{ row }">
            <!-- <el-button type="text" @click="handleView(row)">导出</el-button> -->
    ...
    <SJYGLview ref="edit" @fetchData="fetchData"></SJYGLview>
    <SJYCheck ref="check" @fetchData="fetchData"></SJYCheck>
    <el-pagination
      class="pagination"
      background
...
<script>
  import { getDataSourceList, DataSourceDelete } from '@/api/monitor/rule/index'

  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import SJYGLview from './components/sjyglView.vue'
  import SJYCheck from './sjyglCheck.vue'

  export default {
    name: 'NormalReportList',
    components: { filterTable, filterSearch, SJYGLview, SJYCheck },
    data() {
      return {
        list: [],
        listLoading: true,
        ...
        localKey: 'audit-base-sjygl-search',
        tableKey: 'audit-base-sjygl-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
      }
