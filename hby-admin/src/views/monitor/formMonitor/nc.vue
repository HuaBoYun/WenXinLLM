              ...
              <template #default="{ row }">
                ...
                <el-dropdown style="margin-left: 10px" @command="handleCommand">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item v-if="hasAuth('NCBDHJKstart')">
                      启用
                    </el-dropdown-item>
                    <el-dropdown-item v-if="hasAuth('NCBDHJKdelete')">
                      删除
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
...
<script>
  ...
  import { findFormInfoListInFlow } from '@/api/monitor/formMonitor'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'monitor-formMonitor-nc-search',
        tableKey: 'monitor-formMonitor-nc-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
        filedAll: [
