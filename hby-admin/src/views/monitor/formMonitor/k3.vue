              ...
              <template #default="{ row }">
                ...
                <el-dropdown style="margin-left: 10px" @command="handleCommand">
                  ...
                  <el-dropdown-menu slot="dropdown">
                    <el-dropdown-item v-if="hasAuth('K3BDHJKstart')">
                      启用
                    </el-dropdown-item>
                    <el-dropdown-item v-if="hasAuth('K3BDHJKdelete')">
                      删除
                    </el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'monitor-formMonitor-k3-search',
        tableKey: 'monitor-formMonitor-k3-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
        filedAll: [
