  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table
        ...
        :data="list"
        :default-sort="{ prop: 'assessid', order: 'descending' }"
      >
    ...
    />
    <ScoreView ref="edit" @fetch="fetchData" />
...
<script>
  import { getScoreList } from '@/api/internal/score'
  import { doDelete } from '@/api/table'
  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import EvaluateModel from '@/views/internal/evaluationManagement/components/EvaluateModel'
  import ScoreView from '@/views/internal/evaluationManagement/components/ScoreView'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'internal-evaluationManagement-score-search',
        tableKey: 'internal-evaluationManagement-score-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
      }
    ...
    methods: {
      ...
      getFiled() {
        let fields = [
          { name: '评价项目编号', key: 'projkey' },
          { name: '评价项目名称', key: 'projname' },
          { name: '时间', key: 'Date' },
        ]
        return fields
      },
      ...
      async fetchData() {
        ...
        const {
          data: { pageBean },
        } = await getScoreList({ ...other, startDate, endDate })
