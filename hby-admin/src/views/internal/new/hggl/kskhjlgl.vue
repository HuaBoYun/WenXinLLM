...
<script>
  ...
  import Views from './components/kskhjlglView.vue'

  export default {
    name: '',
    components: { filterTable, filterSearch, Views },
    data() {
      return {
        list: [],
        listLoading: false,
        ...
        localKey: 'internal-hggl-kskhjlgl-search',
        tableKey: 'internal-hggl-kskhjlgl-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
    ...
    methods: {
      ...
      getFiled() {
        let fields = [
          { name: '考核时间', key: 'workUnitName' },
          { name: '考核名称', key: 'employmentTermType' },
        ]
        return fields
      },
      initSearch() {
