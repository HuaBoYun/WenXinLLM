...
<script>
  ...
  import Views from './components/hgpxjlView.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'internal-hggl-hgpxjl-search',
        tableKey: 'internal-hggl-hgpxjl-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
    ...
    methods: {
      ...
      getFiled() {
        let fields = [
          { name: '培训时间', key: 'workUnitName' },
          { name: '培训名称', key: 'employmentTermType' },
        ]
        return fields
      },
      initSearch() {
