  ...
  >
    <el-row :gutter="14" v-loading="loading">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item :label="$translateTitle('管理员名称')" prop="administratorName">
            <el-input
        ...
        <el-col :span="24">
          <el-form-item :label="$translateTitle('联系方式')" prop="contactInformation">
            <el-input
      ...
      <el-col :span="24">
        ...
        <el-table :data="fileList">
          ...
          <el-table-column align="center" :label="$translateTitle('文件大小') + '(KB)'" prop="fileSize" />
...
<script>
  ...
  import { editXXGL, getXXGLDefaultInfo ,deleteFile} from '@/api/hggl/hgjhgl'
    ...
    methods: {
      async showEdit(title, row) {
        ...
        if (row) {
          getXXGLDefaultInfo({
            ...
            this.formData = Object.assign({}, res.data.im)
      ...
      add() {
        ...
        this.$refs['ruleForm'].validate(async (valid) => {
          if (valid) {
            editXXGL(this.formData).then((res) => {
              if (res.msg == '成功') {
                this.dialogFormVisible = false
