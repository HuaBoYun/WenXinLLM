...
<script>
  import { createProjectCode } from '@/api/internal/new/project'
  import {
    defTmplModify,
    defTmplSave,
    typeSave,
  ...
  export default {
    ...
    methods: {
      getNumber() {
        createProjectCode({
          tblName: 'TBL_COM_EXT_TESTTEMPLE',
          column: 'TEMPLENUMBER',
          orgCol: 'TBLCOMANY',
          noId: 317,
        }).then((res) => {
