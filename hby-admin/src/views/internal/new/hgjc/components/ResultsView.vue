      ...
      <div class="right">
        <el-table v-loading="listLoading" :data="list">
          ...
          <el-table-column
            ...
            prop="CONTROLMETHOD"
          />
          <el-table-column align="center" label="检查程序" prop="PROCEDURES" />
          <el-table-column align="center" label="检查结果" prop="TESTRESULT" />
          <el-table-column
            align="center"
            label="检查有效性"
...
<script>
  ...
  import {
    ...
    defListYx,
    defListNum,
  } from '@/api/internal/new/results'
  import ResultsInfo from '@/views/internal/new/hgjc/components/ResultsInfo.vue'
  export default {
    name: 'ResultsView',
