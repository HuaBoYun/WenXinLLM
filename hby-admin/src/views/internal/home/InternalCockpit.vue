<!-- 内控管理驾驶舱 -->
<template>
  <div class="internal-cockpit-container">
    <!-- 页面头部 -->
    ...
    <div class="main-content">
      ...
      <el-row :gutter="20">
        <el-col :lg="8" :md="8" :sm="24">
          <el-card class="chart-card">
            <div id="cockpit-chats-111" class="chart-container"></div>
          </el-card>
        </el-col>
        <el-col :lg="16" :md="16" :sm="24">
          <el-card class="chart-card">
            <div id="cockpit-chats-222" class="chart-container"></div>
          </el-card>
        </el-col>
      </el-row>

      <!-- 第二行：各单位缺陷数量 + 年度缺陷趋势 + 评价结果表 -->
      <el-row :gutter="20">
        <el-col :lg="12" :md="12" :sm="24">
          <el-card class="chart-card">
            <div id="cockpit-chats-333" class="chart-container-small"></div>
          </el-card>
          <el-card class="chart-card" style="margin-top: 20px">
            <div id="cockpit-chats-888" class="chart-container-small"></div>
          </el-card>
        </el-col>
        <el-col :lg="12" :md="12" :sm="24">
      ...
      <el-row :gutter="20">
        <el-col :lg="8" :md="8" :sm="24">
          <el-card class="chart-card">
            <div id="cockpit-chats-555" class="chart-container"></div>
          </el-card>
        </el-col>
        <el-col :lg="8" :md="8" :sm="24">
          <el-card class="chart-card">
            <div id="cockpit-chats-666" class="chart-container"></div>
          </el-card>
        </el-col>
        <el-col :lg="8" :md="8" :sm="24">
          <el-card class="chart-card">
            <div id="cockpit-chats-777" class="chart-container"></div>
          </el-card>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :lg="24" :md="24" :sm="24">
          <el-card class="chart-card">
            <div id="cockpit-chats-444" class="chart-container"></div>
          </el-card>
        </el-col>
      </el-row>
    </div>
    ...
    methods: {
      ...
      getList1() {
        getProjectMaturityAnalysis({ ...this.queryForm }).then((res) => {
          ...
          const chats1 = echarts.init(document.getElementById('cockpit-chats-111'))
          ...
          chats1.setOption({
            ...
            color: [this.themeColor, '#67c23a', '#e6a23c', '#f56c6c', '#909399', '#00d4ff', '#85ce61', '#f78989', '#a0cfff', '#b3d8ff'],
            tooltip: {
              trigger: 'item',
      ...
      getList2() {
        getCompanyProjectEvaluations().then((res) => {
          ...
          const chats2 = echarts.init(document.getElementById('cockpit-chats-222'))
          // 指定图表的配置项和数据
          chats2.setOption({
            title: {
              text: '公司评价项目数',
      ...
      getList3() {
        getDefectQuantityIssues().then((res) => {
          ...
          const chats3 = echarts.init(document.getElementById('cockpit-chats-333'))
          // 绘制图表
          chats3.setOption({
            title: {
              text: '各单位缺陷数量对比分析',
      ...
      getList4() {
        getDefectProjectsYearAnalysis({ ...this.queryForm }).then((res) => {
          ...
          const chats4 = echarts.init(document.getElementById('cockpit-chats-444'))
      ...
      getList5() {
        getDefectQuantityIssuesByDep({ ...this.queryForm }).then((res) => {
          ...
          const chats5 = echarts.init(document.getElementById('cockpit-chats-555'))
      ...
      getList6() {
        oneLevelProcess({ ...this.queryForm }).then((res) => {
          ...
          const chats6 = echarts.init(document.getElementById('cockpit-chats-666'))
          // 指定图表的配置项和数据
          chats6.setOption({
            title: {
              text: '内部控制缺陷分布',
      ...
      getList7() {
        defectGrade({ ...this.queryForm }).then((res) => {
          ...
          const chats7 = echarts.init(document.getElementById('cockpit-chats-777'))
      ...
      getList8() {
        getDistributionDefectTypes({ ...this.queryForm }).then((res) => {
          ...
          const chats8 = echarts.init(document.getElementById('cockpit-chats-888'))
