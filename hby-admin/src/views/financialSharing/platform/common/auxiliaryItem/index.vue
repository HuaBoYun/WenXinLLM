  ...
  <div class="app-container">
    ...
    <el-card class="box-card" style="margin-top: 20px">
      ...
      >
        ...
        <el-table-column label="核算项编码" prop="auxiliaryCode" width="120" />
        <el-table-column label="核算项名称" prop="auxiliaryName" width="200" show-overflow-tooltip />
        <el-table-column label="核算类型" prop="auxiliaryTypeName" width="100" align="center" />
        <el-table-column label="上级核算项" prop="parentName" width="180" show-overflow-tooltip />
    ...
    getList() {
      ...
      getAuxiliaryItemPage(this.queryForm).then(response => {
        if (response.code === 1) {
          ...
          this.auxiliaryItemList = response.data.records || response.data.tlist
