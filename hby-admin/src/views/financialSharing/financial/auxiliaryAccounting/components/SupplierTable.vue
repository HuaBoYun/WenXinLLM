<template>
  <div class="supplier-table">
    ...
    <div class="search-bar">
      <el-form :model="searchForm" :inline="true" size="small">
        ...
        <el-form-item label="付款条件">
          <el-select v-model="searchForm.paymentTerms" placeholder="请选择付款条件" clearable>
    ...
    <el-table
      ...
      border
      style="width: 100%">
      <el-table-column prop="code" label="供应商编码" width="120" fixed="left"></el-table-column>
      <el-table-column prop="name" label="供应商名称" min-width="200" fixed="left"></el-table-column>
      ...
      <el-table-column prop="paymentTerms" label="付款条件" width="100" align="center">
        <template slot-scope="scope">
          <el-tag type="info" size="mini">{{ scope.row.paymentTerms || 'NET30' }}</el-tag>
        </template>
      </el-table-column>
...
export default {
  ...
  computed: {
    filteredData() {
      ...
      if (this.searchForm.paymentTerms) {
        data = data.filter(item => item.paymentTerms === this.searchForm.paymentTerms)
      }
