  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        <el-table-column align="center" label="账簿编码" prop="code,">
...
<script>
  import { getZblxList, deleteZblx } from '@/api/cwsc'
  ...
  export default {
    ...
    components: { filterTable, filterSearch, zblxEdit },
    data() {
      return {
        list: [],
        listLoading: true,
    ...
    methods: {
      ...
      getFiled() {
        let fields = [
          { name: '账簿编码', key: 'code' },
          { name: '账簿名称', key: 'name' },
          { name: '账簿简称', key: 'shortname' },
          { name: '助记码', key: 'mnecode' },
        ]
        return fields
      },
      initSearch() {
      ...
      async fetchData() {
        ...
        const {
          data: { records, total },
        } = await getZblxList(this.queryForm)
        this.list = records
        this.total = total
