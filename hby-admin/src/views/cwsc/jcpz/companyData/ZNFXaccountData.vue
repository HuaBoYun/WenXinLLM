<template>
  <div class="system-log-container">
    <el-row :gutter="20" v-loading="loading">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/cwsj/statement')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/cwsj/subject')">
            <vab-icon icon="kemu" is-custom-svg />
            <p>科目表</p>
          </div>
          <div class="line-item" @click="goTo('/cwsj/balance')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/cwsj/accountCate')">
            <vab-icon icon="zongzhang" is-custom-svg />
            <p>总分类账</p>
          </div>
          <div class="line-item" @click="goTo('/cwsj/accountDetail')">
            <vab-icon icon="mingxi" is-custom-svg />
            <p>明细账</p>
          </div>
          <div class="line-item" @click="goTo('/cwsj/accountDiary')">
            <vab-icon icon="jizhang" is-custom-svg />
            <p>日记账</p>
          </div>
          <div class="line-item" @click="goTo('/cwsj/accountAssist')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/cwsj/voucherLib')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/cwsj/accountManage')">
