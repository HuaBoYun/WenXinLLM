<template>
  ...
  >
    ...
    >
      ...
      <el-table-column prop="dbconfigname" label="数据源名称"></el-table-column>
      <el-table-column
        prop="financeorgname"
        label="配置公司名称"
      ></el-table-column>
      <el-table-column prop="fversionname" label="财务版本"></el-table-column>
    </el-table>
  </el-dialog>
</template>

<script>
  import { getCjfaList } from '@/api/cwsc'
  export default {
    data() {
      return {
        dialogVisible: false,
