  ...
  <div class="system-log-container">
        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              <el-select
                v-model="queryForm.financedbtype"
                placeholder="数据库类型"
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        <el-table-column align="center" label="数据库类型" prop="financedbtype">
...
<script>
  ...
  import SJYGLview from './components/sjyglEdit.vue'

  export default {
    name: 'NormalReportList',
    components: { filterTable, filterSearch, SJYGLview },
    data() {
      return {
        list: [],
        listLoading: true,
    ...
    methods: {
      ...
      // 定义表单所有项
      getFiled() {
        let fields = [{ name: '数据库类型', key: 'financedbtype' }]
        return fields
      },
      initSearch() {
        let self = this
