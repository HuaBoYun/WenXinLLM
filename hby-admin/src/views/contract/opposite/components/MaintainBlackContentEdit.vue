  ...
  export default {
    ...
    methods: {
      async fetchItem(row) {
        ...
        this.form.pageEffectDate = budget.blackRecord.blackdeadtime
        this.form.blacktype = budget.blackRecord.obrtype
        this.form.brid = budget.blackRecord.brid
        this.$forceUpdate()
        // 重置localList
        this.localList = []
        this.current = budget
      ...
      save() {
        this.$refs['form'].validate(async (valid) => {
          if (valid) {
            ...
            if (code == 1) {
              // tableId, fromId
              this.$refs['process'].save(3, this.form.brid)
