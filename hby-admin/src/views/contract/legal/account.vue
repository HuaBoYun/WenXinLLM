...
<script>
  import { getlegal } from '@/api/contract/legal'
  import { doDelete } from '@/api/table'
  import AccountEdit from '@/views/contract/legal/components/AccountEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'contract-legal-account-search',
        tableKey: 'contract-legal-account-list',
        searchNow: [],
        searchMore: true,
        searchItem: [],
