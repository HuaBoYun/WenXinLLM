...
<script>
  import { getdispute, Removedispute } from '@/api/contract/legal'
  import CloseEdit from '@/views/contract/legal/components/CloseEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'contract-legal-close-search',
        tableKey: 'contract-legal-close-list',
        searchNow: [],
        searchMore: true,
        searchItem: [],
