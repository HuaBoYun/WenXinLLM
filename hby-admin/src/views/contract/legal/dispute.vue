...
<script>
  import { getcaseInformationList, Removecase } from '@/api/contract/legal'
  ...
  export default {
    name: 'Dispute',
    components: { DisputeEdit, filterTable, filterSearch },
    data() {
      return {
        list: [],
        listLoading: true,
        ...
        localKey: 'contract-legal-dispute-search',
        tableKey: 'contract-legal-dispute-list',
        searchNow: [],
        searchMore: true,
        searchItem: [],
