 ...
 * @LastEditTime: 2022-04-20 09:27:36
 * @FilePath: /hb-admin/src/views/contract/contractManage/components/FileUpload.vue
-->
<!-- eslint-disable -->
<template>
  <div class="upload-container">
    ...
    >
      <slot>
        <div class="select-file" v-if="fileList.length <= limit">
  ...
  export default {
    ...
    methods: {
      ...
      handleRemove(file, fileList) {
        // console.warn('handleRemove', file, fileList)
