  ...
  >
    ...
    >
      <template>
        ...
        <el-table-column align="center" label="范本名称" prop="contractname" />
        <el-table-column align="center" label="所属类型" prop="contracttype" />
      </template>
    </el-table>
    <el-pagination
      background
...
<script>
  import { getContractList } from '@/api/contract/manage'
