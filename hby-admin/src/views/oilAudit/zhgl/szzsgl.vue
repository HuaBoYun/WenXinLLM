<template>
  <div class="system-log-container">
    ...
    <SZZSGL ref="edit" @fetchData="fetchData"></SZZSGL>
    <el-pagination
      class="pagination"
      background
...
<script>
  import SZZSGL from './components/szzsglViews.vue'
  import { formatDate } from '@/utils/index'
  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import { getList, deleteInfo } from '@/oapi/ypns_zhgl/szzsgl.js'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'oilAudit-zhgl-szzsgl-search',
        tableKey: 'oilAudit-zhgl-szzsgl-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
      }
    ...
    methods: {
      handleApproval(row) {
        //提交审批
        this.$refs['process'].save(144, row.id)
      },
      // 办理
      ...
      getFiled() {
        let fields = [
          { name: '用户姓名', key: 'userName' },
          { name: '员工编号', key: 'staffCode' },
        ]
