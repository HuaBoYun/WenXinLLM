  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        <el-table-column align="center" label="信息标题" prop="infoTitle">
        ...
        <div v-for="(item, index) in filedNow" :key="index">
          ...
          <el-table-column
            ...
            v-if="item.name === '预期上网时间'"
          ></el-table-column>
          <el-table-column
            align="center"
            label="期失效时间"
            prop="failureTime"
            v-if="item.name === '预期失效时间'"
          ></el-table-column>
          <el-table-column
            v-if="item.name === '状态'"
            align="center"
    ...
    <nbwzsqdViews ref="edit" @fetchData="fetchData"></nbwzsqdViews>
    <el-pagination
      class="pagination"
      background
...
<script>
  import nbwzsqdViews from './components/nbwzsqdViews.vue'
  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import { getList, deleteInfo } from '@/oapi/ypns_zhgl/nbwzsqd'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'oilAudit-zhgl-nbwzsqd-search',
        tableKey: 'oilAudit-zhgl-nbwzsqd-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
      }
    ...
    methods: {
      handleApproval(row) {
        //提交审批
        this.$refs['process'].save(134, row.id)
      },
      // 办理
