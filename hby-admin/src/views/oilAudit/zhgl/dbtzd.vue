  ...
  <div class="system-log-container">
        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              <el-input
                v-model="queryForm.noticeNumber"
                clearable
                placeholder="通知单编号"
                style="width: 140px; margin-right: 20px"
                v-if="item.name === '通知单编号'"
              ></el-input>
              <el-input
    ...
    <el-card shadow="never" class="secondCard">
      ...
      >
        ...
        <el-table-column align="center" label="通知单编号" prop="noticeNumber">
    ...
    <dbtzdViews ref="edit" @fetchData="fetchData"></dbtzdViews>
    <el-pagination
      class="pagination"
      background
...
<script>
  import dbtzdViews from './components/dbtzdViews.vue'
  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import { getList, deleteInfo, exportList } from '@/oapi/ypns_zhgl/dbtzd'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'oilAudit-zhgl-dbtzd-search',
        tableKey: 'oilAudit-zhgl-dbtzd-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
        select: [],
    ...
    methods: {
      handleApproval(row) {
        //提交审批
        this.$refs['process'].save(138, row.id)
      },
      // 办理
