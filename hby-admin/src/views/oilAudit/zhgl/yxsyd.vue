...
<script>
  ...
  import { getList, deleteInfo } from '@/oapi/ypns_zhgl/yxsyd'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'oilAudit-zhgl-yxsyd-search',
        tableKey: 'oilAudit-zhgl-yxsyd-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
      }
