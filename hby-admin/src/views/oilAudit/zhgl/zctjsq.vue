<template>
  <div class="system-log-container">
        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              <el-input
                v-model="queryForm.assetMgtName"
                clearable
                placeholder="资产名称"
    ...
    <zctjsqViews ref="edit" @fetchData="fetchData"></zctjsqViews>
    <!-- 提交流程 -->
...
<script>
  import zctjsqViews from './components/zctjsqViews.vue'
  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import { getList, deleteInfo } from '@/oapi/ypns_zhgl/zctjsq.js'
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'oilAudit-zhgl-zctjsq-search',
        tableKey: 'oilAudit-zhgl-zctjsq-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
      }
    ...
    methods: {
      ...
      handleApproval(row) {
        //提交审批
        this.$refs['process'].save(39, row.id)
      },
