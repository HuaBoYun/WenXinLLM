...
<script>
  ...
  export default {
    components: { ExecutorOptions, SelectDepartment, ProcessList },
    inheritAttrs: false,
    props: ['fetchData'],
    data() {
      return {
    ...
    methods: {
      ...
      getDepartmentInfo(node) {
        this.$set(this.formData, 'repairBelongGroupName', node.label)
      ...
      handleApproval() {
        //提交审批
        this.$refs['process'].save(41, this.editId)
      },
