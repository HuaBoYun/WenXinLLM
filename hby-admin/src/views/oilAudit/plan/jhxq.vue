  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="listLoading" :data="list">
        <el-table-column align="center" label="底稿编号" prop="sheetCode" width="100">
...
export default {
  ...
  data() {
    return {
      ...
      searchNow: [], //当前所有搜索项
      searchItem: [], //可见搜索项
      localKey: "oilAudit-plan-jhxq-search",
      tableKey: "oilAudit-plan-jhxq-list",
      searchMore: true,
    };
  },
  created() {
  ...
  methods: {
    getFiled() {
      return [
        ...
        { name: "重点关注领域、项目、事项和风险", key: "sheetname" },
      ];
    },
    resetQueryForm() {
    ...
    async fetchData() {
      ...
      //   },
      // } = await getDgListAll(this.queryForm);
      // this.list = list;
      // this.total = total;
