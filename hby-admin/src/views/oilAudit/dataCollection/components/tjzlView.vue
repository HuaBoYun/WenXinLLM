  ...
  >
    <el-row :gutter="14" v-loading="loading">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="创建人" prop="createUser.realname">
            <el-input
  ...
  export default {
    ...
    methods: {
      ...
      async showEdit(row, title) {
        ...
        if (row) {
          const res = await planDataDetail({ id: row.id })
        ...
        if (title == 'edit') {
          ...
          this.formData.createUser.realname = resL
        }
      },
      close() {
        this.formData = {
      ...
      async save() {
        this.$refs['ruleForm'].validate(async (valid) => {
          if (valid) {
            ...
            const res = await planDataSaveOrUpdate({
              ...params,
              attIds,
            })
            if (res && res.code == 1) {
