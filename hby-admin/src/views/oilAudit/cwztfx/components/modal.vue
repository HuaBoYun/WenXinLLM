...
<script>
  ...
  import { getProjectRunDataModal } from '@/api/cwztfx'
  ...
  export default {
    ...
    methods: {
      show(dataIndex) {
        this.visible = true
        this.currentStatus = dataIndex // 保存状态
        this.queryForm.pageNumber = 1 // 重置页码
      ...
      handleSizeChange(val) {
        ...
        this.fetchData(this.currentStatus) // 传递保存的状态
      },
