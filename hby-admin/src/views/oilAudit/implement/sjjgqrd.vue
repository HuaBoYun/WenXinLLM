  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel :span="24">
        ...
        <el-dropdown style="margin-right: 10px" v-if="isShow">
...
<script>
  ...
  import SJJGQRDview from './components/sjjgqrdView.vue'
  ...
  export default {
    ...
    methods: {
      ...
      handleAdd(i) {
        if (this.row) {
          this.$refs['edit'].showEditWithRow(null, 'add', i, {
