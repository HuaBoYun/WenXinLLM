  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="审计人员" label-width="140px" prop="auditStaff">
            <el-input
              v-model="formData.auditStaff"
              clearable
              placeholder="请输入审计人员"
              :style="{ width: '100%' }"
              disabled
    ...
    methods: {
      ...
      showEdit(title, row) {
        ...
        if (title == 'edit') {
          ...
          this.formData.auditStaff = userInfo.realname
          this.formData.auditStaffId = userInfo.staffid
          this.formData.auditedUnit = userInfo.linkDetp.orgname
          this.formData.auditOrg = userInfo.linkDetp.orgid
