  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="组长" prop="groupLeader" style="height: 29px">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="主审" prop="approver" style="height: 29px">
            <el-input
    ...
    <!-- 公司 -->
    <SelectDepartment ref="compony" @submit="handleUnitSelected" />
  </el-dialog>
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async handleUnitSelected(node) {
        this.formData.exePhraseUnit = node.name
      ...
      async save() {
        this.$refs['ruleForm'].validate(async (valid) => {
          if (valid) {
            ...
            const { data, code } = await projectSaveOrUpdate(params)
            if (code == 1) {
              this.$emit('fetchData')
