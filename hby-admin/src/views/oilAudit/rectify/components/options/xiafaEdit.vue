...
<script>
  ...
  import projectList from '@/views/oilAudit/rectify/components/options/projectList'
  import contentTable from '@/views/oilAudit/rectify/components/table/contentTable'
      ...
      showEdit(title, row) {
        ...
        if (row) {
          ...
          this.formData = {
            ...
            reformuserid:
              row.solution.reformUser && row.solution.reformUser.staffid,
            ...other,
          }
