<template>
  <div class="system-log-container">
    ...
    <valuationTable ref="table" @fetch-data="fetchData" />
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'Valuation',
    components: { SchemeInfo, valuationTable },
    data() {
      return {
        list: [],
        listLoading: true,
    ...
    methods: {
      ...
      async fetchData() {
        ...
        } = await getZgjcSolutionmgmtList(this.queryForm)
        this.list = list
        this.total = total
