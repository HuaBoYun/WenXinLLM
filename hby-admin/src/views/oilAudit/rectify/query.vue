<template>
  <div class="system-log-container">
    ...
    <el-table v-loading="listLoading" :data="list">
      ...
      >
        <template #default="{ row }">
          <el-button type="text" @click="inquire(row)">查询</el-button>
...
<script>
  ...
  export default {
    name: 'Query',
    components: { SchemeInfo, queryTable },
    data() {
      return {
        list: [],
        listLoading: true,
    ...
    methods: {
      ...
      async fetchData() {
        ...
        } = await getZgcxSolutionmgmtList(this.queryForm)
        this.list = list
        this.total = total
      ...
      async handleExport(row) {
        const data = await exploredInfo({ solutionid: row.solutionid })
        let fileName = '整改查询'
