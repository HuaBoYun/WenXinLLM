...
export default {
  ...
  data() {
    return {
      ...
      searchNow: [], //当前所有搜索项
      searchItem: [], //可见搜索项
      localKey: 'oilAudit-gcgl-overviewAuditStatus-search',
      tableKey: 'oilAudit-gcgl-overviewAuditStatus-list',
      searchMore: true,
      dateValue2:{
  ...
  methods: {
    ...
    handleworkSheetQuCount(row){
      this.$refs['DGModel'].showEdit(row,1, 1)
    },
    handleworkSheetFhCount(row){
      this.$refs['DGModel'].showEdit(row,0, 1)
    },
    handleitemCount(row){
