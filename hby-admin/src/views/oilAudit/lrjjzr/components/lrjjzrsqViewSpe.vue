  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="现任职起止时间" prop="jobTimeRange">
            <el-date-picker
            disabled
              v-model="formData.jobTimeRange"
              type="daterange"
              range-separator="至"
              start-placeholder="现任职开始日期"
              end-placeholder="现任职结束日期"
              format="yyyy-MM-dd"
              value-format="yyyy-MM-dd"
              :style="{ width: '100%' }"
            ></el-date-picker>
        ...
        <el-col :span="12">
          <el-form-item label="资产情况（万元）" prop="assetInfo">
            <el-input
              ...
              @input="inputNum($event, 'assetInfo')"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12" style="height: 29px">
          <el-form-item label="可控成本（万元）" prop="controllableCost">
            <el-input
              ...
              @input="inputNum($event, 'controllableCost')"
            />
          </el-form-item>
        </el-col>
        <el-col :span="12">
    ...
    methods: {
     ...
     inputNum(value, key) {
      ...
      getDepartmentInfo(val) {
        ...
        this.formData.oldOrg.orgname = val.name
      ...
      getDepartmentInfos(val) {
        ...
        this.formData.org.orgname = val.name
      },
      // 选公司
      showGroupLeader() {
