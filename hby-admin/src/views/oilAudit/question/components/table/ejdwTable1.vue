<template>
    <el-card shadow="never">
      <el-divider>一、已委托未实施二级单位行政正职离任经济责任审计</el-divider>
      ...
      <el-table v-loading="listLoading" :data="list" :max-height="500">
        ...
        >
          ...
          <el-table-column
            align="center"
            label="主审"
            prop="chiefReviewerId"
          />
          <el-table-column
            align="center"
            label="助审"
            prop="deputyReviewerId"
          />
        </el-table-column>
...
<script>
  import { ywtsjGetlist } from '@/oapi/audit/implement'
