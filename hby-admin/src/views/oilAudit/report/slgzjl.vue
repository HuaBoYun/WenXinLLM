  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list">
        <el-table-column align="center" label="审计项目名称" prop="name">
        ...
        <div v-for="(item, index) in filedNow" :key="index">
          ...
          <el-table-column
            ...
            label="实施审理时间"
            prop="ssslsj"
            v-if="item.name === '实施审理时间'"
          ></el-table-column>
          <el-table-column
            align="center"
            label="审理发现问题摘要"
            prop="slfawt"
            v-if="item.name === '审理发现问题摘要'"
          ></el-table-column>
        </div>
...
<script>
  import { getSjgzjlList, sjgzjlDelete } from '@/oapi/audit/report'
  import ipViews from './components/slgzjlView.vue'
  ...
  export default {
    ...
    methods: {
      ...
      async fetchData() {
        ...
        } = await getSjgzjlList(this.queryForm)
        this.list = tlist || []
      ...
      handleDelete(row) {
        this.$baseConfirm('你确定要删除当前项吗', null, async () => {
          const res = await sjgzjlDelete({ id: row.id })
          if (res.code == 1) {
