<template>
  <div class="system-log-container">
    ...
    <pfxglAdd ref="pfxglAdd" @queryData="queryData" />
  </div>
</template>

<script>
  import { getList, handleDelete } from '@/oapi/baseConfig/sjffwh'
  import filterSearch from '@/components/filterSearch.vue'
  import filterTable from '@/components/filterTable.vue'
  import pfxglAdd from './components/sjffwhView.vue'
  export default {
    name: 'pfxgl',
    components: { filterTable, filterSearch, pfxglAdd },
    data() {
      const fields = [{ name: '方法名称', key: 'methodName' }] // 定义表单所有项
      return {
        list: [],
        loading: true,
        ...
        localKey: 'oilAudit-pfgl-sjffwh-search',
        tableKey: 'oilAudit-pfgl-sjffwh-list',
    ...
    methods: {
      ...
      async fetchData(type) {
        this.loading = true
        if (type && type === 'reset') {
          this.queryForm.methodName = undefined
