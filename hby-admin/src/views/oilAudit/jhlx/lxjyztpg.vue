  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never">
      <vab-query-form-right-panel :span="24">
        ...
        <el-button type="success" @click="handleSend()">汇总</el-button>
        <!-- <el-upload
          class="upload-demo"
    ...
    <lxjyztpgTable ref="table" @fetchData="fetchData"/>
    <lrjjzrsqView ref="edit" @fetchData="fetchData"></lrjjzrsqView>
    <lrjjzrsqViewSpe ref="editSpe" @fetchData="fetchData"></lrjjzrsqViewSpe>
    <project-manage
...
import {
  ...
  getLxZxsjHzDetailList, 
} from '@/oapi/audit/plan'
import { formatDate } from '@/utils/index'
import lrjjzrsqView from '@/views/oilAudit/lrjjzr/components/lrjjzrsqView.vue'
import lxjyztpgTable from '@/views/oilAudit/jhlx/components/table/lxjyztpgTable.vue'
import lrjjzrsqViewSpe from '@/views/oilAudit/lrjjzr/components/lrjjzrsqViewSpe.vue'
...
export default {
  ...
  methods: {
    ...
    async getChildlistPro(val) {
      ...
      saveDistributionPerson({
        idStrs: ids.toString(),
        disSecondPerson: names.toString(),
      }).then((res) => {
        if (res.code == '1') {
    ...
    getFiled() {
      return [
        ...
        { name: '立项理由及审计目的', key: 'projectPurpose' },
      ]
    },
    resetQueryForm() {
    ...
    async fetchData() {
      ...
      const {
        ...
        code,
      } = await getLxZxsjHzDetailList(this.queryForm)
      if (code === 1) {
        this.list = tlist || []
