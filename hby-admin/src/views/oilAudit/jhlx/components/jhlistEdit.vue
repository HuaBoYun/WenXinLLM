...
<script>
  ...
  export default {
    ...
    methods: {
      handleSJDetail(row) {
        console.log('🚀 ~ handleSJDetail ~ row:', row)
      ...
      jhTable(val) {
        ...
        console.log('🚀 ~ jhTable ~ this.tableData5:', this.tableData5)
        ...
        console.log('🚀 ~ jhTable ~ this.tableData6:', this.tableData6)
        ...
        console.log('🚀 ~ jhTable ~  this.tableData7 :', this.tableData7)
