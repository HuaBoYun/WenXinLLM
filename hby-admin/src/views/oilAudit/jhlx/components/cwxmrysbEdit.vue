    ...
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="24">
          ...
          >
            <el-button type="success" @click="push2()">分配督导人员</el-button>
          </div> -->
          <el-table
          ...
          >
            ...
            >
              <template #default="scope">
                <el-button
                  type="text"
                  @click="handleCwxmDetail(scope.row, scope.$index)"
                  :disabled="false"
                >
                  分配
                </el-button>
      ...
      handleBack() {
        if (this.select.length > 0) {
          ...
          this.$baseConfirm('你确定要上报当前项吗', null, async () => {
            const res = await fundAuditProjectXmzsb({ ids: ids.join() })
            if (res.code == 1) {
