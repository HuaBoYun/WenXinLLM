<template>
  ...
  >
    <el-row :gutter="4">
      ...
      >
        <el-col :span="12">
          <el-form-item label="审计项目名称" prop="field1">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="立项理由及审计目的" prop="field2">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="重点关注内容" prop="field4">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="单位范围" prop="field5">
            <el-input
              v-model="formData.field4"
              clearable
              placeholder="请输入单位范围"
        ...
        <el-col :span="12">
          <el-form-item label="时间范围" prop="field5">
            <el-input
              v-model="formData.field4"
              clearable
              placeholder="请输入时间范围"
