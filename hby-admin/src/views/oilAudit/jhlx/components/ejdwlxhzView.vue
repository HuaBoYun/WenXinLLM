  ...
  >
    <el-row :gutter="14" v-loading="loading">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="审计事项" prop="code">
            <el-input
              v-model="formData.code"
              :style="{ width: '75%' }"
              clearable
        ...
        <el-col :span="12">
          <el-form-item label="审计目的" prop="name">
            <el-input
        ...
        <el-col :span="24">
          <el-form-item label="重点关注内容" prop="timer">
            <el-input
              v-model="formData.name"
              :style="{ width: '100%' }"
              clearable
        ...
        <el-col :span="12">
          <el-form-item label="单位范围" prop="timer">
            <el-input
              v-model="formData.name"
              :style="{ width: '100%' }"
              clearable
        ...
        <el-col :span="12">
          <el-form-item label="时间范围" prop="timer">
            <el-input
              v-model="formData.name"
              :style="{ width: '100%' }"
              clearable
        ...
        <el-col :span="12">
          <el-form-item label="项目类型" prop="timer">
            <el-input
              v-model="formData.name"
              :style="{ width: '100%' }"
              clearable
        ...
        <el-col :span="24">
          <el-form-item label="备注" prop="timer">
            <el-input
              v-model="formData.name"
              :style="{ width: '100%' }"
              clearable
