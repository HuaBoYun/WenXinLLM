...
<script>
  ...
  import {
    engineeringBasicInformationList,
  } from '@/oapi/audit/plan'
  import { audit2LsaveOrUpdate4,getListDraftPlan3 } from '@/api/oilAudit/jhgl/jhcg'
  ...
  export default {
    ...
    async fetchData() {
      ...
      const res = await getListDraftPlan3({        ...this.queryForm})
      this.list = res.data
