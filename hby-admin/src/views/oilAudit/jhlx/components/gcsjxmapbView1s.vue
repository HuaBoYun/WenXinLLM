<template>
  ...
  >
    ...
    <el-row :gutter="14">
      ...
      <gcxmrysbAssignEdit2 ref="gcxmrysbAssignEdit2" @save="onSave" />
    </el-row>
  </el-dialog>
</template>
...
<script>
  ...
  import { getGcxmjsListByhzcf } from '@/oapi/audit/project'
  ...
  export default {
    ...
    methods: {
      ...
      async fetchData() {
        ...
        const data = await getGcxmjsListByhzcf({ gcxmzjzjbid: this.id })
