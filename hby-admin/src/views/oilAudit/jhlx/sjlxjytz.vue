  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never">
      ...
      >
        ...
        <el-table-column align="center" label="通知名称" width="170">
        ...
        <div v-for="(item, index) in filedNow" :key="index">
          ...
          >
            <template #default="{ row }">
              {{ row.organizations?.map((item) => item.orgname).join('，') }}
            </template>
          </el-table-column>
          <el-table-column
            align="center"
    ...
    />
    <sjlxjytzEdit ref="edit" @fetchData="fetchData" />
...
<script>
  ...
  import sjlxjytzEdit from './components/sjlxjytzEdit.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'oilAudit-jhlx-sjlxjytz-search',
        tableKey: 'oilAudit-jhlx-sjlxjytz-list',
        searchMore: true,
        btnLoading: false,
      }
    },
