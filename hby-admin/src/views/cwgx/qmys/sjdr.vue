...
<script>
  import { implementPlanList, implementPlanDelete } from '@/oapi/audit/project'
  import Edit from './components/sjdrEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-sjdr-search',
        tableKey: 'globalTreasurer-jsgl-sjdr-list',
        searchMore: false,
        select: [],
      }
    },
