  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgl-qmys-mbxtgl-search',
        tableKey: 'cwgl-qmys-mbxtgl-list',
        searchMore: false,
      }
    },
    created() {
    ...
    methods: {
      ...
      handleAdd(row, disabled) {
        this.$refs['fyhjrjgBaseEdit'].showEdit(row, disabled)
      },
      handleEdit(row) {
        this.$refs['fyhjrjgBaseEdit'].showEdit(row, false)
      },
      handleDelete(row) {
