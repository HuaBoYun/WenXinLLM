  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-cssjrz-search',
        tableKey: 'globalTreasurer-jsgl-cssjrz-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          { name: '目标系统', key: 'sxName' },
          { name: '应用模型', key: 'startStatus1' },
          { name: '主体', key: 'startStatus2' },
          { name: '时间', key: 'day' },
          { name: '传输方案', key: 'supplier1' },
          { name: '操作类型', key: 'supplier2' },
        ]
      },
