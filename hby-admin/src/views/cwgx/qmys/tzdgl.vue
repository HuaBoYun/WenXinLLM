        ...
        <vab-query-form-left-panel :span="24">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              >
                <el-option
                  v-for="option in budgetTaskOptions"
                  :key="option.value"
                  :label="option.label"
                  :value="option.value"
                />
...
<script>
  ...
  import Edit from './components/jbtzEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-qmys-ystj-search',
        tableKey: 'globalTreasurer-qmys-ystj-list',
        searchMore: false,
        select: [],
        budgetTaskOptions: [
          {
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '调整方式', key: 'startStatus1' },
          { name: '单据状态', key: 'startStatus2' },
          { name: '调整人', key: 'startStatus3' },
        ]
      },
