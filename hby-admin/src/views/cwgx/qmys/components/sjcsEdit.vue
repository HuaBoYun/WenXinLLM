<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="方案编码" prop="organization" required>
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="应用模型" prop="code" required>
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="数据选择方式" prop="code" required>
            <el-input
              v-model="formData.code"
              placeholder="数据选择方式"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="目标系统" prop="code" required>
            <el-input
              v-model="formData.code"
              placeholder="目标系统"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="任务模板" prop="code" required>
            <el-input
              v-model="formData.code"
              placeholder="任务模板"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="取数表单" prop="code" required>
            <el-input
              v-model="formData.code"
              placeholder="取数表单"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="启用状态" prop="code" required>
            <el-input
              v-model="formData.code"
              placeholder="启用状态"
              :style="{ width: '100%' }"
