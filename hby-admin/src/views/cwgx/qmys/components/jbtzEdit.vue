<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="预算任务" prop="organization">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="调整人" prop="code">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="调整日期" prop="province">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="审批人" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="审批人"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="审批日期" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="审批日期"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="审批意见" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="审批意见"
              type="textarea"
        ...
        <el-col :span="24">
          ...
          <el-table>
            ...
            <el-table-column label="指标" prop="province" />
            <el-table-column label="其他维度" prop="province" />
            <el-table-column label="调整前数据" prop="province" />
            <el-table-column label="调整数据" prop="province" />
            <el-table-column label="调整后数据" prop="province" />
            <el-table-column label="调整意见" prop="province" />
          </el-table>
        </el-col>
      </el-form>
    </el-row>
