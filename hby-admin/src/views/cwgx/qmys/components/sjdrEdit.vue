<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="任务名称" prop="organization" required>
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="应用模型" prop="name" required>
            <el-input v-model="formData.name" placeholder="应用模型" />
          </el-form-item>
        </el-col>

        <el-col :span="12">
          <el-form-item label="数据来源账套" prop="code">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="来源表" prop="province" required>
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="来源表过滤条件" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="来源表过滤条件"
              :style="{ width: '100%' }"
        ...
        <el-col :span="24">
          <el-table>
            <el-table-column label="序号" prop="province" />
            <el-table-column label="任务维度" prop="province" />
            <el-table-column label="匹配方式" prop="province" />
            <el-table-column label="来源字段" prop="province" />
            <el-table-column label="档案组织编码字段" prop="province" />
            <el-table-column label="指标类型" prop="province" />
            <el-table-column label="科目表" prop="province" />
          </el-table>
        </el-col>
      </el-form>
    </el-row>
