          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              >
                ...
                <el-option label="所有用户" value="2"></el-option>
              </el-select>
              <el-select
                v-model="queryForm.jsFinance1"
                clearable
                v-if="item.name === '计算类型'"
              >
                <el-option label="取数" value="1"></el-option>
                <el-option label="单表测算" value="2"></el-option>
                <el-option label="多表计算" value="3"></el-option>
                <el-option label="全表计算" value="4"></el-option>
                <el-option label="规则计算" value="5"></el-option>
              </el-select>
              <el-select
                v-model="queryForm.jsFinance2"
                clearable
                v-if="item.name === '执行状态'"
              >
...
<script>
  ...
  import Edit from './components/bbcxEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-jsgl-jsjkt-search',
        tableKey: 'globalTreasurer-jsgl-jsjkt-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          { name: '用户', key: 'jsFinance' },
          { name: '计算类型', key: 'jsFinance1' },
          { name: '执行状态', key: 'jsFinance2' },
          { name: '作业名称', key: 'supplier' },
        ]
      },
