...
<template>
  <div class="system-log-container">
    <div class="lr-layout">
      <div class="left">
        <czggTree @iconClick="iconClick" :show-type="false" />
      </div>
      <div class="right">
                ...
                <el-table :data="tableData" border style="width: 100%">
                  ...
                  >
                    <template slot-scope="scope">
                      <el-input
                        v-model="scope.row.dimensionName"
                        placeholder="请输入维度名称"
                        size="small"
                      ></el-input>
                    </template>
                  ...
                  <el-table-column
                    label="汇总结构"
                    prop="summaryStructure"
                    align="center"
                  >
                    <template slot-scope="scope">
                      <el-input
                        v-model="scope.row.summaryStructure"
                        placeholder="请输入汇总结构"
                        size="small"
                      ></el-input>
                    </template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgl-srgl-yymxqj-search',
        tableKey: 'cwgl-srgl-yymxqj-list',
        searchMore: false,
        showEdit: false,
        dialogVisible: false,
        form: {
...
<style scoped lang="scss">
  ...
  .form-section .el-form-item.is-required .el-form-item__label:before {
    content: '*';
    color: #f56c6c;
    margin-right: 4px;
  }
