  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="合计金额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="合计金额"
              type="textarea"
        ...
        <el-col :span="24">
          <div class="dialog-add">
            <div>
              <span>行程明细 ({{ tableData.length }})</span>
              <span style="margin-left: 18px">
                共 {{ selectionLength.length }}条
              </span>
            </div>
            <div>
        ...
        <el-col :span="24">
          <div class="dialog-add">
            <div>
              <span>交通费用 ({{ tableData.length }})</span>
              <span style="margin-left: 18px">
        ...
        <el-col :span="24">
          <div class="dialog-add">
            <div>
              <span>住宿费用 ({{ tableData.length }})</span>
              <span style="margin-left: 18px">
                共 {{ selectionLength.length }}条，合计 {{ total }} 元
              </span>
            </div>
        ...
        <el-col :span="24">
          <div class="dialog-add">
            <div>
              <span>餐饮补贴 ({{ tableData.length }})</span>
              <span style="margin-left: 18px">
                共 {{ selectionLength.length }}条，合计 {{ total }} 元
              </span>
            </div>
        ...
        <el-col :span="24">
          <div class="dialog-add">
            <div>
              <span>出差补贴 ({{ tableData.length }})</span>
              <span style="margin-left: 18px">
                共 {{ selectionLength.length }}条，合计 {{ total }} 元
              </span>
            </div>
