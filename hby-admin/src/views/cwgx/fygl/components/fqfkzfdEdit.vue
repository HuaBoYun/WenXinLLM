<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="报销单位" prop="name">
            <el-input v-model="formData.name" placeholder="报销单位" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="单据日期" prop="organization">
            <el-date-picker
        ...
        <el-col :span="12">
          <el-form-item label="交易类型" prop="code">
            <el-input
