...
<script>
  ...
  import Edit from './components/djcxEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-djcx-search',
        tableKey: 'cwgx-fygl-djcx-list',
        searchMore: false,
        select: [],
        options_1: [
          {
    ...
    methods: {
      getFiled() {
        return [
          { name: '财务组织', key: 'startStatus' },
          { name: '单据日期', key: 'startStatus' },
          { name: '交易类型', key: 'startStatus' },
          { name: '单据状态', key: 'startStatus2' },
          { name: '金额开始', key: 'startStatus1' },
          { name: '金额结束', key: 'startStatus1' },
          { name: '审批状态', key: 'startStatus1' },
