  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">快速复制</el-button>
            ...
            <el-dropdown style="margin-left: 10px">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item>
                  ...
                  <el-button type="text" :disabled="!!scope.row.spzt">
                    启用
                  </el-button>
                  <el-button type="text" :disabled="!!scope.row.spzt">
                    停用
...
<script>
  ...
  import Edit from './components/zntdgzzzEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-zntdgzzz-search',
        tableKey: 'cwgx-fygl-zntdgzzz-list',
        searchMore: false,
        select: [],
        invoiceOptions: [
          {
    ...
    methods: {
      getFiled() {
        return [
          { name: '业务单元', key: 'sxName' },
          { name: '交易类型', key: 'sxName' },
          { name: '发票类型', key: 'startStatus' },
          { name: '发票税目', key: 'startStatus1' },
          { name: '收支项目', key: 'startStatus2' },
          { name: '启用状态', key: 'startStatus2' },
        ]
      },
