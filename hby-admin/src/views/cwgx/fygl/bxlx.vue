...
<template>
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <div class="top__bpx">
        <el-checkbox v-model="queryForm.isblockup">显示停用</el-checkbox>
...
<script>
  ...
  import Edit from './components/bxlxEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-bxlx-search',
        tableKey: 'cwgx-fygl-bxlx-list',
        searchMore: false,
        select: [],
        treeData: [
          {
