...
<script>
  ...
  import Edit from './components/clfbxdEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-clfbxd-search',
        tableKey: 'cwgx-fygl-clfbxd-list',
        searchMore: false,
        select: [],
        options_1: [
          {
