  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-bmfymxcx-search',
        tableKey: 'cwgx-fygl-bmfymxcx-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          { name: '费用承担单位', key: 'sxName' },
          { name: '单据日期', key: 'startStatus' },
          { name: '费用承担部门', key: 'startStatus1' },
