  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-bxrfymxzhcx-search',
        tableKey: 'cwgx-fygl-bxrfymxzhcx-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          { name: '承担单位', key: 'sxName' },
          { name: '单据日期', key: 'startStatus' },
          { name: '报销人', key: 'startStatus1' },
          { name: '明细账状态', key: 'startStatus2' },
        ]
      },
