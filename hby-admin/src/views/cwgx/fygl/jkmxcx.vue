  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <!-- <el-button type="primary">联查借款明细</el-button> -->
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-jkmxcx-search',
        tableKey: 'cwgx-fygl-jkmxcx-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '借款人部门', key: 'startStatus1' },
          { name: '借款人', key: 'startStatus2' },
