  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">生成凭证</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-ympz-search',
        tableKey: 'cwgx-fygl-ympz-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          { name: '借款报销单位', key: 'sxName' },
          { name: '单据编号', key: 'startStatus' },
          { name: '单据日期', key: 'startStatus1' },
        ]
      },
