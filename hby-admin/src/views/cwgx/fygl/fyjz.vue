  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <div class="search-box">
        <div>
          <el-radio v-model="queryForm.jiez" label="1">可结账</el-radio>
          <el-radio v-model="queryForm.jiez" label="2">可取消结账</el-radio>
        </div>
        <div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-fyjz-search',
        tableKey: 'cwgx-fygl-fyjz-list',
        searchMore: false,
        select: [],
        options_1: [
          {
    ...
    methods: {
      getFiled() {
        return [{ name: '财务组织', key: 'startStatus' }]
      },
