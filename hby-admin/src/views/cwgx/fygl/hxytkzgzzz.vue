...
<script>
  ...
  import Edit from './components/hxytkzgzzzEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-hxytkzgzzz-search',
        tableKey: 'cwgx-fygl-hxytkzgzzz-list',
        searchMore: false,
        select: [],
        treeData: [
          {
