  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <div class="search-box">
        <div>
          <el-checkbox>显示关帐</el-checkbox>
          <el-checkbox>显示未关帐</el-checkbox>
        </div>
        <div>
...
<script>
  ...
  import Edit from './components/jkqcdjEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-fygl-fygz-search',
        tableKey: 'cwgx-fygl-fygz-list',
        searchMore: false,
        select: [],
        options_1: [
          {
