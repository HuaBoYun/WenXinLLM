  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary" @click="handleTradeEdit(false, false)">
          交易类型
        </el-button>
        <el-button type="primary" @click="handleAccountsEdit(false, false)">
          期初建账
        </el-button>
        <el-button type="primary" @click="handleCloseEdit(false, false)">
          取消期初建账
        </el-button>
    ...
    <tradeTypeEdit ref="tradeEdit" />
    <accountsEdit ref="accountsEdit" />
    <closeAccountsEdit ref="closeEdit" />
  </div>
</template>
...
<script>
  ...
  import Edit from './components/ysqcEdit'
  import tradeTypeEdit from './components/tradeTypeEdit'
  import accountsEdit from './components/accountsEdit'
  import closeAccountsEdit from './components/closeAccountsEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-ysqc-search',
        tableKey: 'cwgx-ysgl-ysqc-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      ...
      handleTradeEdit(row, disabled, type) {
        this.$refs['tradeEdit'].showTradeEdit(row, disabled, this.planNum, type)
      },
      handleAccountsEdit(row, disabled, type) {
        this.$refs['accountsEdit'].showAccountsEdit(
          row,
          disabled,
          this.planNum,
          type
      ...
      handleCloseEdit(row, disabled, type) {
        this.$refs['closeEdit'].showCloseEdit(row, disabled, this.planNum, type)
      },
