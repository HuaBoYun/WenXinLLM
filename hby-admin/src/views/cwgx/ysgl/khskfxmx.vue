...
<template>
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list" style="margin-top: 45px">
        <el-table-column
          align="center"
          label="序号"
          prop="qdcode"
        ...
        <el-table-column
          ...
          show-overflow-tooltip
        />
        <el-table-column label="收款合计" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="projectOrderName"
        ...
        <el-table-column label="已核销收款" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="projectOrderName"
        ...
        <el-table-column label="收款余额" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="projectOrderName"
        ...
        <el-table-column label="预收余额" align="center">
          <el-table-column
            align="center"
            label="原币"
            prop="projectOrderName"
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-khskfxmx-search',
        tableKey: 'cwgx-ysgl-khskfxmx-list',
        searchMore: false,
        select: [],
      }
    },
