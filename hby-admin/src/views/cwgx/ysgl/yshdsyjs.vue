...
<script>
  ...
  import Edit from './components/yshdsyjsEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-ysgl-yshdsyjs-search',
        tableKey: 'globalTreasurer-ysgl-yshdsyjs-list',
        searchMore: false,
        select: [],
      }
    },
