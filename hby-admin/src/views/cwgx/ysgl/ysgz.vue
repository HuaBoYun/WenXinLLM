  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">关帐</el-button>
        <el-button type="primary">反关帐</el-button>
        <el-button type="primary">关帐检查</el-button>
    ...
    <el-card shadow="never" class="secondCard">
      <div class="title_box_2">
        <div class="box_1">关帐期间明细展示 （0）</div>
        <el-input
          v-model="queryForm.supplier"
          clearable
          placeholder="会计期间"
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-ysgz-search',
        tableKey: 'cwgx-ysgl-ysgz-list',
        searchMore: false,
        select: [],
      }
    },
