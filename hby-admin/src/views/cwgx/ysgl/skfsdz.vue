...
<script>
  ...
  import Edit from './components/skfsdzEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-skfsdz-search',
        tableKey: 'cwgx-ysgl-skfsdz-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '部门', key: 'startStatus' },
          { name: '结算方式', key: 'startStatus1' },
          { name: '收付款类型', key: 'startStatus2' },
        ]
      },
