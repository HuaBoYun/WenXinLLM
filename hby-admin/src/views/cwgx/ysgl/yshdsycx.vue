  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">取消损益</el-button>
        <el-button type="primary">联查明细</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-yshdsycx-search',
        tableKey: 'cwgx-ysgl-yshdsycx-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '客户', key: 'startStatus' },
          { name: '交易类型', key: 'startStatus1' },
          { name: '本币', key: 'startStatus2' },
          { name: '单据编号', key: 'startStatus2' },
          { name: '日期', key: 'startStatus2' },
          { name: '本币差额', key: 'startStatus2' },
