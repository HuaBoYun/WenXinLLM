  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">自动核销</el-button>
        <el-button type="primary">核销查询</el-button>
        <el-button type="primary">按借方匹配</el-button>
        <el-button type="primary">按贷方匹配</el-button>
      </vab-query-form-right-panel>

      <div class="title_box">
        <div class="title_1">本方 (0)</div>
        <div>已选 0 条</div>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-yshx-search',
        tableKey: 'cwgx-ysgl-yshx-list',
        searchMore: false,
        select: [],
        options_1: [
          {
