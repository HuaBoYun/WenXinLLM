  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary" @click="handleDeal()">交易类型</el-button>
    ...
    <dealTypeEdit ref="dealEdit"></dealTypeEdit>
...
<script>
  ...
  import Edit from './components/skqcEdit'
  import dealTypeEdit from './components/dealTypeEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-skqc-search',
        tableKey: 'cwgx-ysgl-skqc-list',
        searchMore: false,
        select: [],
      }
    },
