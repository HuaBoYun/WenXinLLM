  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">批量关帐</el-button>
        <el-button type="primary">批量反关帐</el-button>
      </vab-query-form-right-panel>

      <div style="margin-bottom: 10px">
        <el-checkbox v-model="queryForm.supplier">显示关帐</el-checkbox>
        <el-checkbox v-model="queryForm.supplier">显示未关帐</el-checkbox>
      </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-ysplgz-search',
        tableKey: 'cwgx-ysgl-ysplgz-list',
        searchMore: false,
        select: [],
      }
    },
