  ...
  <div class="system-log-container">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-date-picker
                ...
                type="date"
                placeholder="计提开始时间"
                v-if="item.name === '计提开始时间'"
              ></el-date-picker>
              <el-date-picker
                v-model="queryForm.supplier"
                type="date"
                placeholder="计提结束时间"
                v-if="item.name === '计提结束时间'"
              ></el-date-picker>
              <el-select
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">计提</el-button>
        <el-button type="primary">取消计提</el-button>
        <el-button type="primary">个别计提</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-hzjtgbjt-search',
        tableKey: 'cwgx-ysgl-hzjtgbjt-list',
        searchMore: false,
        select: [],
        options_1: [
          {
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '计提开始时间', key: 'startStatus' },
          { name: '计提结束时间', key: 'startStatus1' },
          { name: '计提状态', key: 'startStatus2' },
