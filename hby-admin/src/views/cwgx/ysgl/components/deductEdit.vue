      ...
      <el-form ref="ruleForm" :model="formData" :rules="rules" size="mini">
        ...
        <el-col :span="8">
          <el-form-item prop="code">
            <el-input v-model="formData.code" placeholder="单据编号" />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item prop="code">
            <el-input v-model="formData.code" placeholder="客户" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item prop="name">
            <el-date-picker
              ...
              unlink-panels
              range-separator="至"
              start-placeholder="结转日期开始日期"
              end-placeholder="结转日期结束日期"
              style="width: 100%"
            ></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item prop="name">
            <el-date-picker
              ...
              unlink-panels
              range-separator="至"
              start-placeholder="信用日期开始日期"
              end-placeholder="信用日期结束日期"
              style="width: 100%"
            ></el-date-picker>
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-table :data="tableData" style="width: 100%">
            <el-table-column prop="date" label="财务组织"></el-table-column>
            <el-table-column prop="name" label="单据编号"></el-table-column>
            <el-table-column
              prop="address"
              label="单据表体行号"
            ></el-table-column>
            ...
            <el-table-column prop="address" label="单据日期"></el-table-column>
            <el-table-column prop="address" label="物料"></el-table-column>
            <el-table-column prop="address" label="币种"></el-table-column>
            <el-table-column prop="address" label="本币汇率"></el-table-column>
            <el-table-column prop="address" label="起算日期"></el-table-column>
            <el-table-column
              prop="address"
              label="信用到期日"
            ></el-table-column>
            ...
            <el-table-column prop="address" label="本币金额"></el-table-column>
            <el-table-column
              prop="address"
              label="单据表体行号"
            ></el-table-column>
