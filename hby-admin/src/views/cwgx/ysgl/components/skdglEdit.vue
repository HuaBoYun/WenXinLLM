      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="客户" prop="status">
            <el-input v-model="formData.status" placeholder="客户" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="供应商" prop="status">
            <el-input v-model="formData.status" placeholder="供应商" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="结算状态" prop="status">
            <el-input v-model="formData.status" placeholder="结算状态" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            <el-col :span="12">
              <el-form-item label="结算方式" prop="creator">
                <el-input v-model="formData.creator" placeholder="结算方式" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="付款银行账户" prop="createDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="收款银行账户" prop="updateDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="现金账户" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  placeholder="现金账户"
                />
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow2">
            ...
            <el-col :span="12">
              <el-form-item label="支付日期" prop="updateDate">
                <el-date-picker
                  v-model="formData.receiptsDate"
                  type="date"
                  placeholder="支付日期"
            ...
            <el-col :span="12">
              <el-form-item label="正式打印人" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  placeholder="正式打印人"
                />
