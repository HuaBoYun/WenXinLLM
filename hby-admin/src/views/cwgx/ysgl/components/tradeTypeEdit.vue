      ...
      <el-form ref="ruleForm" :model="formData" :rules="rules" size="mini">
        <el-col :span="6">
          <el-form-item prop="name">
            <el-input v-model="formData.name" placeholder="交易类型参照" />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-table :data="tableData" style="width: 100%">
            <el-table-column prop="date" label="交易类型编码"></el-table-column>
            <el-table-column prop="name" label="交易类型名称"></el-table-column>
          </el-table>
          <el-pagination
            background
