  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">取消核销并红冲</el-button>
        <el-button type="primary">单据追溯</el-button>
      </vab-query-form-right-panel>

      <div style="margin-bottom: 10px">单据列表 (0)</div>
    ...
    <el-card style="margin-top: 15px">
      <div style="margin-bottom: 10px">核销结果 (0)</div>
      <el-table v-loading="listLoading" :data="list">
        <el-table-column
          align="center"
          label="序号"
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-qxhxbhc-search',
        tableKey: 'cwgx-ysgl-qxhxbhc-list',
        searchMore: false,
        select: [],
        options_1: [
          {
