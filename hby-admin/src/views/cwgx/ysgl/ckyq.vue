...
<script>
  ...
  import Edit from './components/ckyqEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        currProjectId: '',
        filedAll: [{ name: '编码' }, { name: '币种' }, { name: '类型' }], //所有表格项
        filedNow: [], //当前表格项
        searchAll: this.getFiled(), //所有搜索项
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-ckyq-search',
        tableKey: 'cwgx-ysgl-ckyq-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '编码', key: 'startStatus' },
          { name: '名称', key: 'startStatus1' },
          { name: '币种', key: 'startStatus2' },
          { name: '类型', key: 'startStatus2' },
        ]
      },
