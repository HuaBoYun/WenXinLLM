...
<script>
  ...
  import Edit from './components/deductEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-yszbjkc-search',
        tableKey: 'cwgx-ysgl-yszbjkc-list',
        searchMore: false,
        select: [],
      }
    },
