...
<script>
  ...
  import Edit from './components/yszbjjzEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-yszbjjz-search',
        tableKey: 'cwgx-ysgl-yszbjjz-list',
        searchMore: false,
        select: [],
        options_1: [
          {
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '结转日期', key: 'startStatus' },
          { name: '结转单号', key: 'startStatus1' },
          { name: '单据状态', key: 'startStatus2' },
          { name: '审批状态', key: 'startStatus2' },
        ]
      },
