  ...
  <div class="system-log-container">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              <el-date-picker
                ...
                type="date"
                placeholder="版本化开始时间"
                v-if="item.name === '版本化开始时间'"
              ></el-date-picker>
              <el-date-picker
                v-model="queryForm.jsFinance"
                type="date"
                placeholder="版本化结束时间"
                v-if="item.name === '版本化结束时间'"
              ></el-date-picker>
              <el-input
                v-model="queryForm.jsFinance"
                clearable
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">版本化</el-button>
        <el-button type="primary">取消本版化</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-hzjtblszjt-search',
        tableKey: 'cwgx-ysgl-hzjtblszjt-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          { name: '版本化开始时间', key: 'sxName' },
          { name: '版本化结束时间', key: 'startStatus' },
          { name: '计提规则', key: 'startStatus1' },
        ]
      },
