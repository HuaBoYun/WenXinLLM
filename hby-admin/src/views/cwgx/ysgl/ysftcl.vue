  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">分摊</el-button>
        <el-button type="primary">取消分摊</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'globalTreasurer-ysgl-ysftcl-search',
        tableKey: 'globalTreasurer-ysgl-ysftcl-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '日期', key: 'startStatus' },
          { name: '单据号', key: 'startStatus1' },
          { name: '客户', key: 'startStatus2' },
          { name: '期间分摊规则', key: 'startStatus2' },
        ]
      },
