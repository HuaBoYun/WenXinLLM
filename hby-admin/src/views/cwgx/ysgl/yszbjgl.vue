  ...
  <div class="system-log-container">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-date-picker
                ...
                unlink-panels
                range-separator="至"
                start-placeholder="信用日期开始"
                end-placeholder="信用日期结束"
                v-if="item.name === '信用日期'"
              ></el-date-picker>
            </el-form-item>
            <el-form-item>
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <el-button type="primary">质保金结转</el-button>
        <el-button type="primary">质保金扣除</el-button>
        <el-button type="primary">冻结</el-button>
        <el-button type="primary">解除</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-ysgl-yszbjgl-search',
        tableKey: 'cwgx-ysgl-yszbjgl-list',
        searchMore: false,
        select: [],
        instructList: [
          {
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '质保金状态', key: 'startStatus1' },
          { name: '供应商', key: 'startStatus2' },
          { name: '信用日期', key: 'startStatus2' },
        ]
      },
