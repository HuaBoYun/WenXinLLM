...
<template>
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list" class="table-box">
        <el-table-column
          type="selection"
          width="55"
          align="center"
...
<script>
  ...
  import Edit from './components/yfdjxtszEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-yfdjxtsz-search',
        tableKey: 'cwgx-yfgl-yfdjxtsz-list',
        searchMore: false,
        select: [],
      }
    },
