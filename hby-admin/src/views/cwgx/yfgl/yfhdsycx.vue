  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel style="width: 100%">
        ...
        <!-- <el-button type="success" @click="handleEdit(false, false)"> 新建 </el-button> -->
...
<script>
  ...
  import Edit from './components/fkbzcxEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-yfhdsycx-search',
        tableKey: 'cwgx-yfgl-yfhdsycx-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '供应商', key: 'sxName' },
          { name: '损益类型', key: 'sxName' },
          { name: '汇总查询', key: 'sxName' },
          { name: '交易类型', key: 'sxName' },
          { name: '币种', key: 'sxName' },
          { name: '单据编号', key: 'sxName' },
          { name: '时间', key: 'startStatus' },
          { name: '本币差额', key: 'startStatus1' },
          { name: '组织本币', key: 'startStatus2' },
        ]
      },
