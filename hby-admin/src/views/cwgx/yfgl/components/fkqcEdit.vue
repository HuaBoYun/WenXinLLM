<template>
  ...
  >
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="付款财务组织" prop="organization">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="供应商" prop="phone">
            <el-select
              v-model="formData.value"
              placeholder="供应商"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="客户" prop="address">
            <el-select
              v-model="formData.value"
              placeholder="客户"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="部门" prop="status">
            <el-input v-model="formData.status" placeholder="部门" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="业务员" prop="status">
            <el-input v-model="formData.status" placeholder="业务员" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="付款类型" prop="status">
        ...
        <el-col :span="12">
          <el-form-item label="币种" prop="status">
            <el-input v-model="formData.status" placeholder="币种" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="组织本币汇率" prop="status">
            <el-input v-model="formData.status" placeholder="组织本币汇率" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="组织本币金额" prop="status">
            <el-input v-model="formData.status" placeholder="组织本币金额" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="付款银行账户" prop="status">
            <el-input v-model="formData.status" placeholder="付款银行账户" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="收款银行账户" prop="status">
            <el-input v-model="formData.status" placeholder="收款银行账户" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="现金账户" prop="status">
            <el-input v-model="formData.status" placeholder="现金账户" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            <el-col :span="12">
              <el-form-item label="审核人" prop="creator">
                <el-input v-model="formData.creator" placeholder="审核人" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="审批日期" prop="updateCreator">
                <el-date-picker
                  v-model="formData.receiptsDate"
                  type="date"
                  placeholder="选择日期"
            ...
            <el-col :span="12">
              <el-form-item label="生效人" prop="createDate">
                <el-input v-model="formData.createDate" placeholder="生效人" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-col :span="12">
              <el-form-item label="签字确认人" prop="updateDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="签字确认日期" prop="updateDate">
                <el-date-picker
                  v-model="formData.receiptsDate"
                  type="date"
                  placeholder="签字确认日期"
            ...
            <el-col :span="12">
              <el-form-item label="支付人" prop="updateDate">
                <el-input v-model="formData.updateDate" placeholder="支付人" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="正式打印日期" prop="updateDate">
                <el-date-picker
                  v-model="formData.receiptsDate"
                  type="date"
                  placeholder="正式打印日期"
            ...
            <el-col :span="12">
              <el-form-item label="单据确认人" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  placeholder="单据确认人"
                />
            ...
            <el-col :span="12">
              <el-form-item label="单据来源系统" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  placeholder="单据来源系统"
                />
