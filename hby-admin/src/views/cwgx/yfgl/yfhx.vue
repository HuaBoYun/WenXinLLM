  ...
  export default {
    ...
    data() {
      return {
        ...
        currProjectId: '',
        filedAll: [
          { name: '往来对象', key: 'sxName' },
          { name: '供应商', key: 'startStatus' },
          { name: '交易类型', key: 'startStatus1' },
          { name: '单据编号', key: 'startStatus2' },
          { name: '单据日期', key: 'startStatus2' },
          { name: '币种', key: 'startStatus2' },
          { name: '表头原币金额', key: 'startStatus2' },
          { name: '原币金额', key: 'startStatus2' },
          { name: '本次折扣', key: 'startStatus2' },
          { name: '本次结算', key: 'startStatus2' },
        ], //所有表格项
        filedNow: [], //当前表格项
        searchAll: this.getFiled(), //所有搜索项
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-yfhx-search',
        tableKey: 'cwgx-yfgl-yfhx-list',
        searchMore: false,
        select: [],
      }
    },
