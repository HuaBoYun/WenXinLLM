    ...
    data() {
      return {
        ...
        filedAll: [
          ...
          { name: '借方原币金额', key: 'startStatus2' },
          { name: '借方本币金额', key: 'startStatus2' },
          { name: '供应商', key: 'startStatus2' },
          { name: '客户', key: 'startStatus2' },
          { name: '部门', key: 'startStatus2' },
          { name: '业务员', key: 'startStatus2' },
          { name: '单据类型', key: 'startStatus2' },
          { name: '业务流程', key: 'startStatus2' },
          { name: '录入人', key: 'startStatus2' },
        ], //所有表格项
        filedNow: [], //当前表格项
        searchAll: this.getFiled(), //所有搜索项
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-qxhxbhch-search',
        tableKey: 'cwgx-yfgl-qxhxbhch-list',
        searchMore: false,
        select: [],
      }
    },
