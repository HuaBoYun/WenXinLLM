  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-fkbzzx-search',
        tableKey: 'cwgx-yfgl-fkbzzx-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '转出对象', key: 'startStatus1' },
          { name: '供应商', key: 'startStatus1' },
          { name: '部门', key: 'startStatus2' },
          { name: '业务员', key: 'startStatus2' },
          { name: '币种', key: 'startStatus2' },
          { name: '付款类型', key: 'startStatus2' },
          { name: '利润中心', key: 'startStatus2' },
          { name: '时间', key: 'startStatus2' },
