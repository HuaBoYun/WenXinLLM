          ...
          >
            ...
            <el-form-item>
              <el-radio-group v-model="queryForm.radio">
                <el-radio :label="3">待结账</el-radio>
                <el-radio :label="6">可取消结账</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item>
              <el-button
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-yfjzjz-search',
        tableKey: 'cwgx-yfgl-yfjzjz-list',
        searchMore: false,
        select: [],
      }
    },
