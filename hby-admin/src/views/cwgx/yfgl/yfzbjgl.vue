          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-date-picker
                ...
                unlink-panels
                range-separator="至"
                start-placeholder="信用到期日开始日期"
                end-placeholder="信用到期日结束日期"
                v-if="item.name === '信用到期时间'"
              ></el-date-picker>
            </el-form-item>
            <el-form-item>
              <el-button
...
<script>
  ...
  import Edit from './components/zgyfdglEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-yfzbjgl-search',
        tableKey: 'cwgx-yfgl-yfzbjgl-list',
        searchMore: false,
        select: [],
      }
    },
