...
<script>
  ...
  import Edit from './components/yfqcEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-yfftcl-search',
        tableKey: 'cwgx-yfgl-yfftcl-list',
        searchMore: false,
        select: [],
      }
    },
