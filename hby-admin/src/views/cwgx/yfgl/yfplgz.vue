          ...
          >
            ...
            <el-form-item>
              <el-radio-group v-model="queryForm.radio">
                <el-radio :label="3">显示关账</el-radio>
                <el-radio :label="6">显示未关账</el-radio>
              </el-radio-group>
            </el-form-item>
            <el-form-item>
              <el-button
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-yfplgz-search',
        tableKey: 'cwgx-yfgl-yfplgz-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          { name: '组织名称方案', key: 'sxName' },
          { name: '组织名称', key: 'sxName' },
          { name: '组织', key: 'sxName' },
        ]
      },
