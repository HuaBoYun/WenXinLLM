...
<template>
  <div class="system-log-container">
          ...
          >
            <el-form-item v-for="(item, index) in searchItem" :key="index">
              ...
              <el-date-picker
                ...
                unlink-panels
                range-separator="至"
                start-placeholder="会计期间开始日期"
                end-placeholder="会计期间结束日期"
                v-if="item.name === '时间'"
              ></el-date-picker>
            </el-form-item>
            <el-form-item>
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="业务模块" name="first"></el-tab-pane>
    </el-tabs>
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgx-yfgl-yfgz-search',
        tableKey: 'cwgx-yfgl-yfgz-list',
        searchMore: false,
        select: [],
        activeName: 'first',
      }
