...
<script>
  ...
  import Edit from './components/srqrdEdit'
  ...
  export default {
    ...
    data() {
      return {
        ...
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        localKey: 'cwgl-srgl-dysrqrd-search',
        tableKey: 'cwgl-srgl-dysrqrd-list',
        searchMore: false,
        select: [],
      }
    },
    ...
    methods: {
      getFiled() {
        return [
          ...
          { name: '收入类型', key: 'startStatus2' },
          { name: '客户', key: 'startStatus3' },
        ]
      },
