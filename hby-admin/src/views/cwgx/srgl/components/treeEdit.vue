  ...
  >
    <el-row :gutter="24">
      ...
      >
        ...
        <el-col :span="24">
          <el-form-item label="启用状态" prop="province">
            <el-input
        ...
        <el-col :span="24">
          <el-form-item label="尾差处理方式" prop="city">
            <el-input
              v-model="formData.city"
              placeholder="请输入尾差处理方式"
              :style="{ width: '100%' }"
            />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="收入分摊类别" prop="city">
            <el-input
              v-model="formData.city"
              placeholder="请输入收入分摊类别"
              :style="{ width: '100%' }"
            />
          </el-form-item>
        </el-col>
        <el-col :span="24">
          <el-form-item label="成本来源" prop="city">
            <el-input
              v-model="formData.city"
              placeholder="请输入成本来源"
              :style="{ width: '100%' }"
        ...
        <el-col :span="24">
          <el-form-item label="会计科目编码" prop="city">
            <el-input
              v-model="formData.city"
