  ...
  >
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="收入确认类型" prop="province">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="收入类型" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="收入类型"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="业务流程" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="业务流程"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="原币价税合计" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="原币价税合计"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="原币税额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="原币税额"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="本币价税合计" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="本币价税合计"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="本币税额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="本币税额"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="集团本币汇率" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="集团本币汇率"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="集团本币无税金额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="集团本币无税金额"
              type="textarea"
              :style="{ width: '100%' }"
            />
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="集团本币价税合计" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="集团本币价税合计"
              type="textarea"
              :style="{ width: '100%' }"
            />
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="集团本币税额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="集团本币税额"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="全局本币汇率" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="全局本币汇率"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="全局本币无税金额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="全局本币无税金额"
              type="textarea"
              :style="{ width: '100%' }"
            />
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="全局本币价税合计" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="全局本币价税合计"
              type="textarea"
              :style="{ width: '100%' }"
            />
          </el-form-item>
        ...
        <el-col :span="12">
          <el-form-item label="全局本币税额" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="全局本币税额"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="收入性质" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="收入性质"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="红冲标志" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="红冲标志"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="期初标志" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="期初标志"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="单据状态" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="单据状态"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="审批状态" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="审批状态"
              type="textarea"
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            <el-col :span="12">
              <el-form-item label="客户" prop="creator">
                <el-input v-model="formData.creator" placeholder="客户" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="散户" prop="createDate">
                <el-input v-model="formData.createDate" placeholder="散户" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            ...
            <el-col :span="12">
              <el-form-item label="本币汇率" prop="createDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="原币无税金额" prop="updateDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="本币无税金额" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  placeholder="本币无税金额"
                />
