      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="合同编码" prop="name">
            <el-input v-model="formData.name" placeholder="合同编码" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="合同类型" prop="province">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="上级合同" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="上级合同"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="版本号" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="版本号"
              :style="{ width: '100%' }"
        ...
        <el-col :span="12">
          <el-form-item label="部门" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="部门"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="人员" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="人员"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="期初" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="期初"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="总数量" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="总数量"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="价税合计" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="价税合计"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="收入确认政策" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="收入确认政策"
              type="textarea"
        ...
        <el-col :span="12">
          <el-form-item label="销售渠道" prop="province">
            <el-input
              v-model="formData.province"
              placeholder="销售渠道"
              type="textarea"
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            <el-col :span="12">
              <el-form-item label="合同签订日期" prop="creator">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="计划生效日期" prop="createDate">
                <el-input
            ...
            <el-col :span="12">
              <el-form-item label="计划终止日期" prop="updateDate">
                <el-input
        ...
        <el-col :span="24">
          ...
          <template v-if="isUnfoldAuditShow">
            ...
            <el-col :span="12">
              <el-form-item label="汇率" prop="createDate">
                <el-input v-model="formData.createDate" placeholder="汇率" />
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="本币价税合计" prop="updateDate">
                <el-input
                  v-model="formData.updateDate"
                  placeholder="本币价税合计"
                />
