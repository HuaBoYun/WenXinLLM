<template>
  <div class="system-log-container">
    <el-row :gutter="20" v-loading="loading">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/gkzt/statement')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/gkzt/subject')">
            <vab-icon icon="kemu" is-custom-svg />
            <p>科目表</p>
          </div>
          <div class="line-item" @click="goTo('/gkzt/balance')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/gkzt/accountCate')">
            <vab-icon icon="zongzhang" is-custom-svg />
            <p>总分类账</p>
          </div>
          <div class="line-item" @click="goTo('/gkzt/accountDetail')">
            <vab-icon icon="mingxi" is-custom-svg />
            <p>明细账</p>
          </div>
          <div class="line-item" @click="goTo('/gkzt/accountDiary')">
            <vab-icon icon="jizhang" is-custom-svg />
            <p>日记账</p>
          </div>
          <div class="line-item" @click="goTo('/gkzt/accountAssist')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/gkzt/voucherLib')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/gkzt/accountManage')">
