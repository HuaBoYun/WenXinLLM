<template>
  <div class="system-log-container">
    <el-row :gutter="20" v-loading="loading">
      ...
      <el-col :span="4">
        <div class="line-view">
          <!-- <div class="line-item" @click="goTo('/auditSjfx/statement')"> -->
          <div class="line-item">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/auditSjfx/subject')">
            <vab-icon icon="kemu" is-custom-svg />
            <p>科目表</p>
          </div>
          <div class="line-item" @click="goTo('/auditSjfx/balance')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/auditSjfx/accountCate')">
            <vab-icon icon="zongzhang" is-custom-svg />
            <p>总分类账</p>
          </div>
          <div class="line-item" @click="goTo('/auditSjfx/accountDetail')">
            <vab-icon icon="mingxi" is-custom-svg />
            <p>明细账</p>
          </div>
          <div class="line-item" @click="goTo('/auditSjfx/accountDiary')">
            <vab-icon icon="jizhang" is-custom-svg />
            <p>日记账</p>
          </div>
          <div class="line-item" @click="goTo('/auditSjfx/accountAssist')">
      ...
      <el-col :span="4">
        <div class="line-view">
          <div class="line-item" @click="goTo('/auditSjfx/voucherLib')">
