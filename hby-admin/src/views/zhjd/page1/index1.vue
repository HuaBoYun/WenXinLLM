<template>
  <div class="real-time-report-container">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="【本级上报】" name="first">
        <vab-query-form>
          ...
          <vab-query-form-left-panel>
            <span>
              全部：
              <span class="c-blue padding-right-16 border-right">
                {{ allNum }}
              </span>
            </span>
        ...
        <el-table v-loading="listLoading" :data="list">
          ...
          <el-table-column align="center" label="报告日期" prop="data" />
      ...
      <el-tab-pane label="【下级上报】" name="second">
        <vab-query-form>
          <vab-query-form-top-panel>
            <el-form
              ref="form"
...
<script>
  import editModal from './components/editRealTimeReportModal.vue'
