  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      ...
      <el-table v-loading="listLoading" :data="list" @sort-change="sortChange">
        <el-table-column align="center" label="文档名称" prop="dataBaseType">
  ...
  export default {
    ...
    data() {
      return {
        ...
        filedAll: [{ name: '隶属模块' }, { name: '最后修改时间' }], //所有表格项
        filedNow: [],
        searchAll: this.getFiled(), //所有搜索项
        localKey: 'sjzt-Apis-index-search',
        tableKey: 'sjzt-Apis-index-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
        sortFields: '',
