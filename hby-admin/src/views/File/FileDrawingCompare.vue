  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel :span="24">
        ...
        <el-button type="success" @click="handleAdd" v-if="hasAuth('TZDBadd')">
          新建
        </el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'file-file-drawing-compare-search',
        tableKey: 'file-file-drawing-compare-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
        tableData1: [],
