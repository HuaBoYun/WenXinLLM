  ...
  <div class="system-log-container">
    ...
    <el-card shadow="never" class="secondCard">
      <vab-query-form-right-panel :span="24">
        ...
        <el-button type="success" @click="handleAdd" v-if="hasAuth('DBCCadd')">
          新建
        </el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        filedAll: [{ name: '重复指数' }, { name: '创建者' }, { name: '状态' }], //所有表格项
        filedNow: [],
        searchAll: this.getFiled(), //所有搜索项
        localKey: 'file-file-duplicate-check-search',
        tableKey: 'file-file-duplicate-check-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
        tableData1: [],
