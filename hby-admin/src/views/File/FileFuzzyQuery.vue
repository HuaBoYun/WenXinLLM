  ...
  export default {
    ...
    data() {
      return {
        ...
        localKey: 'file-file-fuzzy-query-search',
        tableKey: 'file-file-fuzzy-query-list',
        searchNow: [], //当前所有搜索项
        searchItem: [], //可见搜索项
        searchMore: true,
        tableData1: [],
    ...
    methods: {
      ...
      handleQueryNow(row) {
        this.$confirm(
          `是否确认立即查找文件编号为${row.fileName}的相似度文件?`,
          '提示',
          {
            confirmButtonText: '确定',
            cancelButtonText: '取消',
