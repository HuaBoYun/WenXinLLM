  ...
  <div>
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="整改督促牵头部门或单位" prop="urgeDepartment">
            <el-input
     ...
     -->
        ...
        <el-col :span="12">
          <el-form-item label="整改状态" prop="zgzt">
            <el-select
        ...
        <el-col :span="12">
          <el-form-item label="当期整改金额（元）" prop="dqzgje">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="当期直接经济成果类型" prop="dqzjjjcgtype">
            <el-select
        ...
        <el-col :span="12">
          <el-form-item label="当期直接经济成果（元）" prop="dqzjjjcg">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="当期其他经济成果类型" prop="dqqtjjcgtype">
            <el-select
        ...
        <el-col :span="12">
          <el-form-item label="当期其他经济成果（元）" prop="dqqtjjcg">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="是否移送" prop="sfys">
            <el-select
        ...
        <template v-if="this.formData.sfys == 1">
          <el-col :span="24">
            <el-divider>移送内容</el-divider>
          </el-col>

          <el-col :span="12">
            <el-form-item label="移送处理事项" prop="ysclsx">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="移送处理涉及金额（元）" prop="ysclsjje">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="移送处理人员（人）" prop="ysclr">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="落实移送处理事项" prop="lsysclsx">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="移送处理落实情况（人）" prop="yscllsqk">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="其中涉及党纪处分（人）" prop="sjdjcf">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="其中涉及政务处分（人）" prop="sjzwcf">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="其中涉及内部纪律处分（人）" prop="sjnbjlcf">
              <el-input
          ...
          <el-col :span="12">
            <el-form-item label="其他经济处分（人）" prop="qtjjcf">
              <el-input
          ...
          <!-- <el-col :span="12">
            <el-form-item label="创建人" prop="cjr">
              <el-input
                v-model="formData.tblYqnsSjzgYsnr.cjr"
                disabled
                placeholder="请输入创建人"
                :style="{ width: '100%' }"
              />
          ...
          <el-col :span="12">
            <el-form-item label="创建时间" prop="cjsj">
              <el-date-picker
                v-model="formData.tblYqnsSjzgYsnr.cjsj"
                placeholder="请输入创建时间"
                type="date"
                format="yyyy-MM-dd"
                value-format="yyyy-MM-dd"
        ...
        <el-col :span="24">
          <div style="text-align: right; margin-bottom: 5px">
            <el-button type="success" disabled @click="handleEditTable1(null)">
              新增
            </el-button>
          </div>
          <el-table :data="tableData1">
            ...
            <el-table-column align="center" label="文号" prop="document">
              <template #default="{ row, $index }">
                <el-button
                  type="text"
                  :disabled="false"
                  @click="handleEditTable1(row, true)"
                >
                  {{ row.document }}
                </el-button>
                <!-- <span v-else>
            ...
            >
              <template #default="{ row, $index }">
                <el-button type="text" @click="handleEditTable1(row)" disabled>
                  编辑
                </el-button>
                <el-button
                  type="text"
        ...
        <el-col :span="24">
          <div style="text-align: right; margin-bottom: 5px">
            <el-button type="success" disabled @click="handleEditTable2(null)">
              新增
            </el-button>
          </div>
          <el-table :data="tableData2">
            ...
            >
              ...
              <template #default="{ row, $index }">
                <el-button
                  type="text"
                  :disabled="false"
                  @click="handleEditTable2(row, true)"
                  v-if="row.sjzgtjid"
                >
                  {{ row.zdgzzds }}
                </el-button>
            ...
            >
              <template #default="{ row, $index }">
                <el-button
                  type="text"
                  @click="handleEditTable2(row, false)"
                  disabled
                >
                  编辑
                </el-button>
          ...
          <el-table :data="tableDataGzzdqksm">
            ...
            >
              <template #default="{ row }">
                ...
                <el-button
                  type="text"
                  @click="handlePreviewFileFile(row)"
                  :disabled="false"
                >
                  预览
                </el-button>
        ...
        <el-col :span="24">
          <el-divider>上传审计移送处理文书</el-divider>
        </el-col>
        <el-col :span="24">
          <el-table :data="tableDataWS">
            <el-table-column align="center" label="附件名称" prop="attname" />
            <el-table-column
              align="center"
              label="文件大小(KB)"
        ...
        <el-col :span="24">
          <el-divider>跟踪审计采纳情况</el-divider>
        </el-col>
        <el-col :span="24">
          <!-- <div style="text-align: right; margin-bottom: 5px">
            <el-button
          ...
          <el-table :data="tableData4">
            ...
            <el-table-column
              ...
              show-overflow-tooltip
            ></el-table-column>
            <el-table-column align="center" label="是否采纳" prop="isAdopt">
              <template #default="{ row }">
                <span>
                  {{
                    row.isAdopt == '1' ? '是' : row.isAdopt == '0' ? '否' : ''
                  }}
                </span>
              </template>
            </el-table-column>
          ...
          <el-table :data="tableData5">
            ...
            >
              <template #default="{ row, $index }">
                <el-button
                  type="text"
                  @click="handleEditTable5(row, $index)"
                  :disabled="formDisabled"
                >
                  编辑
                </el-button>
                <el-button
                  type="text"
                  @click="handleDeleteTable5(row, $index)"
                  :disabled="formDisabled"
                >
                  删除
                </el-button>
        ...
        <el-col :span="24">
          <el-divider>审计意见及决定书</el-divider>
        </el-col>
        <el-col :span="24">
          <div style="text-align: right; margin-bottom: 5px">
            <el-button
              type="success"
              :disabled="formDisabled"
              @click="handleEditTable6(null, 'add')"
            >
              新建
            </el-button>
            <el-button
          ...
          >
            ...
            >
              <template #default="{ row, $index }">
                <el-button
                  type="text"
                  @click="handleEditTable6(row, 'edit')"
                  :disabled="formDisabled"
                >
                  编辑
                </el-button>
                <el-button
                  type="text"
                  @click="handleDeleteTable6(row, $index)"
                  :disabled="formDisabled"
                >
                  删除
                </el-button>
        ...
        <el-col :span="24">
          <el-divider>经济责任审计结果报告</el-divider>
        </el-col>
        <el-col :span="24">
          <div style="text-align: right; margin-bottom: 5px">
            <el-button
              type="success"
              :disabled="formDisabled"
              @click="handleEditTable7(null, 'add')"
            >
              新建
            </el-button>
            <el-button
          ...
          /> -->
            ...
            >
              <template #default="{ row, $index }">
                <el-button
                  type="text"
                  @click="handleEditTable7(row, 'edit')"
                  :disabled="formDisabled"
                >
                  编辑
                </el-button>
                <el-button
                  type="text"
                  @click="handleDeleteTable7(row, $index)"
                  :disabled="formDisabled"
                >
                  删除
                </el-button>
    ...
    <div style="text-align: right; margin-top: 10px" v-if="!formDisabled">
      <!-- <el-button @click="close">取 消</el-button>!formDisabled-->
      <el-button type="primary" @click="add" v-if="!formDisabled">
        确 定
      </el-button>
      <el-button type="primary" @click="ymsubmit" v-if="!formDisabled">
        提 交
      </el-button>
    </div>
    ...
    <NoticeInfo ref="table5View" @fetchData="addTable5" />
    <NoticeInfoTable ref="table5" @seTtable="setTable5" />

    <sjjysView ref="table6View" @fetchData="addTable6" />
    <sjjysViewTable ref="table6" @seTtable="setTable6" />

    <jjzrsjjgbgView ref="table7View" @fetchData="addTable7" />
    <jjzrsjjgbgViewTable ref="table7" @seTtable="setTable7" />

    <CaiNaModel ref="CaiNaModel" @fetchData="caiNaFetch" />
  </div>
</template>
...
<script>
  ...
  import {
    deleteInfo as deleteInfosjzgbg,
    getTotalMoney,
    getWtzgReportInfoList,
    saveWtzgSjtzs,
    removeWtzgSjtzs,
  ...
  import scsjbgEdit from '@/views/oilAudit/rectify/components/scsjbgEdit'
  import sjzgtjxxEdit from '@/views/oilAudit/rectify/components/sjzgtjxxEdit2'
  import sjzgtjxxEditNext from '@/views/oilAudit/rectify/components/sjzgtjxxEditNext'

  import NoticeInfo from '@/views/oilAudit/rectify/components/gzhf/NoticeInfo.vue'
  import NoticeInfoTable from '@/views/oilAudit/rectify/components/gzhf/NoticeInfoTable.vue'
  import sjjysView from '@/views/oilAudit/rectify/components/gzhf/sjjysView.vue'
  import sjjysViewTable from '@/views/oilAudit/rectify/components/gzhf/sjjysViewTable.vue'

  import jjzrsjjgbgView from '@/views/oilAudit/rectify/components/gzhf/jjzrsjjgbgView.vue'
  import jjzrsjjgbgViewTable from '@/views/oilAudit/rectify/components/gzhf/jjzrsjjgbgViewTable.vue'
  import CaiNaModel from '@/views/oilAudit/rectify/components/gzhf/CaiNaModel.vue'
  ...
  export default {
    ...
    data() {
      return {
        ...
        apiFile: 'https://www.wenxin.example.com/api/file/file/upload',
    ...
    watch: {
      'formData.ljzgje'(val) {
        if (!val && this.formData.projectId) {
          this.getLjzgje(this.formData.projectId)
        }
      },
    },
    created() {},
    ...
    methods: {
      ...
      handleCaiNa(row) {
        this.$refs['CaiNaModel'].showEdit(row, 1, this.formData.wtzgid)
      },
      handleBuCaiNa(row) {
        this.$refs['CaiNaModel'].showEdit(row, 2, this.formData.wtzgid)
      },
      async caiNaFetch(wtzgid) {
        const res = await getDetailInfor({ wtzgid: wtzgid })
        this.tableData4 = res.data.tblIssueEntity
          ? res.data.tblIssueEntity.proList
          : []
      },
      async getThreeList(wtzgid) {
        const res = await getWtzgReportInfoList({ wtzgid })
        this.tableData5 = res.data.tzsList
        this.tableData6 = res.data.sjyjList
        this.tableData7 = res.data.sjjgList
      },
      async getLjzgje(projectId) {
        const res = await getTotalMoney({ projectId })
        this.formData.ljjjcg = res.data.ljjjcgMoney
        this.formData.ljzgje = res.data.ljzgMoney
        this.$forceUpdate()
      },
      handleAddTable7() {
        this.$refs['table7'].showEdit()
      },
      setTable7(val) {
        this.saveWtzgSjtzsVal(this.formData.wtzgid, val[0].jjzrsjjgbgid, 3)
        this.tableData7.push(val[0])
      },
      addTable7(row) {
        console.log('reo', row)
        let list = this.tableData7
        let type = false
        list.map((item) => {
          if (item.jjzrsjjgbgid == row.jjzrsjjgbgid) {
            type = true
          }
        })
        if (type) {
          list = list.filter((item) => item.jjzrsjjgbgid != row.jjzrsjjgbgid)
          list.push(row)
          this.tableData7 = list
        } else {
          this.saveWtzgSjtzsVal(this.formData.wtzgid, row.jjzrsjjgbgid, 3)
          this.tableData7.push(row)
        }
      },
      handleDeleteTable7(row) {
        this.removeWtzgSjtzsVal(this.formData.wtzgid, row.jjzrsjjgbgid, 3)
        let list = this.tableData7
        list = list.filter((item) => item.jjzrsjjgbgid != row.jjzrsjjgbgid)
        this.tableData7 = list
      },
      ...
      handleEditTable7(row, disabled) {
        this.$refs['table7View'].showEdit(row, disabled)
      },
      handleAddTable6() {
        this.$refs['table6'].showEdit()
      },
      setTable6(val) {
        this.saveWtzgSjtzsVal(this.formData.wtzgid, val[0].bgid, 2)
        this.tableData6.push(val[0])
      },
      addTable6(row) {
        console.log('reo', row)
        let list = this.tableData6
        let type = false
        list.map((item) => {
          if (item.bgid == row.bgid) {
            type = true
          }
        })
        if (type) {
          list = list.filter((item) => item.bgid != row.bgid)
          list.push(row)
          this.tableData6 = list
        } else {
          this.saveWtzgSjtzsVal(this.formData.wtzgid, row.bgid, 2)
          this.tableData6.push(row)
        }
      },
      handleDeleteTable6(row) {
        this.removeWtzgSjtzsVal(this.formData.wtzgid, row.bgid, 2)
        let list = this.tableData6
        list = list.filter((item) => item.bgid != row.bgid)
        this.tableData6 = list
      },
      handleEditTable6(row, disabled) {
        this.$refs['table6View'].showEdit(row, disabled)
      },
      handleAddTable5() {
        this.$refs['table5'].showEdit()
      },
      handleDetail(row) {
        this.$refs['table6View'].showEdit(row, 'detail')
      },
      setTable5(val) {
        this.saveWtzgSjtzsVal(this.formData.wtzgid, val[0].adviceid, 1)
        this.tableData5.push(val[0])
      },
      addTable5(row) {
        let list = this.tableData5
        let type = false
        list.map((item) => {
          if (item.adviceid == row.adviceid) {
            type = true
          }
        })
        if (type) {
          list = list.filter((item) => item.adviceid != row.adviceid)
          list.push(row)
          this.tableData5 = list
        } else {
          this.saveWtzgSjtzsVal(this.formData.wtzgid, row.adviceid, 1)
          this.tableData5.push(row)
        }
      },
      handleDeleteTable5(row) {
        this.removeWtzgSjtzsVal(this.formData.wtzgid, row.adviceid, 1)
        let list = this.tableData5
        list = list.filter((item) => item.adviceid != row.adviceid)
        this.tableData5 = list
      },
      ...
      async saveWtzgSjtzsVal(wtzgid, formid, optype) {
        const res = await saveWtzgSjtzs({ wtzgid, formid, optype })
      },
      async removeWtzgSjtzsVal(wtzgid, formid, optype) {
        const res = await removeWtzgSjtzs({ wtzgid, formid, optype })
      },
      ...
      async handleEditTable2(row, disabled) {
        this.$refs['table2'].showEdit(
          row,
          disabled,
          this.formData.wtzgid,
          this.formData.projectId,
          this.formData.dqzjjjcgtype,
          this.formData.dqqtjjcgtype
        )
      },
      ...
      async showEdit(
        ...
        if (formId) {
          const res = await getDetailInfor({ wtzgid: formId })

          this.formData.sjbgdgTitle = res.data.tblIssueEntity.sjbgdgTitle
          this.formData.issuesId = res.data.tblIssueEntity.id
          this.formData.sjbgdgid = res.data.tblIssueEntity.sjbgdgid
          this.formData.unitName = res.data.tblIssueEntity.unitName
          this.formData.unitOrgId = res.data.tblIssueEntity.unitOrgId
          this.formData.issueNumber = res.data.tblIssueEntity.issueNumber
          this.formData.rectPerName = res.data.tblIssueEntity.rectPerName
          this.formData.rectPerson = res.data.tblIssueEntity.rectPerson
          this.formData.issueDetail = res.data.tblIssueEntity.issueDetail
          this.formData.money = res.data.tblIssueEntity.money
          this.formData.reviewMoney = res.data.tblIssueEntity.reviewMoney
          this.formData.qualitative = res.data.tblIssueEntity.qualitative
          this.formData.problemQualitative =
            res.data.tblIssueEntity.problemQualitative
          this.formData.qualitativeRule =
            res.data.tblIssueEntity.qualitativeRule
          this.formData.correctPropose = res.data.tblIssueEntity.correctPropose
          this.formData.problemYear = res.data.tblIssueEntity.problemYear
          this.formData.timeLimit = res.data.tblIssueEntity.timeLimit
          this.formData.rectClass = res.data.tblIssueEntity.rectClass
          this.formData.urgeDepartment = res.data.tblIssueEntity.urgeDepartment
          this.formData.head = res.data.tblIssueEntity.head
          this.formData.operator = res.data.tblIssueEntity.operator
          this.formData.operatorId = res.data.tblIssueEntity.operatorId
          this.formData.addTime = res.data.tblIssueEntity.addTime
          this.formData.draft = res.data.tblIssueEntity.draft
          this.formData.draftIdStrs = res.data.tblIssueEntity.draftIdStrs
          this.formData.zcss = res.data.tblIssueEntity.assetLoss
          this.formData.fxcd = res.data.tblIssueEntity.riskLevel

          this.formData.projectId = res.data.tblIssueEntity.projectId
          this.formData.projectName = res.data.tblIssueEntity.projectName
          ...
          this.getThreeList(res.data.wtzgid)
          // }
          this.tableData =
          ...
          this.getLjzgje(this.formData.projectId)
          if (res.data.tblYqnsSjzgYsnr) {
            this.formData.tblYqnsSjzgYsnr = res.data.tblYqnsSjzgYsnr
            this.tableDataWS = res.data.tblYqnsSjzgYsnr.ysAttList
          } else {
            this.tableDataWS = []
          }
          this.$forceUpdate()
        ...
        if (formId && disabled == 'edit') {
          this.title = '编辑'
          this.formDisabled = false
        } else if (formId && disabled == 'detail') {
          this.title = '详细'
