<template>
  ...
  <div>
    ...
    <cwsjxmapbOutView ref="cwsjxmapbOutView" />
...
<script>
  ...
  import cwsjxmapbOutView from '@/views/oilAudit/jhlx/components/cwsjxmapbOutView.vue'
    ...
    methods: {
      async showEdit(
        ...
        if (formId) {
          const {
            data: { data },
          } = await fundAuditOutProjectDetail({ tbid: formId })
          ...
          let res = await fundFileList({ tbid: formId })
