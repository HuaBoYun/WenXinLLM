  ...
  <div>
    <el-row :gutter="14">
      ...
      >
        ...
        <el-col :span="12">
          <el-form-item label="开竣工时间" prop="kjgsj">
            <el-date-picker
              v-model="formData.kjgsj"
              placeholder="请输入开竣工时间"
              type="date"
              format="yyyy-MM-dd"
...
<script>
  ...
  import SelectPlan from '@/views/oilAudit/gcgl/components/selectGcjgysjhModal.vue'
  import { customUpload } from '@/utils/Uploader'
  import { handleDown } from '@/utils/fileHandler'
  export default {
    name: 'jsxmjbqkEdit',
    inheritAttrs: false,
    components: { Resubmit, projectManage, SelectDepartment, SelectPlan },
    props: [],
    data() {
      return {
        baseApi: baseURL,
    ...
    methods: {
      ...
      async showEdit(
        ...
        const res = await engineeringBasicInformationDetail({ jsxmjbqkid: row }) // 获取到详情回显
      ...
      handleUnitSelected(node) {
        ...
        this.formData.tborgname = node.name
