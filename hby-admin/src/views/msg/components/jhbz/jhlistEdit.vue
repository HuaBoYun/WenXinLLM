...
<script>
  import Vue from 'vue'
  import { jhgljhSaveOrUpdate, jhgljhDetail } from '@/api/monitor/question'
    ...
    methods: {
      ...
      async fetchData(formId) {
        ...
        if (res && res.code == 1) {
          ...
          // this.formData.createUserName = res.data.createUser.realname
          // this.formData.organizationName = res.data.organization.orgname
