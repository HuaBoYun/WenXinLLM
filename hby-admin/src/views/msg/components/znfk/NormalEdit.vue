  ...
  export default {
    ...
    methods: {
      ...
      handleBeforeUpload(file) {
        ...
        //   return true
        // }else{
        //   this.$baseMessage('请先保存表单信息', 'error')
        //   return false
        // }
      },
      async getMJData(id) {
      ...
      async showEdit(
        ...
        if (!formId) {
          ...
          // if (res.data.report.status == 2 || res.data.report.status == 3) {
          ...
          //   }
          // }
          if (res.data.report?.secrectLevelId) {
            localStorage.setItem(
              'SPsecrectLevelId',
              res.data.report.secrectLevelId
            )
          }
          // console.log(res, 'woqunimade')
