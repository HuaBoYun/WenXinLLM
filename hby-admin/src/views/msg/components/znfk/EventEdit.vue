    ...
    <el-row :gutter="15">
      ...
      >
        <el-col :span="24">
          ...
          <el-col :span="12">
            <el-form-item label="涉及企业名称" prop="involvingenterprisenames">
              <el-input
    ...
    methods: {
      ...
      async save() {
        ...
        this.$refs['elForm'].validate(async (valid) => {
          if (valid) {
            ...
            // console.log(obj, '请求')
            console.log("🚀 ~ this.$refs['elForm'].validate ~ obj:", obj)
      ...
      async showEdit(
        ...
        if (!formId) {
          ...
          this.title = '编辑'
          const res = await getFxsjkDetails({ eventid: formId })
          if (res.data.riskevent?.secrectLevelId) {
            localStorage.setItem(
              'SPsecrectLevelId',
              res.data.riskevent.secrectLevelId
            )
          }
      ...
      async upDateData(detailData, formId) {
