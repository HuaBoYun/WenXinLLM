<template>
  <div>
    <el-row :gutter="14">
      ...
      >
        <el-col :span="12">
          <el-form-item label="单位（科室）" label-width="140px" prop="orgid">
            <el-input
        ...
        <el-col :span="12">
          <el-form-item label="经办人" label-width="140px" prop="jbr">
            <el-input
              ...
              :style="{ width: '80%', marginRight: '10px' }"
            />
            <el-button type="primary" @click="$refs.executor.show()">
              选择
            </el-button>
          </el-form-item>
        </el-col>
...
<script>
  ...
  // import oaList from '../../../oilAudit/prepare/oaList.vue'
  import {
    // createNoticeCode,
    // deleteNoticeFile,
      ...
      save() {
        this.$refs['elForm'].validate(async (valid) => {
          if (valid) {
            ...
            let { code, msg } = await NoticechangeAdd({
              ...this.formData,
              attids: fileIds,
            })
            if (code == 1) {
