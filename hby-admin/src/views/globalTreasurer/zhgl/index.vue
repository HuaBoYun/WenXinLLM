<template>
  <div class="account-management-home">
    ...
    <div class="function-modules">
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-card class="module-card" @click.native="navigateTo('/globalTreasurer/zhgl/zhxx')">
            <div class="card-content">
              <div class="card-icon">
                <i class="el-icon-postcard"></i>
              </div>
        ...
        <el-col :span="6">
          <el-card class="module-card" @click.native="navigateTo('/globalTreasurer/zhgl/balance')">
            <div class="card-content">
              <div class="card-icon">
                <i class="el-icon-money"></i>
              </div>
              <h3>余额查询管理</h3>
              <p>实时余额查询、历史余额统计、余额变动分析、资金流向追踪</p>
              <div class="card-footer">
                <span class="feature-tag">余额管理</span>
                <i class="el-icon-arrow-right"></i>
              </div>
            </div>
          </el-card>
        ...
        <el-col :span="6">
          <el-card class="module-card" @click.native="navigateTo('/globalTreasurer/zhgl/transaction')">
            <div class="card-content">
              <div class="card-icon">
                <i class="el-icon-document"></i>
              </div>
              <h3>交易记录管理</h3>
              <p>账户交易明细查询、交易分类统计、异常交易监控、对账管理</p>
              <div class="card-footer">
                <span class="feature-tag">交易管理</span>
                <i class="el-icon-arrow-right"></i>
              </div>
            </div>
          </el-card>
        ...
        <el-col :span="6">
          <el-card class="module-card" @click.native="navigateTo('/globalTreasurer/zhgl/authorization')">
            <div class="card-content">
              <div class="card-icon">
                <i class="el-icon-key"></i>
              </div>
              <h3>账户授权管理</h3>
              <p>操作权限配置、授权审批流程、权限变更记录、安全控制</p>
              <div class="card-footer">
      ...
      <el-row :gutter="20" style="margin-top: 20px;">
        <el-col :span="6">
          <el-card class="module-card" @click.native="navigateTo('/globalTreasurer/zhgl/reconciliation')">
            <div class="card-content">
              <div class="card-icon">
                <i class="el-icon-finished"></i>
              </div>
              <h3>银企对账管理</h3>
              <p>自动对账处理、差异分析处理、对账报告生成、异常处理流程</p>
              <div class="card-footer">
                <span class="feature-tag">对账管理</span>
                <i class="el-icon-arrow-right"></i>
              </div>
            </div>
          </el-card>
        ...
        <el-col :span="6">
          <el-card class="module-card" @click.native="navigateTo('/globalTreasurer/zhgl/monitoring')">
            <div class="card-content">
              <div class="card-icon">
                <i class="el-icon-view"></i>
              </div>
              <h3>账户监控预警</h3>
              <p>余额预警设置、异常交易监控、风险评估分析、预警通知管理</p>
              <div class="card-footer">
                <span class="feature-tag">监控预警</span>
                <i class="el-icon-arrow-right"></i>
              </div>
            </div>
          </el-card>
        ...
        <el-col :span="6">
          <el-card class="module-card" @click.native="navigateTo('/globalTreasurer/zhgl/reports')">
            <div class="card-content">
              <div class="card-icon">
                <i class="el-icon-data-analysis"></i>
              </div>
              <h3>账户报表分析</h3>
              <p>资金日报月报、账户使用分析、银行费用统计、综合分析报告</p>
              <div class="card-footer">
                <span class="feature-tag">报表分析</span>
                <i class="el-icon-arrow-right"></i>
              </div>
            </div>
          </el-card>
        ...
        <el-col :span="6">
          <el-card class="module-card" @click.native="navigateTo('/globalTreasurer/zhgl/settings')">
            <div class="card-content">
              <div class="card-icon">
                <i class="el-icon-setting"></i>
              </div>
              <h3>系统配置管理</h3>
              <p>账户类型配置、银行信息维护、业务参数设置、接口配置管理</p>
              <div class="card-footer">
...
export default {
  ...
  methods: {
    ...
    getMockBalanceOverview() {
      return {
        availableBalance: 2456789432.50,
        frozenBalance: 350000000.00,
        transitBalance: 50000000.00
      }
    },
    ...
    getMockBankDistribution() {
      return [
        ...
        { bankCode: 'COMM', bankName: '交通银行', accountCount: 13 }
      ]
    },
    ...
    handleQuickAction(action) {
      switch (action) {
        case 'addAccount':
          this.$router.push('/globalTreasurer/zhgl/zhxx')
          break
        case 'balanceQuery':
          this.$router.push('/globalTreasurer/zhgl/balance')
          break
        case 'transactionQuery':
          this.$router.push('/globalTreasurer/zhgl/transaction')
          break
        case 'reconciliation':
          this.$router.push('/globalTreasurer/zhgl/reconciliation')
          break
        case 'report':
          this.$router.push('/globalTreasurer/zhgl/reports')
          break
        case 'export':
          this.handleExport()
          break
