    ...
    <el-card class="table-card" shadow="never">
      ...
      >
        ...
        <el-table-column label="对账日期" width="120px" align="center">
          <template slot-scope="{row}">
            <span>{{ row.reconciliationDate }}</span>
          </template>
        </el-table-column>
...
<script>
import { getBankReconciliationPage, startReconciliation, importBankStatement } from '@/api/globalTreasurer/xjgl'
      ...
      setTimeout(() => {
        this.reconciliationList = [
          ...
          },
          {
            ...
            bookBalance: 3000000.00,
            bankBalance: 3000000.00,
            differenceAmount: 0.00,
            matchStatus: 'FULLY_MATCHED',
            reconciliationStatus: 'COMPLETED',
            reconciliationDate: '2024-09-24',
            operatorName: '李四'
          }
        ]
        this.total = this.reconciliationList.length
        this.listLoading = false
      }, 1000)
    },
    loadBankAccounts() {
      this.bankAccounts = [
        { accountId: 1, bankName: '中国工商银行', accountNumber: '1234567890123456789' },
        { accountId: 2, bankName: '中国建设银行', accountNumber: '9876543210987654321' },
        { accountId: 3, bankName: '中国农业银行', accountNumber: '5555666677778888999' }
      ]
    },
    handleFilter() {
