    ...
    <el-dialog title="电子票据详情" :visible.sync="dialogDetailVisible" width="800px">
      <div v-if="currentBill" class="bill-detail">
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="签发日期">{{ currentBill.issueDate }}</el-descriptions-item>
...
<script>
import { getElectronicBillPage, createElectronicBill, updateElectronicBill } from '@/api/globalTreasurer/pzgl'
...
export default {
  ...
  methods: {
    getList() {
      ...
      setTimeout(() => {
        this.billList = [
          {
            billId: 1,
            billNumber: 'E-BA20240925001',
            billType: 'E_BANK_ACCEPTANCE',
          ...
          {
            billId: 2,
            billNumber: 'E-CA20240920002',
            billType: 'E_COMMERCIAL_ACCEPTANCE',
            ...
            billStatus: 'CIRCULATING',
            digitalSignature: true
          },
          {
            billId: 3,
            billNumber: 'E-CH20240915003',
            billType: 'E_CHECK',
        ...
        series: [
          {
            ...
            type: 'line',
            stack: 'Total',
            data: this.generateMockData(30, 2, 8),
          ...
          },
          {
            ...
            type: 'line',
            stack: 'Total',
            data: this.generateMockData(30, 1, 5),
          ...
          },
          {
            ...
            type: 'line',
            stack: 'Total',
            data: this.generateMockData(30, 0, 3),
          ...
          },
          {
            ...
            type: 'line',
            stack: 'Total',
            data: this.generateMockData(30, 1, 4),
      ...
      this.circulationRecords = [
        {
          id: 1,
          operationType: '票据签发',
          description: '电子票据成功签发',
          operationTime: '2024-09-25 10:00:00',
          operatorName: '张三'
        },
        {
          id: 2,
          operationType: '数字签名',
          description: '完成数字签名认证',
          operationTime: '2024-09-25 10:05:00',
          operatorName: '系统自动'
        }
      ]
    },
    loadTrackData(billId) {
      // 模拟追踪数据
      this.trackSteps = [
        { title: '票据签发', description: '2024-09-25 10:00' },
        { title: '数字签名', description: '2024-09-25 10:05' },
        { title: '票据流转', description: '2024-09-25 14:30' },
        { title: '背书转让', description: '待处理' }
      ]
      ...
      this.trackDetails = [
        ...
        {
          operationTime: '2024-09-25 14:30:00',
          operationType: '票据流转',
          operatorName: '李四',
          description: '票据进入流转状态',
          status: 'SUCCESS'
        }
      ]
    },
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          this.temp.billNumber = 'E-' + this.temp.billType.substring(2, 4) + new Date().getTime()
          this.temp.billStatus = 'ISSUED'
