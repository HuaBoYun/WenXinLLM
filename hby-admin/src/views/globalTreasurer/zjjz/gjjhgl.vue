...
<script>
import { getConcentrationPlanPage, createConcentrationPlan, executeConcentrationPlan } from '@/api/globalTreasurer/zjjz'
  ...
  methods: {
        ...
        this.planList = [
          {
            ...
            planName: '月末资金归集计划',
            strategyName: '日终资金归集',
            planAmount: 5000000.00,
            actualAmount: 4850000.00,
            executionProgress: 97,
            planStatus: 'COMPLETED',
            executionTime: '2024-09-30 18:00:00',
            creatorName: '张三',
            createTime: '2024-09-25 10:00:00',
            planDescription: '月末统一归集各分公司资金到集团总账户'
          },
          {
            planId: 2,
            planName: '投资项目资金归集',
            strategyName: '智能余额归集',
            planAmount: 3000000.00,
            actualAmount: 1500000.00,
            executionProgress: 50,
            planStatus: 'EXECUTING',
            executionTime: '2024-09-26 09:00:00',
            creatorName: '李四',
            createTime: '2024-09-26 08:30:00',
            planDescription: '为新投资项目归集资金'
          }
        ]
    ...
    loadAvailableStrategies() {
      ...
      this.availableStrategies = [
        { strategyId: 1, strategyName: '日终资金归集' },
        { strategyId: 2, strategyName: '智能余额归集' },
        { strategyId: 3, strategyName: '比例归集策略' }
      ]
    },
    handleFilter() {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          ...
          this.temp.planStatus = 'PENDING'
          this.temp.executionProgress = 0
          this.temp.actualAmount = 0
          this.temp.creatorName = '当前用户'
          this.temp.createTime = new Date().toLocaleString()
          if (this.temp.executionTime) {
            this.temp.executionTime = this.temp.executionTime.toLocaleString()
          }
          // 找到策略名称
          const strategy = this.availableStrategies.find(s => s.strategyId === this.temp.strategyId)
          if (strategy) {
            this.temp.strategyName = strategy.strategyName
          }
    ...
    loadExecutionDetails(planId) {
      ...
      this.executionDetails = [
        {
          sourceAccountName: '示例云科技分公司账户',
          targetAccountName: '示例云集团总账户',
          amount: 1500000.00,
          status: 'COMPLETED',
          executionTime: '2024-09-25 18:05:00',
          remark: '正常归集'
        },
        {
          sourceAccountName: '示例云投资账户',
          targetAccountName: '示例云集团总账户',
          amount: 2000000.00,
          status: 'COMPLETED',
          executionTime: '2024-09-25 18:10:00',
          remark: '正常归集'
        }
      ]
    },
