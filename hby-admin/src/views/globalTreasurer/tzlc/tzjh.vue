    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['investment:plan:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['investment:plan:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['investment:plan:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['investment:plan:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="planList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="投资类型" align="center" prop="investmentType">
        <template slot-scope="scope">
          <dict-tag :options="investmentTypeOptions" :value="scope.row.investmentType"/>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['investment:plan:query']"
          >查看</el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['investment:plan:edit']"
          >修改</el-button>
          <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['investment:plan:submit']">
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('investment/plan/export', {
        ...this.queryParams
