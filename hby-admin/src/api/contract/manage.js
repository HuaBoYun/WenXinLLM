...
export function findOrganizationByTreeAllss(data) {
  return request({
    ...
    url: '/baseInfo/findOrganizationByTreeAllbm',
    method: 'post',
    data: transData(data),
  })
}
...
//流程详细
export function getFlowPkInfo(data) {
  return request({
...
export function getRiskBusiness(params) {
  return request({
    url: '/riskcontrol/risk//get_risk_business',
    method: 'get',
    params: transData(params),
  })
}
...
//获取流程名称字典
export function getRiskProcess(params) {
  return request({
    url: '/riskcontrol/risk/get_risk_process',
    method: 'get',
    params: transData(params),
  })
}
...
//获取风险编号
export function getRiskProcessNo(params) {
  return request({
    url: '/riskcontrol/risk/get_risk_no',
    method: 'get',
    params: transData(params),
  })
}
//获取风险编号
export function getRiskNo(params) {
  return request({
    url: '/riskcontrol/risk/get_riskNo',
    method: 'get',
    params: transData(params),
  })
}
...
//评价
export function goReplyInfo(params) {
  return request({
    url: '/riskcontrol/fxxt/fxyd/runeval',
    method: 'post',
    data: transData(params),
  })
}
