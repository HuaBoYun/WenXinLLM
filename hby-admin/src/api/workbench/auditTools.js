...
//审计模板-审计类型列表
export function getSjlxListOld(params, headers) {
	return request({
...
export function getNbsjTypeOfList(params) {
	return request({
		url: '/oiaudit/nbsjworkSpace/getNbsjTypeOfList',
		method: 'post',
		data: transData(params),
	})
}
...
export function saveNbsjTypeOf(params) {
	return request({
		url: '/oiaudit/nbsjworkSpace/saveNbsjTypeOf',
		method: 'post',
		data: transData(params),
	})
}
...
export function modifyNbsjTypeOf(params) {
	return request({
		url: '/oiaudit/nbsjworkSpace/modifyNbsjTypeOf',
		method: 'post',
		data: transData(params),
	})
}
...
export function getNbsjTypeOfInfo(params) {
	return request({
		url: '/oiaudit/nbsjworkSpace/getNbsjTypeOfInfo',
		method: 'post',
		data: transData(params),
	})
}
...
export function removeNbsjTypeOf(params) {
	return request({
		url: '/oiaudit/nbsjworkSpace/removeNbsjTypeOf',
		method: 'post',
		data: transData(params),
	})
}
...
//审计模板目录-左侧树结构
export function findNbsjTargetTreeAudit(params) {
	return request({
		url: '/audit/nbsjworkSpace/findNbsjTargetTree',
		method: 'post',
		headers: transData(params),
	})
}
...
//审计模板目录-左侧树结构2
export function findNbsjTargetTree2Audit(params) {
	return request({
		url: '/audit/nbsjworkSpace/findNbsjTargetTree2',
		method: 'post',
		headers: transData(params),
	})
}
...
//审计模板目录-右侧
export function defCatListZyAudit(params) {
	return request({
...
//审计指引-删除
export function deleteNbsjAuditprogramAudit(params) {
	return request({
		url: '/audit/nbsjworkSpace/deleteNbsjAuditprogram',
		method: 'post',
		headers: transData(params),
	})
}
//审计模板目录-删除
export function deleteNbsjTargetAudit(params) {
	return request({
		url: '/audit/nbsjworkSpace/deleteNbsjTarget',
		method: 'post',
		headers: transData(params),
	})
}
...
//审计模板目录-新增、修改
export function mergeTblNbsjTargetAudit(params) {
	return request({
		url: '/audit/nbsjworkSpace/mergeTblNbsjTarget',
		method: 'post',
		data: transData(params),
	})
}
//审计模板目录-查询单个信息
export function selectNbsjTargetInfoAudit(params) {
	return request({
		url: '/audit/nbsjworkSpace/selectNbsjTargetInfo',
		method: 'post',
		headers: transData(params),
	})
}
//审计指引-新增、修改
export function mergeTblNbsjAuditprogramAudit(params) {
	return request({
		url: '/audit/nbsjworkSpace/mergeTblNbsjAuditprogram',
		method: 'post',
		data: transData(params),
	})
}
