...
export function projectWbList(params) {
  return request({
    url: '/audit/nbsjzg/zg/project_wb_list',
    method: 'get',
    params: transData(params),
  })
}
...
// 删除整改内容列表row
export function delSolutionnr(params) {
  return request({
...
//整改方案关闭
export function closeSolutionaa(params) {
  return request({
    url: '/audit/zgzz/modifyRectificationPlanStatus',
    method: 'post',
    data: transData(params),
  })
}