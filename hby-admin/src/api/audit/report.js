...
export function saveOpinion(params) {
	return request({
		url: '/audit/auditReport/manage/opinion_file_save',
		method: 'post',
		data: transData(params),
	})
}
...
export function getOpinionList(params) {
	return request({
		url: '/audit/auditReport/manage/opinion_file_list',
		method: 'get',
		params: transData(params),
	})
}
//审计报告编制-终稿附件保存
export function saveFinal(params) {
	return request({
		url: '/audit/auditReport/manage/final_file_save',
		method: 'post',
		data: transData(params),
	})
}
//审计报告编制-终稿附件列表
export function getFinalList(params) {
	return request({
		url: '/audit/auditReport/manage/final_file_list',
		method: 'get',
		params: transData(params),
	})
}