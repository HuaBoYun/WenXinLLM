...
export function searchDataMapping(data) {
  return request({
    url: '/cwgxAi/basicConfig/mapping/search',
    method: 'post',
    data
  })
}
...
export function getDataMapping(id) {
  return request({
    url: `/cwgxAi/basicConfig/mapping/detail?id=${id}`,
    method: 'get'
  })
}
...
export function getInitData() {
  return request({
    url: '/cwgxAi/basicConfig/mapping/initData',
    method: 'get'
  })
}
...
export function checkMappingName(data) {
  return request({
    url: '/cwgxAi/basicConfig/mapping/checkName',
    method: 'post',
    data
  })
}
...
export function validateFieldMappings(data) {
  return request({
    url: '/cwgxAi/basicConfig/mapping/validateFields',
    method: 'post',
    data
  })
}
...
export function getSourceFields(systemId) {
  return request({
    url: `/cwgxAi/basicConfig/mapping/sourceFields?systemId=${systemId}`,
    method: 'get'
  })
}
...
export function getTargetFields(systemId) {
  return request({
    url: `/cwgxAi/basicConfig/mapping/targetFields?systemId=${systemId}`,
    method: 'get'
  })
}
...
export function batchDeleteDataMapping(ids) {
  return request({
    url: '/cwgxAi/basicConfig/mapping/batch',
    method: 'delete',
    data: ids
  })
}
...
export function getDataMappingStatistics() {
  return request({
    url: '/cwgxAi/basicConfig/mapping/statistics',
    method: 'get'
  })
}
...
export function batchImportDataMapping(file, updateUser) {
  ...
  return request({
    url: '/cwgxAi/basicConfig/mapping/import',
    method: 'post',
    data: formData,
    params: { updateUser },
    headers: {
...
export function getFieldTypes() {
  return request({
    url: '/cwgxAi/basicConfig/mapping/fieldTypes',
    method: 'get'
  })
}
...
export function getTransformRules() {
  return request({
    url: '/cwgxAi/basicConfig/mapping/transformRules',
    method: 'get'
  })
}
