...
export function getCbTableList(params) {
  return request({
    url: '/setting/refopm/reminder/getList',
    method: 'post',
    data: transData(params),
    headers: {
...
export function saveCBInfo(params) {
  return request({
    url: '/setting/refopm/reminder/saveOrUpdate',
    method: 'post',
    data: transData(params),
    headers: {
      'Content-Type': 'application/json',
...
export function deleteCBList(params) {
  return request({
    url: `/setting/refopm/reminder/${params.id}`,
    method: 'DELETE',
    params: transData(params),
  })
}
...
export function stopBList(params) {
  return request({
    url: `/setting/refopm/reminder/is-stop-reminder/${params.id}`,
    method: 'PUT',
    params: transData(params),
  })
}
...
export function handleCuiBan(params) {
  return request({
    url: `/setting/refopm/reminder/do-reminder/${params.id}`,
    method: 'PUT',
    params: transData(params),
  })
}
...
export function getHomeCBList(params) {
  return request({
    url: `/setting/ref/reminder/getList`,
    method: 'post',
    data: transData(params),
    headers: {
      'Content-Type': 'application/json',
...
export function getFWlist(params) {
  return request({
    url: '/setting/ref/reminder/access/getList',
    method: 'post',
    data: transData(params),
    headers: {
      'Content-Type': 'application/json',
