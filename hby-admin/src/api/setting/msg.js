...
export const getRemindList = (params) => {
  return request({
    url: '/riskcontrol/riskEventZh/getRemindList',
    method: 'get',
    params: transData(params),
  })
}
//整改方案即将到期
export const getZGInfo = (params) => {
  return request({
    url: '/setting/loadinit/getRectificationPlan/dueStr',
    method: 'get',
    params: transData(params),
  })
}
...
// 获取所有消息数量
export const getAllMsgNum = (params) => {
  return request({
