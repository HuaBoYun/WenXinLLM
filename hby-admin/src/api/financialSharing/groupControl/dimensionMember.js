...
export function getDimensionMemberTree(data) {
  return request({
    url: '/cwgxAi/groupControl/dimensionMember/getTree',
    method: 'post',
    data
  })
}
...
export function getDimensionMemberDetail(data) {
  return request({
    url: '/cwgxAi/groupControl/dimensionMember/detail',
    method: 'post',
    data
  })
}
...
export function saveDimensionMember(data) {
  return request({
    url: '/cwgxAi/groupControl/dimensionMember/save',
    method: 'post',
    data
  })
}
...
export function deleteDimensionMember(data) {
  return request({
    url: '/cwgxAi/groupControl/dimensionMember/delete',
    method: 'post',
    data
  })
}
...
export function batchDeleteDimensionMember(memberIds) {
  return request({
    url: '/cwgxAi/groupControl/dimensionMember/batchDelete',
    method: 'post',
    data: memberIds
  })
}
...
export function moveDimensionMember(data) {
  return request({
    url: '/cwgxAi/groupControl/dimensionMember/move',
    method: 'post',
    data
  })
}
...
export function updateDimensionMemberStatus(data) {
  return request({
    url: '/cwgxAi/groupControl/dimensionMember/updateStatus',
    method: 'post',
    data
  })
}
