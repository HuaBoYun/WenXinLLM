...
export function defTmplList(params) {
  return request({
    url: '/hgglext/nbkz/csmb/def_tmpl_list',
    method: 'get',
...
export function getAutoNumber(params) {
  return request({
    url: '/hgglext/nbkz/csmb/getAutoNumber',
    method: 'get',
    params: transData(params),
  })
}
...
export function tempdelete(params) {
  return request({
    url: '/hgglext/nbkz/csmb/tempdelete',
    method: 'post',
...
export function defTmplModify(params) {
  return request({
    url: '/hgglext/nbkz/csmb/def_tmpl_modify',
    method: 'post',
    data: transData(params),
  })
}
...
export function defTmplSave(params) {
  return request({
    url: '/hgglext/nbkz/csmb/def_tmpl_save',
    method: 'post',
    data: transData(params),
  })
}
...
export function saveissued(params) {
  return request({
    url: '/hgglext/nbkz/csmb/saveissued',
    method: 'post',
    data: transData(params),
  })
}
...
export function typeSave(params) {
  return request({
    url: '/hgglext/nbkz/csmb/type_save',
    method: 'post',
    data: transData(params),
  })
}
...
export function typeModify(params) {
  return request({
    url: '/hgglext/nbkz/csmb/type_modify',
    method: 'post',
    data: transData(params),
  })
}
...
export function typeList(params) {
  return request({
    url: '/hgglext/nbkz/csmb/type_list',
    method: 'get',
    params: transData(params),
  })
}
...
export function typeRemove(params) {
  return request({
    url: '/hgglext/nbkz/csmb/type_remove',
    method: 'get',
    params: transData(params),
  })
}
...
export function elementList(params) {
  return request({
    url: '/hgglext/nbkz/csmb/elementList',
    method: 'get',
    params: transData(params),
  })
}
...
export function elementssave(params) {
  return request({
    url: '/hgglext/nbkz/csmb/elementssave',
    method: 'post',
    data: transData(params),
  })
}
...
export function elementmodify(params) {
  return request({
    url: '/hgglext/nbkz/csmb/elementmodify',
    method: 'post',
    data: transData(params),
  })
}
...
export function elementremove(params) {
  return request({
    url: '/hgglext/nbkz/csmb/elementremove',
    method: 'get',
    params: transData(params),
  })
}
...
export function findAutoNextNumberForLevel(params) {
  return request({
    url: '/hgglext/nbkz/code/findAutoNextNumberForLevel',
    method: 'get',
    params: transData(params),
  })
}
...
export function findRootNumberByParentIdLevel(params) {
  return request({
    url: '/hgglext/nbkz/code/findRootNumberByParentIdLevel',
    method: 'get',
    params: transData(params),
  })
}
