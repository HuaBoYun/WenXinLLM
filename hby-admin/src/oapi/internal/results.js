...
export function resultCountList(params) {
  return request({
    url: '/nkhg/nkcs/statistic/result_count_list',
    method: 'get',
...
export function controlTestImplDetail(params) {
  return request({
    url: '/nkhg/csrw/control_test_impl_detail',
    method: 'get',
    params: transData(params),
  })
}
