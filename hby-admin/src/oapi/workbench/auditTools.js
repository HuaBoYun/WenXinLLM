...
//审计模板-审计类型列表
export function getSjlxList(params) {
	return request({
...
export function getNbsjTempletePageList(params) {
	return request({
		url: '/audit/nbsjworkSpace/getNbsjTempletePageList',
		method: 'post',
		data: transData(params),
	})
}
...
//审计模板-新增、修改
export function mergeNbsjTemplete(params) {
	return request({
		url: '/audit/nbsjworkSpace/mergeNbsjTemplete',
		method: 'post',
		data: transData(params),
...
export function selectTempleteInfo(params) {
	return request({
		url: '/audit/nbsjworkSpace/selectTempleteInfo',
		method: 'post',
...
export function getOrgTreeListByAuditObj(params) {
	return request({
		url: '/audit/auditProject/getOrgTreeListByAuditObj',
		method: 'get',
...
export function copyTemplete(params) {
	return request({
		url: '/audit/nbsjworkSpace/copyTemplete',
		method: 'post',
		headers: params,
	})
}
...
export function deleteTempleteInfo(params) {
	return request({
		url: '/audit/nbsjworkSpace/deleteTempleteInfo',
		method: 'post',
		headers: { templeteId: params },
	})
}
...
export function updateTempleteStatus(params) {
	return request({
		url: '/audit/nbsjworkSpace/updateTempleteStatus',
		method: 'post',
		headers: { templeteId: params },
	})
}
...
export function getNbsjjyTempletePageList(params) {
	return request({
		url: '/audit/nbsjworkSpace/getNbsjjyTempletePageList',
		method: 'post',
		data: transData(params),
	})
}
...
export function createAuditCode(params) {
	return request({
		url: '/audit/auditPlan/getAutoCodeBySjmb',
		method: 'post',
		data: transData(params),
	})
}
...
export function createExperienceCode(params) {
	return request({
		url: '/audit/auditPlan/getAutoCodeBySjzy',
		method: 'post',
		data: transData(params),
	})
}
