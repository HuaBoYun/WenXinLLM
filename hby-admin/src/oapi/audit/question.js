...
export function defectAdd(params) {
  return request({
    url: '/audit/auditPS/sjss/dg_defect_Add',
    method: 'post',
    data: transData(params),
  })
}
...
//新增缺陷编号
export function createFlawCode(params) {
  return request({
    url: '/audit/auditPlan/getAutoCodeByQxgl',
    method: 'post',
    data: transData(params),
  })
}
//新增风险发现编号
export function createRiskCode(params) {
  return request({
    url: '/audit/auditPlan/getAutoCodeByFxfx',
    method: 'post',
    data: transData(params),
  })
}
...
//底稿清单列表  
export function getDraftListPage(params) {
  return request({
    url: '/oiaudit/audit/MyManuscript/getDraftListPage',
    method: 'get',
    params: transData(params),
  })
}
...
export function exportList(params) {
  return request({
    url: '/oiaudit/audit/MyManuscript/qdexport',
    method: 'get',
    params,
    responseType: 'blob',
  })
