...
// 下发列表
export function getDistributionListPage(data) {
  return request({
    url: '/setting/distribution/getDistributionListPage',
    method: 'get',
    params: data,
  })
}
// 确认接收
export function modifyDistributionInfo(data) {
  return request({
    url: '/setting/distribution/modifyDistributionInfo',
    method: 'post',
    data,
  })
}
...
export function getTypeData(data) {
  return request({
    url: '/setting/distribution/getDistributionTypeList',
    method: 'get',
  })
}
...
export function getAllTypeData(data) {
  return request({
    url: '/setting/distribution/batchModifyDistributionInfo',
    method: 'post',
    params: data
  })
}
...
// 操作完成
export function operateComplete(data) {
  return request({
    url: '/oiaudit/operate/complete',
    method: 'post',
    params: data
  })
}
...
// 消息列表
export function operateGetList(data) {
  return request({
    url: '/oiaudit/operate/getList',
    method: 'get',
    params: data,
  })
}
